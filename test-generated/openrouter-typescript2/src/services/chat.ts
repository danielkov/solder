...
export class ChatService {
   ...
   */
  async sendChatCompletionRequest(params: { body: ChatGenerationParams }): Promise<ChatResponse> {
      ...
      switch (response.status) {
        case 400: {
          try {
            ...
            if (e instanceof SendChatCompletionRequestBadRequestError) {
              throw e;
            }
        ...
        case 401: {
          try {
            ...
            if (e instanceof SendChatCompletionRequestUnauthorizedError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 429: {
          try {
            ...
            if (e instanceof SendChatCompletionRequestTooManyRequestsError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 500: {
          try {
            ...
            if (e instanceof SendChatCompletionRequestInternalServerErrorError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
