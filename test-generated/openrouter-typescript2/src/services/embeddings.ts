...
export class EmbeddingsService {
   ...
   */
  async createEmbeddings(params: { body: CreateEmbeddingsRequest }): Promise<CreateEmbeddingsResponse> {
      ...
      switch (response.status) {
        case 400: {
          try {
            ...
            if (e instanceof CreateEmbeddingsBadRequestError) {
              throw e;
            }
        ...
        case 401: {
          try {
            ...
            if (e instanceof CreateEmbeddingsUnauthorizedError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 402: {
          try {
            ...
            if (e instanceof CreateEmbeddingsStatus402Error) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 404: {
          try {
            ...
            if (e instanceof CreateEmbeddingsNotFoundError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 429: {
          try {
            ...
            if (e instanceof CreateEmbeddingsTooManyRequestsError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 500: {
          try {
            ...
            if (e instanceof CreateEmbeddingsInternalServerErrorError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 502: {
          try {
            ...
            if (e instanceof CreateEmbeddingsBadGatewayError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 503: {
          try {
            ...
            if (e instanceof CreateEmbeddingsServiceUnavailableError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 524: {
          try {
            ...
            if (e instanceof CreateEmbeddingsStatus524Error) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 529: {
          try {
            ...
            if (e instanceof CreateEmbeddingsStatus529Error) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
      ...
      switch (response.status) {
        case 400: {
          try {
            ...
            if (e instanceof ListEmbeddingsModelsBadRequestError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 500: {
          try {
            ...
            if (e instanceof ListEmbeddingsModelsInternalServerErrorError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
