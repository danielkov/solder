...
export class CreditsService {
      ...
      switch (response.status) {
        case 401: {
          try {
            ...
            if (e instanceof GetCreditsUnauthorizedError) {
              throw e;
            }
        ...
        case 403: {
          try {
            ...
            if (e instanceof GetCreditsForbiddenError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 500: {
          try {
            ...
            if (e instanceof GetCreditsInternalServerErrorError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
   ...
   */
  async createCoinbaseCharge(params: { body: CreateChargeRequest }): Promise<CreateCoinbaseChargeResponse> {
      ...
      switch (response.status) {
        case 400: {
          try {
            ...
            if (e instanceof CreateCoinbaseChargeBadRequestError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 401: {
          try {
            ...
            if (e instanceof CreateCoinbaseChargeUnauthorizedError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 429: {
          try {
            ...
            if (e instanceof CreateCoinbaseChargeTooManyRequestsError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 500: {
          try {
            ...
            if (e instanceof CreateCoinbaseChargeInternalServerErrorError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
