...
export class OAuthService {
   ...
   */
  async exchangeAuthCodeForApiKey(params: { body: ExchangeAuthCodeForApiKeyRequest }): Promise<ExchangeAuthCodeForApiKeyResponse> {
      ...
      switch (response.status) {
        case 400: {
          try {
            ...
            if (e instanceof ExchangeAuthCodeForApiKeyBadRequestError) {
              throw e;
            }
        ...
        case 403: {
          try {
            ...
            if (e instanceof ExchangeAuthCodeForApiKeyForbiddenError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 500: {
          try {
            ...
            if (e instanceof ExchangeAuthCodeForApiKeyInternalServerErrorError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
   ...
   */
  async createAuthKeysCode(params: { body: CreateAuthKeysCodeRequest }): Promise<CreateAuthKeysCodeResponse> {
      ...
      switch (response.status) {
        case 400: {
          try {
            ...
            if (e instanceof CreateAuthKeysCodeBadRequestError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 401: {
          try {
            ...
            if (e instanceof CreateAuthKeysCodeUnauthorizedError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 500: {
          try {
            ...
            if (e instanceof CreateAuthKeysCodeInternalServerErrorError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
