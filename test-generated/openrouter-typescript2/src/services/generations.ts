...
export class GenerationsService {
   ...
   */
  async getGeneration(params: { id: string }): Promise<GetGenerationResponse> {
      ...
      switch (response.status) {
        case 401: {
          try {
            ...
            if (e instanceof GetGenerationUnauthorizedError) {
              throw e;
            }
        ...
        case 402: {
          try {
            ...
            if (e instanceof GetGenerationStatus402Error) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 404: {
          try {
            ...
            if (e instanceof GetGenerationNotFoundError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 429: {
          try {
            ...
            if (e instanceof GetGenerationTooManyRequestsError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 500: {
          try {
            ...
            if (e instanceof GetGenerationInternalServerErrorError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 502: {
          try {
            ...
            if (e instanceof GetGenerationBadGatewayError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 524: {
          try {
            ...
            if (e instanceof GetGenerationStatus524Error) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 529: {
          try {
            ...
            if (e instanceof GetGenerationStatus529Error) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
