...
export class BetaResponsesService {
   ...
   */
  async createResponses(params: { body: OpenResponsesRequest }): Promise<OpenResponsesNonStreamingResponse> {
      ...
      switch (response.status) {
        case 400: {
          try {
            ...
            if (e instanceof CreateResponsesBadRequestError) {
              throw e;
            }
        ...
        case 401: {
          try {
            ...
            if (e instanceof CreateResponsesUnauthorizedError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 402: {
          try {
            ...
            if (e instanceof CreateResponsesStatus402Error) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 404: {
          try {
            ...
            if (e instanceof CreateResponsesNotFoundError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 408: {
          try {
            ...
            if (e instanceof CreateResponsesStatus408Error) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 413: {
          try {
            ...
            if (e instanceof CreateResponsesStatus413Error) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 422: {
          try {
            ...
            if (e instanceof CreateResponsesUnprocessableEntityError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 429: {
          try {
            ...
            if (e instanceof CreateResponsesTooManyRequestsError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 500: {
          try {
            ...
            if (e instanceof CreateResponsesInternalServerErrorError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 502: {
          try {
            ...
            if (e instanceof CreateResponsesBadGatewayError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 503: {
          try {
            ...
            if (e instanceof CreateResponsesServiceUnavailableError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 524: {
          try {
            ...
            if (e instanceof CreateResponsesStatus524Error) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 529: {
          try {
            ...
            if (e instanceof CreateResponsesStatus529Error) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
