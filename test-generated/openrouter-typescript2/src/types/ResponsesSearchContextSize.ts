...
export const ResponsesSearchContextSizeSchema: TypedSchema<ResponsesSearchContextSize> = typed<ResponsesSearchContextSize>(union(literal('low'), literal('medium'), literal('high')));
