...
export const ListProvidersResponseSchema: TypedSchema<ListProvidersResponse> = typed<ListProvidersResponse>(object({ data: array(ListProvidersResponseDataItemSchema) }));
