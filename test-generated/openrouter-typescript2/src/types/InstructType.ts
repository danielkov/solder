...
export const InstructTypeSchema: TypedSchema<InstructType> = typed<InstructType>(union(literal('none'), literal('airoboros'), literal('alpaca'), literal('alpaca-modif'), literal('chatml'), literal('claude'), literal('code-llama'), literal('gemma'), literal('llama2'), literal('llama3'), literal('mistral'), literal('nemotron'), literal('neural'), literal('openchat'), literal('phi3'), literal('rwkv'), literal('vicuna'), literal('zephyr'), literal('deepseek-r1'), literal('deepseek-v3.1'), literal('qwq'), literal('qwen3')));
