import { boolean, number, object, optional, typed } from '@speakeasy-api/tonic';
...
export const OpenResponsesReasoningConfigSchema: TypedSchema<OpenResponsesReasoningConfig> = typed<OpenResponsesReasoningConfig>(object({
  get effort() {
    return optional(OpenAiResponsesReasoningEffortSchema);
  },
  enabled: optional(boolean()),
  maxTokens: optional(number()),
  get summary() {
    return optional(ReasoningSummaryVerbositySchema);
  },
}));
