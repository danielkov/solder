...
export const GetParametersResponseDataSchema: TypedSchema<GetParametersResponseData> = typed<GetParametersResponseData>(object({ model: string(), supportedParameters: array(string()) }));
