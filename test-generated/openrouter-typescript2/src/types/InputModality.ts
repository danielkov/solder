...
export const InputModalitySchema: TypedSchema<InputModality> = typed<InputModality>(union(literal('text'), literal('image'), literal('file'), literal('audio'), literal('video')));
