...
export const OpenAiResponsesIncludableSchema: TypedSchema<OpenAiResponsesIncludable> = typed<OpenAiResponsesIncludable>(union(literal('file_search_call.results'), literal('message.input_image.image_url'), literal('computer_call_output.output.image_url'), literal('reasoning.encrypted_content'), literal('code_interpreter_call.outputs')));
