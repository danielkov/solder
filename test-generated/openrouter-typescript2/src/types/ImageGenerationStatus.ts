...
export const ImageGenerationStatusSchema: TypedSchema<ImageGenerationStatus> = typed<ImageGenerationStatus>(union(literal('in_progress'), literal('completed'), literal('generating'), literal('failed')));
