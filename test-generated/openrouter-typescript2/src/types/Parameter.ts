...
export const ParameterSchema: TypedSchema<Parameter> = typed<Parameter>(union(literal('temperature'), literal('top_p'), literal('top_k'), literal('min_p'), literal('top_a'), literal('frequency_penalty'), literal('presence_penalty'), literal('repetition_penalty'), literal('max_tokens'), literal('logit_bias'), literal('logprobs'), literal('top_logprobs'), literal('seed'), literal('response_format'), literal('structured_outputs'), literal('stop'), literal('tools'), literal('tool_choice'), literal('parallel_tool_calls'), literal('include_reasoning'), literal('reasoning'), literal('web_search_options'), literal('verbosity')));
