...
export const ListEndpointsZdrResponseSchema: TypedSchema<ListEndpointsZdrResponse> = typed<ListEndpointsZdrResponse>(object({ data: array(PublicEndpointSchema) }));
