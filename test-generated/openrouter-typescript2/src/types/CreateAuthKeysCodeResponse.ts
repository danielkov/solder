...
export const CreateAuthKeysCodeResponseSchema: TypedSchema<CreateAuthKeysCodeResponse> = typed<CreateAuthKeysCodeResponse>(object({ data: CreateAuthKeysCodeResponseDataSchema }));
