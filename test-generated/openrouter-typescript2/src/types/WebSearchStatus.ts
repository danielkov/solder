...
export const WebSearchStatusSchema: TypedSchema<WebSearchStatus> = typed<WebSearchStatus>(union(literal('completed'), literal('searching'), literal('in_progress'), literal('failed')));
