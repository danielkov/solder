...
export const EmbeddingsCreateEmbeddingsRequestInputObjectContentItemObjectSchema: TypedSchema<EmbeddingsCreateEmbeddingsRequestInputObjectContentItemObject> = typed<EmbeddingsCreateEmbeddingsRequestInputObjectContentItemObject>(object({ imageUrl: InlineTypeObjectVideoUrlSchema, type: string() }));
