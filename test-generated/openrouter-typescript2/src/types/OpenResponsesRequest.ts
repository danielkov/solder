...
export const OpenResponsesRequestSchema: TypedSchema<OpenResponsesRequest> = typed<OpenResponsesRequest>(object({
  ...
  get include() {
    return optional(array(OpenAiResponsesIncludableSchema));
  },
  get input() {
    return optional(OpenResponsesInputSchema);
  },
  instructions: optional(string()),
  maxOutputTokens: optional(number()),
  get metadata() {
    return optional(OpenResponsesRequestMetadataSchema);
  },
  model: optional(string()),
  models: optional(array(string())),
  parallelToolCalls: optional(boolean()),
  get plugins() {
    return optional(array(PluginsItemUnionSchema));
  },
  previousResponseId: optional(string()),
  get prompt() {
    return optional(OpenAiResponsesPromptSchema);
  },
  promptCacheKey: optional(string()),
  get provider() {
    return optional(ProviderPropertySchema);
  },
  get reasoning() {
    return optional(OpenResponsesReasoningConfigSchema);
  },
  safetyIdentifier: optional(string()),
  get serviceTier() {
    return optional(ServiceTierUnionSchema);
  },
  store: optional(boolean()),
  stream: optional(boolean()),
  temperature: optional(number()),
  get text() {
    return optional(OpenResponsesResponseTextSchema);
  },
  get toolChoice() {
    return optional(OpenAiResponsesToolChoiceSchema);
  },
  get tools() {
    return optional(array(ToolsItemUnionSchema));
  },
  topK: optional(number()),
  topP: optional(number()),
  get truncation() {
    return optional(TruncationUnionSchema);
  },
