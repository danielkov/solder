...
export const OpenAiResponsesReasoningEffortSchema: TypedSchema<OpenAiResponsesReasoningEffort> = typed<OpenAiResponsesReasoningEffort>(union(literal('high'), literal('medium'), literal('low'), literal('minimal'), literal('none')));
