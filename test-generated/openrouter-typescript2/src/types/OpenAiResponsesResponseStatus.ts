...
export const OpenAiResponsesResponseStatusSchema: TypedSchema<OpenAiResponsesResponseStatus> = typed<OpenAiResponsesResponseStatus>(union(literal('completed'), literal('incomplete'), literal('in_progress'), literal('failed'), literal('cancelled'), literal('queued')));
