...
export const CreateAuthKeysCodeResponseDataSchema: TypedSchema<CreateAuthKeysCodeResponseData> = typed<CreateAuthKeysCodeResponseData>(object({ appId: number(), createdAt: string(), id: string() }));
