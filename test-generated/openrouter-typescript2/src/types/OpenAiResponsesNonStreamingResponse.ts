...
export const OpenAiResponsesNonStreamingResponseSchema: TypedSchema<OpenAiResponsesNonStreamingResponse> = typed<OpenAiResponsesNonStreamingResponse>(object({
  ...
  get reasoning() {
    return optional(OpenAiResponsesReasoningConfigSchema);
  },
  safetyIdentifier: optional(string()),
  get serviceTier() {
    return optional(OpenAiResponsesServiceTierSchema);
  },
  get status() {
    return optional(OpenAiResponsesResponseStatusSchema);
  },
  store: optional(boolean()),
  temperature: number(),
  get text() {
    return optional(ResponseTextConfigSchema);
  },
  ...
  topP: number(),
  get truncation() {
    return optional(OpenAiResponsesTruncationSchema);
  },
  get usage() {
    return optional(OpenAiResponsesUsageSchema);
  },
