...
export const ChatGenerationParamsSchema: TypedSchema<ChatGenerationParams> = typed<ChatGenerationParams>(object({
  get frequencyPenalty() {
    return optional(FrequencyPenaltyUnionSchema);
  },
  get logitBias() {
    return optional(LogitBiasUnionSchema);
  },
  get logprobs() {
    return optional(LogprobsUnionSchema);
  },
  get maxCompletionTokens() {
    return optional(MaxCompletionTokensUnionSchema);
  },
  get maxTokens() {
    return optional(MaxCompletionTokensUnionSchema);
  },
  ...
  get model() {
    return optional(ModelNameSchema);
  },
  get models() {
    return optional(array(ModelNameSchema));
  },
  get presencePenalty() {
    return optional(FrequencyPenaltyUnionSchema);
  },
  get reasoning() {
    return optional(ReasoningPropertySchema);
  },
  get responseFormat() {
    return optional(ResponseFormatUnionSchema);
  },
  get seed() {
    return optional(SeedUnionSchema);
  },
  get stop() {
    return optional(StopUnionSchema);
  },
  stream: optional(boolean()),
  get streamOptions() {
    return optional(StreamOptionsUnionSchema);
  },
  get temperature() {
    return optional(TemperatureUnionSchema);
  },
  get toolChoice() {
    return optional(ToolChoiceOptionSchema);
  },
  get tools() {
    return optional(array(ToolDefinitionJsonSchema));
  },
  get topLogprobs() {
    return optional(TopLogprobsUnionSchema);
  },
  get topP() {
    return optional(TopPUnionSchema);
  },
