...
export const OpenAiResponsesServiceTierSchema: TypedSchema<OpenAiResponsesServiceTier> = typed<OpenAiResponsesServiceTier>(union(literal('auto'), literal('default'), literal('flex'), literal('priority'), literal('scale')));
