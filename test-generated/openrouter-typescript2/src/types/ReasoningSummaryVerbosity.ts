...
export const ReasoningSummaryVerbositySchema: TypedSchema<ReasoningSummaryVerbosity> = typed<ReasoningSummaryVerbosity>(union(literal('auto'), literal('concise'), literal('detailed')));
