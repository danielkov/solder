import { array, literal, object, optional, string, typed } from '@speakeasy-api/tonic';
...
export const AssistantMessageSchema: TypedSchema<AssistantMessage> = typed<AssistantMessage>(object({
  get content() {
    return optional(ContentUnionSchema);
  },
  ...
  get toolCalls() {
    return optional(array(ChatMessageToolCallSchema));
  },
}));
