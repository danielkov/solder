...
export const CompletionCreateParamsSchema: TypedSchema<CompletionCreateParams> = typed<CompletionCreateParams>(object({
  get bestOf() {
    return optional(BestOfUnionSchema);
  },
  get echo() {
  ...
  get logprobs() {
    return optional(LogprobsUnion4Schema);
  },
  get maxTokens() {
    return optional(MaxTokensUnionSchema);
  },
  get metadata() {
    return optional(MetadataUnionSchema);
  },
  get model() {
  ...
  get responseFormat() {
    return optional(ResponseFormatUnion2Schema);
  },
  get seed() {
    return optional(SeedUnionSchema);
  },
  get stop() {
    return optional(StopUnion2Schema);
  },
  stream: optional(boolean()),
  get streamOptions() {
    return optional(StreamOptionsUnion2Schema);
  },
  get suffix() {
    return optional(ReasoningUnionSchema);
  },
  get temperature() {
