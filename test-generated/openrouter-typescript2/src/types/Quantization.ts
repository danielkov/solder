...
export const QuantizationSchema: TypedSchema<Quantization> = typed<Quantization>(union(literal('int4'), literal('int8'), literal('fp4'), literal('fp6'), literal('fp8'), literal('fp16'), literal('bf16'), literal('fp32'), literal('unknown')));
