...
export const ModelGroupSchema: TypedSchema<ModelGroup> = typed<ModelGroup>(union(literal('Router'), literal('Media'), literal('Other'), literal('GPT'), literal('Claude'), literal('Gemini'), literal('Grok'), literal('Cohere'), literal('Nova'), literal('Qwen'), literal('Yi'), literal('DeepSeek'), literal('Mistral'), literal('Llama2'), literal('Llama3'), literal('Llama4'), literal('PaLM'), literal('RWKV'), literal('Qwen3')));
