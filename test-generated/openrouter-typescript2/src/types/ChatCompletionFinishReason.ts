...
export const ChatCompletionFinishReasonSchema: TypedSchema<ChatCompletionFinishReason> = typed<ChatCompletionFinishReason>(union(literal('tool_calls'), literal('stop'), literal('length'), literal('content_filter'), literal('error')));
