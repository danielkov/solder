import { array, boolean, object, optional, typed } from '@speakeasy-api/tonic';
...
export const CreateEmbeddingsRequestProviderSchema: TypedSchema<CreateEmbeddingsRequestProvider> = typed<CreateEmbeddingsRequestProvider>(object({
  allowFallbacks: optional(boolean()),
  get dataCollection() {
    return optional(DataCollectionSchema);
  },
  enforceDistillableText: optional(boolean()),
  get ignore() {
    return optional(array(IgnoreItemOrRefSchema));
  },
  get maxPrice() {
    return optional(MaxPricePropertySchema);
  },
  get only() {
    return optional(array(IgnoreItemOrRefSchema));
  },
  ...
  get quantizations() {
    return optional(array(QuantizationSchema));
  },
  requireParameters: optional(boolean()),
  get sort() {
    return optional(ProviderSortSchema);
  },
