...
export const FaqCategorySchema: TypedSchema<FaqCategory> = typed<FaqCategory>(union(literal('general'), literal('orders'), literal('shipping'), literal('returns'), literal('pets')));
