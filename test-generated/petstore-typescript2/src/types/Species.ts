...
export const SpeciesSchema: TypedSchema<Species> = typed<Species>(union(literal('dog'), literal('cat'), literal('bird'), literal('rabbit'), literal('hamster'), literal('guinea_pig'), literal('fish'), literal('reptile'), literal('other')));
