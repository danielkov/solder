...
export class FilesService {
   ...
   * 
   */
  async uploadFile(params: { body: UploadFileRequest }): Promise<void> {
    const path = '/files';
   ...
   * 
   */
  async uploadMultipleFiles(params: { body: UploadMultipleFilesRequest }): Promise<void> {
   ...
   * 
   */
  async importFile(params: { body: FileImportRequest }): Promise<void> {
   ...
   * 
   */
  async uploadRawFile(params: { body: Uint8Array }): Promise<void> {
   ...
   * 
   */
  async uploadFileWithMetadata(params: { body: UploadFileWithMetadataRequest }): Promise<void> {
