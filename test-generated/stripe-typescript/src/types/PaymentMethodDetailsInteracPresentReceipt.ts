...
export const PaymentMethodDetailsInteracPresentReceiptSchema: TypedSchema<PaymentMethodDetailsInteracPresentReceipt> = typed<PaymentMethodDetailsInteracPresentReceipt>(object({
