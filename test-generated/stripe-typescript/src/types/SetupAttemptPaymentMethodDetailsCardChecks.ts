...
export const SetupAttemptPaymentMethodDetailsCardChecksSchema: TypedSchema<SetupAttemptPaymentMethodDetailsCardChecks> = typed<SetupAttemptPaymentMethodDetailsCardChecks>(object({
