...
export const CheckoutKonbiniPaymentMethodOptionsSchema: TypedSchema<CheckoutKonbiniPaymentMethodOptions> = typed<CheckoutKonbiniPaymentMethodOptions>(object({
