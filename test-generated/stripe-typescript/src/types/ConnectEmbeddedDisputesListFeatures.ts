...
export const ConnectEmbeddedDisputesListFeaturesSchema: TypedSchema<ConnectEmbeddedDisputesListFeatures> = typed<ConnectEmbeddedDisputesListFeatures>(object({
  capturePayments: boolean(),
  destinationOnBehalfOfChargeManagement: boolean(),
  disputeManagement: boolean(),
  refundManagement: boolean(),
