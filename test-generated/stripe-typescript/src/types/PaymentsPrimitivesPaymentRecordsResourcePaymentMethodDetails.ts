...
export const PaymentsPrimitivesPaymentRecordsResourcePaymentMethodDetailsSchema: TypedSchema<PaymentsPrimitivesPaymentRecordsResourcePaymentMethodDetails> = typed<PaymentsPrimitivesPaymentRecordsResourcePaymentMethodDetails>(object({
  ...
  get billingDetails() { return optional(PaymentsPrimitivesPaymentRecordsResourceBillingDetailsSchema) },
  get blik() { return optional(PaymentMethodDetailsBlikSchema) },
  get boleto() { return optional(PaymentMethodDetailsBoletoSchema) },
  get card() { return optional(PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsSchema) },
  ...
  get custom() { return optional(PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCustomDetailsSchema) },
  ...
  type: string(),
  get usBankAccount() { return optional(PaymentsPrimitivesPaymentRecordsResourcePaymentMethodUsBankAccountDetailsSchema) },
