...
import type { RatesProperty } from './RatesProperty';
import { RatesPropertySchema } from './RatesProperty';
/**
 * ExchangeRate
 *
...
export const ExchangeRateSchema: TypedSchema<ExchangeRate> = typed<ExchangeRate>(object({
  id: string(),
  object: string(),
  rates: RatesPropertySchema,
}));