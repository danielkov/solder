...
export const PaymentIntentPaymentMethodOptionsLinkSchema: TypedSchema<PaymentIntentPaymentMethodOptionsLink> = typed<PaymentIntentPaymentMethodOptionsLink>(object({
