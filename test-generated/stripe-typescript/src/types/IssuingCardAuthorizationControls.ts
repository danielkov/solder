...
import { IssuingCardSpendingLimitSchema } from './IssuingCardSpendingLimit';
/**
...
export const IssuingCardAuthorizationControlsSchema: TypedSchema<IssuingCardAuthorizationControls> = typed<IssuingCardAuthorizationControls>(object({
  ...
  get spendingLimits() { return optional(array(IssuingCardSpendingLimitSchema)) },
