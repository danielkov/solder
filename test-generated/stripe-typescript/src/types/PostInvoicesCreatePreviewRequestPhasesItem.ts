...
export const PostInvoicesCreatePreviewRequestPhasesItemSchema: TypedSchema<PostInvoicesCreatePreviewRequestPhasesItem> = typed<PostInvoicesCreatePreviewRequestPhasesItem>(object({
  ...
  get endDate() { return optional(PostInvoicesCreatePreviewRequestPhasesItemEndDateSchema) },
  ...
  get startDate() { return optional(PostInvoicesCreatePreviewRequestPhasesItemEndDateSchema) },
  get transferData() { return optional(DefaultPostCheckoutSessionsRequestTransferDataSchema) },
  trial: optional(boolean()),
  get trialEnd() { return optional(PostInvoicesCreatePreviewRequestPhasesItemEndDateSchema) },
}));