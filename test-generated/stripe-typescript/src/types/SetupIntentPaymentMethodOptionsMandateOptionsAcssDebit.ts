...
export const SetupIntentPaymentMethodOptionsMandateOptionsAcssDebitSchema: TypedSchema<SetupIntentPaymentMethodOptionsMandateOptionsAcssDebit> = typed<SetupIntentPaymentMethodOptionsMandateOptionsAcssDebit>(object({
