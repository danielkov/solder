...
export class PaymentsService {
   ...
   */
  async createBookingPayment(params: { body: BookingPayment }): Promise<CreateBookingPaymentUnion> {
      ...
      switch (response.status) {
        case 400: {
          try {
            ...
            if (e instanceof CreateBookingPaymentBadRequestError) {
              throw e;
            }
        ...
        case 401: {
          try {
            ...
            if (e instanceof CreateBookingPaymentUnauthorizedError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 403: {
          try {
            ...
            if (e instanceof CreateBookingPaymentForbiddenError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 429: {
          try {
            ...
            if (e instanceof CreateBookingPaymentTooManyRequestsError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 500: {
          try {
            ...
            if (e instanceof CreateBookingPaymentInternalServerErrorError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
