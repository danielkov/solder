    ...
    S: Clone + Send + Sync + 'static,
{
    ...
    fn router(self) -> Router<S> {
        let get_parameters_handler = |ctx: RequestContext<S>, Extension(service): Extension<Self>, axum::extract::Path(path_params): axum::extract::Path<(String, String)>, axum::extract::Query(query): axum::extract::Query<GetParametersQuery>
        | async move {
