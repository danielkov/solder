...
export class UsersService {
   ...
   */
  async listUsers(params: { page?: number; pageSize?: number; status?: string; role?: string; search?: string }): Promise<UserList> {
    const path = '/users';
      ...
      switch (response.status) {
        case 400: {
          try {
            ...
            if (e instanceof ListUsersBadRequestError) {
              throw e;
            }
        ...
        case 401: {
          try {
            ...
            if (e instanceof ListUsersUnauthorizedError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
   ...
   */
  async createUser(params: { body: UserCreate }): Promise<User> {
    const path = '/users';
      ...
      switch (response.status) {
        case 400: {
          try {
            ...
            if (e instanceof CreateUserBadRequestError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 401: {
          try {
            ...
            if (e instanceof CreateUserUnauthorizedError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
      ...
      switch (response.status) {
        case 401: {
          try {
            ...
            if (e instanceof GetUserByIdUnauthorizedError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 404: {
          try {
            ...
            if (e instanceof GetUserByIdNotFoundError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
   ...
   */
  async updateUser(params: { body: UserUpdate }): Promise<User> {
    const path = '/users/{userId}';
    const url = `${this.baseUrl}${path}`;
      ...
      switch (response.status) {
        case 400: {
          try {
            ...
            if (e instanceof UpdateUserBadRequestError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 401: {
          try {
            ...
            if (e instanceof UpdateUserUnauthorizedError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 404: {
          try {
            ...
            if (e instanceof UpdateUserNotFoundError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
      ...
      switch (response.status) {
        case 401: {
          try {
            ...
            if (e instanceof DeleteUserUnauthorizedError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 404: {
          try {
            ...
            if (e instanceof DeleteUserNotFoundError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
