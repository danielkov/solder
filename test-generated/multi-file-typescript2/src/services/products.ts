...
export class ProductsService {
   ...
   */
  async listProducts(params: { page?: number; pageSize?: number; category?: string; status?: string; minPrice?: number; maxPrice?: number; search?: string; tags?: string }): Promise<ProductList> {
    const path = '/products';
      ...
      switch (response.status) {
        case 400: {
          try {
            ...
            if (e instanceof ListProductsBadRequestError) {
              throw e;
            }
        ...
        case 401: {
          try {
            ...
            if (e instanceof ListProductsUnauthorizedError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
   ...
   */
  async createProduct(params: { body: ProductCreate }): Promise<Product> {
    const path = '/products';
      ...
      switch (response.status) {
        case 400: {
          try {
            ...
            if (e instanceof CreateProductBadRequestError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 401: {
          try {
            ...
            if (e instanceof CreateProductUnauthorizedError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 409: {
          try {
            ...
            if (e instanceof CreateProductConflictError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
      ...
      switch (response.status) {
        case 401: {
          try {
            ...
            if (e instanceof GetProductByIdUnauthorizedError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 404: {
          try {
            ...
            if (e instanceof GetProductByIdNotFoundError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
   ...
   */
  async updateProduct(params: { body: ProductUpdate }): Promise<Product> {
    const path = '/products/{productId}';
    const url = `${this.baseUrl}${path}`;
      ...
      switch (response.status) {
        case 400: {
          try {
            ...
            if (e instanceof UpdateProductBadRequestError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 401: {
          try {
            ...
            if (e instanceof UpdateProductUnauthorizedError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 404: {
          try {
            ...
            if (e instanceof UpdateProductNotFoundError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
      ...
      switch (response.status) {
        case 401: {
          try {
            ...
            if (e instanceof DeleteProductUnauthorizedError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 404: {
          try {
            ...
            if (e instanceof DeleteProductNotFoundError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
   ...
   */
  async updateProductInventory(params: { body: InventoryUpdate }): Promise<Product> {
      ...
      switch (response.status) {
        case 400: {
          try {
            ...
            if (e instanceof UpdateProductInventoryBadRequestError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 401: {
          try {
            ...
            if (e instanceof UpdateProductInventoryUnauthorizedError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 404: {
          try {
            ...
            if (e instanceof UpdateProductInventoryNotFoundError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
