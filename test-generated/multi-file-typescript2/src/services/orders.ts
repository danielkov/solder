...
export class OrdersService {
   ...
   */
  async listOrders(params: { page?: number; pageSize?: number; userId?: string; status?: string; paymentStatus?: string; startDate?: string; endDate?: string }): Promise<OrderList> {
    const path = '/orders';
      ...
      switch (response.status) {
        case 400: {
          try {
            ...
            if (e instanceof ListOrdersBadRequestError) {
              throw e;
            }
        ...
        case 401: {
          try {
            ...
            if (e instanceof ListOrdersUnauthorizedError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
   ...
   */
  async createOrder(params: { body: OrderCreate }): Promise<Order> {
    const path = '/orders';
      ...
      switch (response.status) {
        case 400: {
          try {
            ...
            if (e instanceof CreateOrderBadRequestError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 401: {
          try {
            ...
            if (e instanceof CreateOrderUnauthorizedError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
      ...
      switch (response.status) {
        case 401: {
          try {
            ...
            if (e instanceof GetOrderByIdUnauthorizedError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 404: {
          try {
            ...
            if (e instanceof GetOrderByIdNotFoundError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
      ...
      switch (response.status) {
        case 400: {
          try {
            ...
            if (e instanceof DeleteOrderBadRequestError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 401: {
          try {
            ...
            if (e instanceof DeleteOrderUnauthorizedError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 404: {
          try {
            ...
            if (e instanceof DeleteOrderNotFoundError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
   ...
   */
  async cancelOrder(params: { body: CancelOrderRequest }): Promise<Order> {
      ...
      switch (response.status) {
        case 400: {
          try {
            ...
            if (e instanceof CancelOrderBadRequestError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 401: {
          try {
            ...
            if (e instanceof CancelOrderUnauthorizedError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 404: {
          try {
            ...
            if (e instanceof CancelOrderNotFoundError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
