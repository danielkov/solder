...
export const SpecialEventFieldsSchema: TypedSchema<SpecialEventFields> = typed<SpecialEventFields>(object({
  get dates() {
    return optional(EventDatesSchema);
  },
  get eventDescription() {
    return optional(EventDescriptionSchema);
  },
  get location() {
    return optional(EventLocationSchema);
  },
  get name() {
    return optional(EventNameSchema);
  },
  get price() {
    return optional(EventPriceSchema);
  },
}));
