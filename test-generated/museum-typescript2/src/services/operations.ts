...
export class OperationsService {
   ...
   */
  async getMuseumHours(params: { startDate?: string; page?: number; limit?: number }): Promise<MuseumHours> {
      ...
      switch (response.status) {
        case 400: {
          try {
            ...
            if (e instanceof GetMuseumHoursBadRequestError) {
              throw e;
            }
        ...
        case 404: {
          try {
            ...
            if (e instanceof GetMuseumHoursNotFoundError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
