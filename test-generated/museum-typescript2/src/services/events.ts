...
export class EventsService {
   ...
   */
  async listSpecialEvents(params: { startDate?: string; endDate?: string; page?: number; limit?: number }): Promise<SpecialEventCollection> {
      ...
      switch (response.status) {
        case 400: {
          try {
            ...
            if (e instanceof ListSpecialEventsBadRequestError) {
              throw e;
            }
        ...
        case 404: {
          try {
            ...
            if (e instanceof ListSpecialEventsNotFoundError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
   ...
   */
  async createSpecialEvent(params: { body: SpecialEvent }): Promise<SpecialEvent> {
    const path = '/special-events';
      ...
      switch (response.status) {
        case 400: {
          try {
            ...
            if (e instanceof CreateSpecialEventBadRequestError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 404: {
          try {
            ...
            if (e instanceof CreateSpecialEventNotFoundError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
   ...
   */
  async getSpecialEvent(params: { eventId: string }): Promise<SpecialEvent> {
      ...
      switch (response.status) {
        case 400: {
          try {
            ...
            if (e instanceof GetSpecialEventBadRequestError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 404: {
          try {
            ...
            if (e instanceof GetSpecialEventNotFoundError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
   ...
   */
  async deleteSpecialEvent(params: { eventId: string }): Promise<void> {
    const path = `/special-events/{eventId}`.replace('{eventId}', String(params.eventId));
    const url = `${this.baseUrl}${path}`;
      ...
      switch (response.status) {
        case 400: {
          try {
            ...
            if (e instanceof DeleteSpecialEventBadRequestError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 401: {
          try {
            ...
            if (e instanceof DeleteSpecialEventUnauthorizedError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 404: {
          try {
            ...
            if (e instanceof DeleteSpecialEventNotFoundError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
   ...
   */
  async updateSpecialEvent(params: { eventId: string; body: SpecialEventFields }): Promise<SpecialEvent> {
    const path = `/special-events/{eventId}`.replace('{eventId}', String(params.eventId));
    const url = `${this.baseUrl}${path}`;
      ...
      switch (response.status) {
        case 400: {
          try {
            ...
            if (e instanceof UpdateSpecialEventBadRequestError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
        ...
        case 404: {
          try {
            ...
            if (e instanceof UpdateSpecialEventNotFoundError) {
              throw e;
            }
            await this.raise(new UnexpectedError(response.status, await response.text()));
          }
