...
export class DefaultService {
   ...
   * 
   */
  async getAccount(params: { expand?: Array<string>; body: GetAccountRequest }): Promise<Account> {
   ...
   * 
   */
  async postAccountLinks(params: { body: PostAccountLinksRequest }): Promise<AccountLink> {
   ...
   * 
   */
  async postAccountSessions(params: { body: PostAccountSessionsRequest }): Promise<AccountSession> {
   ...
   * 
   */
  async getAccounts(params: { created?: GetAccountsUnion; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetAccountsResponse> {
...
You can prefill any information on the account.</p>
   * 
   */
  async postAccounts(params: { body: PostAccountsRequest }): Promise<Account> {
    const path = '/v1/accounts';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getAccountsAccount(params: { account: string; expand?: Array<string>; body: GetAccountRequest }): Promise<Account> {
...
<a href="/docs/connect/updating-accounts">Connect</a> documentation to learn more about updating accounts.</p>
   * 
   */
  async postAccountsAccount(params: { account: string; body: PostAccountsAccountRequest }): Promise<Account> {
    const path = `/v1/accounts/{account}`.replace('{account}', String(params.account));
    const url = `${this.baseUrl}${path}`;
...
<p>If you want to delete your own account, use the <a href="https://dashboard.stripe.com/settings/account">account information tab in your account settings</a> instead.</p>
   * 
   */
  async deleteAccountsAccount(params: { account: string; body: GetAccountRequest }): Promise<DeletedAccount> {
    const path = `/v1/accounts/{account}`.replace('{account}', String(params.account));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async postAccountsAccountBankAccounts(params: { account: string; body: PostAccountsAccountBankAccountsRequest }): Promise<ExternalAccount> {
   ...
   * 
   */
  async getAccountsAccountBankAccountsId(params: { account: string; id: string; expand?: Array<string>; body: GetAccountRequest }): Promise<ExternalAccount> {
...
arguments or changes.</p>
   * 
   */
  async postAccountsAccountBankAccountsId(params: { account: string; id: string; body: PostAccountsAccountBankAccountsIdRequest }): Promise<ExternalAccount> {
    const path = `/v1/accounts/{account}/bank_accounts/{id}`.replace('{account}', String(params.account)).replace('{id}', String(params.id));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async deleteAccountsAccountBankAccountsId(params: { account: string; id: string; body: GetAccountRequest }): Promise<DeletedExternalAccount> {
    const path = `/v1/accounts/{account}/bank_accounts/{id}`.replace('{account}', String(params.account)).replace('{id}', String(params.id));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getAccountsAccountCapabilities(params: { account: string; expand?: Array<string>; body: GetAccountRequest }): Promise<GetAccountsAccountCapabilitiesResponse> {
   ...
   * 
   */
  async getAccountsAccountCapabilitiesCapability(params: { account: string; capability: string; expand?: Array<string>; body: GetAccountRequest }): Promise<Capability> {
   ...
   * 
   */
  async postAccountsAccountCapabilitiesCapability(params: { account: string; capability: string; body: PostAccountsAccountCapabilitiesCapabilityRequest }): Promise<Capability> {
    const path = `/v1/accounts/{account}/capabilities/{capability}`.replace('{account}', String(params.account)).replace('{capability}', String(params.capability));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getAccountsAccountExternalAccounts(params: { account: string; endingBefore?: string; expand?: Array<string>; limit?: number; object?: string; startingAfter?: string; body: GetAccountRequest }): Promise<GetAccountsAccountExternalAccountsResponse> {
   ...
   * 
   */
  async postAccountsAccountExternalAccounts(params: { account: string; body: PostAccountsAccountBankAccountsRequest }): Promise<ExternalAccount> {
    const path = `/v1/accounts/{account}/external_accounts`.replace('{account}', String(params.account));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getAccountsAccountExternalAccountsId(params: { account: string; id: string; expand?: Array<string>; body: GetAccountRequest }): Promise<ExternalAccount> {
...
arguments or changes.</p>
   * 
   */
  async postAccountsAccountExternalAccountsId(params: { account: string; id: string; body: PostAccountsAccountBankAccountsIdRequest }): Promise<ExternalAccount> {
    const path = `/v1/accounts/{account}/external_accounts/{id}`.replace('{account}', String(params.account)).replace('{id}', String(params.id));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async deleteAccountsAccountExternalAccountsId(params: { account: string; id: string; body: GetAccountRequest }): Promise<DeletedExternalAccount> {
    const path = `/v1/accounts/{account}/external_accounts/{id}`.replace('{account}', String(params.account)).replace('{id}', String(params.id));
    const url = `${this.baseUrl}${path}`;
...
<p><strong>You can only create login links for accounts that use the <a href="/connect/express-dashboard">Express Dashboard</a> and are connected to your platform</strong>.</p>
   * 
   */
  async postAccountsAccountLoginLinks(params: { account: string; body: PostAccountsAccountLoginLinksRequest }): Promise<LoginLink> {
   ...
   * 
   */
  async getAccountsAccountPeople(params: { account: string; endingBefore?: string; expand?: Array<string>; limit?: number; relationship?: GetAccountsAccountPeopleObject; startingAfter?: string; body: GetAccountRequest }): Promise<GetAccountsAccountPeopleResponse> {
   ...
   * 
   */
  async postAccountsAccountPeople(params: { account: string; body: PostAccountsAccountPeopleRequest }): Promise<Person> {
    const path = `/v1/accounts/{account}/people`.replace('{account}', String(params.account));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getAccountsAccountPeoplePerson(params: { account: string; person: string; expand?: Array<string>; body: GetAccountRequest }): Promise<Person> {
   ...
   * 
   */
  async postAccountsAccountPeoplePerson(params: { account: string; person: string; body: PostAccountsAccountPeopleRequest }): Promise<Person> {
    const path = `/v1/accounts/{account}/people/{person}`.replace('{account}', String(params.account)).replace('{person}', String(params.person));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async deleteAccountsAccountPeoplePerson(params: { account: string; person: string; body: GetAccountRequest }): Promise<DeletedPerson> {
    const path = `/v1/accounts/{account}/people/{person}`.replace('{account}', String(params.account)).replace('{person}', String(params.person));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getAccountsAccountPersons(params: { account: string; endingBefore?: string; expand?: Array<string>; limit?: number; relationship?: GetAccountsAccountPeopleObject; startingAfter?: string; body: GetAccountRequest }): Promise<GetAccountsAccountPeopleResponse> {
   ...
   * 
   */
  async postAccountsAccountPersons(params: { account: string; body: PostAccountsAccountPeopleRequest }): Promise<Person> {
    const path = `/v1/accounts/{account}/persons`.replace('{account}', String(params.account));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getAccountsAccountPersonsPerson(params: { account: string; person: string; expand?: Array<string>; body: GetAccountRequest }): Promise<Person> {
   ...
   * 
   */
  async postAccountsAccountPersonsPerson(params: { account: string; person: string; body: PostAccountsAccountPeopleRequest }): Promise<Person> {
    const path = `/v1/accounts/{account}/persons/{person}`.replace('{account}', String(params.account)).replace('{person}', String(params.person));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async deleteAccountsAccountPersonsPerson(params: { account: string; person: string; body: GetAccountRequest }): Promise<DeletedPerson> {
    const path = `/v1/accounts/{account}/persons/{person}`.replace('{account}', String(params.account)).replace('{person}', String(params.person));
    const url = `${this.baseUrl}${path}`;
...
<p>Only accounts where your platform is liable for negative account balances, which includes Custom and Express accounts, can be rejected. Test-mode accounts can be rejected at any time. Live-mode accounts can only be rejected after all balances are zero.</p>
   * 
   */
  async postAccountsAccountReject(params: { account: string; body: PostAccountsAccountRejectRequest }): Promise<Account> {
   ...
   * 
   */
  async getApplePayDomains(params: { domainName?: string; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetApplePayDomainsResponse> {
   ...
   * 
   */
  async postApplePayDomains(params: { body: PostApplePayDomainsRequest }): Promise<ApplePayDomain> {
    const path = '/v1/apple_pay/domains';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getApplePayDomainsDomain(params: { domain: string; expand?: Array<string>; body: GetAccountRequest }): Promise<ApplePayDomain> {
   ...
   * 
   */
  async deleteApplePayDomainsDomain(params: { domain: string; body: GetAccountRequest }): Promise<DeletedApplePayDomain> {
    const path = `/v1/apple_pay/domains/{domain}`.replace('{domain}', String(params.domain));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getApplicationFees(params: { charge?: string; created?: GetAccountsUnion; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetApplicationFeesResponse> {
   ...
   * 
   */
  async getApplicationFeesFeeRefundsId(params: { fee: string; id: string; expand?: Array<string>; body: GetAccountRequest }): Promise<FeeRefund> {
...
<p>This request only accepts metadata as an argument.</p>
   * 
   */
  async postApplicationFeesFeeRefundsId(params: { fee: string; id: string; body: PostApplicationFeesFeeRefundsIdRequest }): Promise<FeeRefund> {
    const path = `/v1/application_fees/{fee}/refunds/{id}`.replace('{fee}', String(params.fee)).replace('{id}', String(params.id));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getApplicationFeesId(params: { id: string; expand?: Array<string>; body: GetAccountRequest }): Promise<ApplicationFee> {
   ...
   * 
   */
  async postApplicationFeesIdRefund(params: { id: string; body: PostApplicationFeesIdRefundRequest }): Promise<ApplicationFee> {
   ...
   * 
   */
  async getApplicationFeesIdRefunds(params: { id: string; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetApplicationFeesIdRefundsResponse> {
...
or when trying to refund more money than is left on an application fee.</p>
   * 
   */
  async postApplicationFeesIdRefunds(params: { id: string; body: PostApplicationFeesIdRefundsRequest }): Promise<FeeRefund> {
    const path = `/v1/application_fees/{id}/refunds`.replace('{id}', String(params.id));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getAppsSecrets(params: { endingBefore?: string; expand?: Array<string>; limit?: number; scope: GetAppsSecretsObject; startingAfter?: string; body: GetAccountRequest }): Promise<GetAppsSecretsResponse> {
   ...
   * 
   */
  async postAppsSecrets(params: { body: PostAppsSecretsRequest }): Promise<AppsSecret> {
    const path = '/v1/apps/secrets';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async postAppsSecretsDelete(params: { body: PostAppsSecretsDeleteRequest }): Promise<AppsSecret> {
   ...
   * 
   */
  async getAppsSecretsFind(params: { expand?: Array<string>; name: string; scope: GetAppsSecretsObject; body: GetAccountRequest }): Promise<AppsSecret> {
 ...
 For a sample request, see <a href="/docs/connect/account-balances#accounting-for-negative-balances">Accounting for negative balances</a>.</p>
   * 
   */
  async getBalance(params: { expand?: Array<string>; body: GetAccountRequest }): Promise<Balance> {
...
<p>Note that this endpoint was previously called “Balance history” and used the path <code>/v1/balance/history</code>.</p>
   * 
   */
  async getBalanceHistory(params: { created?: GetAccountsUnion; currency?: string; endingBefore?: string; expand?: Array<string>; limit?: number; payout?: string; source?: string; startingAfter?: string; type?: string; body: GetAccountRequest }): Promise<GetBalanceHistoryResponse> {
...
<p>Note that this endpoint previously used the path <code>/v1/balance/history/:id</code>.</p>
   * 
   */
  async getBalanceHistoryId(params: { id: string; expand?: Array<string>; body: GetAccountRequest }): Promise<BalanceTransaction> {
 ...
 Related guide: <a href="/connect/authentication">Making API calls for connected accounts</a></p>
   * 
   */
  async getBalanceSettings(params: { expand?: Array<string>; body: GetAccountRequest }): Promise<BalanceSettings> {
 ...
 Related guide: <a href="/connect/authentication">Making API calls for connected accounts</a></p>
   * 
   */
  async postBalanceSettings(params: { body: PostBalanceSettingsRequest }): Promise<BalanceSettings> {
    const path = '/v1/balance_settings';
    const url = `${this.baseUrl}${path}`;
...
<p>Note that this endpoint was previously called “Balance history” and used the path <code>/v1/balance/history</code>.</p>
   * 
   */
  async getBalanceTransactions(params: { created?: GetAccountsUnion; currency?: string; endingBefore?: string; expand?: Array<string>; limit?: number; payout?: string; source?: string; startingAfter?: string; type?: string; body: GetAccountRequest }): Promise<GetBalanceHistoryResponse> {
...
<p>Note that this endpoint previously used the path <code>/v1/balance/history/:id</code>.</p>
   * 
   */
  async getBalanceTransactionsId(params: { id: string; expand?: Array<string>; body: GetAccountRequest }): Promise<BalanceTransaction> {
   ...
   * 
   */
  async getBillingAlerts(params: { alertType?: string; endingBefore?: string; expand?: Array<string>; limit?: number; meter?: string; startingAfter?: string; body: GetAccountRequest }): Promise<GetBillingAlertsResponse> {
   ...
   * 
   */
  async postBillingAlerts(params: { body: PostBillingAlertsRequest }): Promise<BillingAlert> {
    const path = '/v1/billing/alerts';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getBillingAlertsId(params: { id: string; expand?: Array<string>; body: GetAccountRequest }): Promise<BillingAlert> {
   ...
   * 
   */
  async postBillingAlertsIdActivate(params: { id: string; body: PostAccountsAccountLoginLinksRequest }): Promise<BillingAlert> {
   ...
   * 
   */
  async postBillingAlertsIdArchive(params: { id: string; body: PostAccountsAccountLoginLinksRequest }): Promise<BillingAlert> {
   ...
   * 
   */
  async postBillingAlertsIdDeactivate(params: { id: string; body: PostAccountsAccountLoginLinksRequest }): Promise<BillingAlert> {
   ...
   * 
   */
  async getBillingCreditBalanceSummary(params: { customer: string; expand?: Array<string>; filter: GetBillingCreditBalanceSummaryObject; body: GetAccountRequest }): Promise<BillingCreditBalanceSummary> {
   ...
   * 
   */
  async getBillingCreditBalanceTransactions(params: { creditGrant?: string; customer: string; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetBillingCreditBalanceTransactionsResponse> {
   ...
   * 
   */
  async getBillingCreditBalanceTransactionsId(params: { id: string; expand?: Array<string>; body: GetAccountRequest }): Promise<BillingCreditBalanceTransaction> {
   ...
   * 
   */
  async getBillingCreditGrants(params: { customer?: string; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetBillingCreditGrantsResponse> {
   ...
   * 
   */
  async postBillingCreditGrants(params: { body: PostBillingCreditGrantsRequest }): Promise<BillingCreditGrant> {
    const path = '/v1/billing/credit_grants';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getBillingCreditGrantsId(params: { id: string; expand?: Array<string>; body: GetAccountRequest }): Promise<BillingCreditGrant> {
   ...
   * 
   */
  async postBillingCreditGrantsId(params: { id: string; body: PostBillingCreditGrantsIdRequest }): Promise<BillingCreditGrant> {
    const path = `/v1/billing/credit_grants/{id}`.replace('{id}', String(params.id));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async postBillingCreditGrantsIdExpire(params: { id: string; body: PostAccountsAccountLoginLinksRequest }): Promise<BillingCreditGrant> {
   ...
   * 
   */
  async postBillingCreditGrantsIdVoid(params: { id: string; body: PostAccountsAccountLoginLinksRequest }): Promise<BillingCreditGrant> {
   ...
   * 
   */
  async postBillingMeterEventAdjustments(params: { body: PostBillingMeterEventAdjustmentsRequest }): Promise<BillingMeterEventAdjustment> {
   ...
   * 
   */
  async postBillingMeterEvents(params: { body: PostBillingMeterEventsRequest }): Promise<BillingMeterEvent> {
   ...
   * 
   */
  async getBillingMeters(params: { endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; status?: string; body: GetAccountRequest }): Promise<GetBillingMetersResponse> {
   ...
   * 
   */
  async postBillingMeters(params: { body: PostBillingMetersRequest }): Promise<BillingMeter> {
    const path = '/v1/billing/meters';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getBillingMetersId(params: { id: string; expand?: Array<string>; body: GetAccountRequest }): Promise<BillingMeter> {
   ...
   * 
   */
  async postBillingMetersId(params: { id: string; body: PostBillingMetersIdRequest }): Promise<BillingMeter> {
    const path = `/v1/billing/meters/{id}`.replace('{id}', String(params.id));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async postBillingMetersIdDeactivate(params: { id: string; body: PostAccountsAccountLoginLinksRequest }): Promise<BillingMeter> {
   ...
   * 
   */
  async getBillingMetersIdEventSummaries(params: { id: string; customer: string; endTime: number; endingBefore?: string; expand?: Array<string>; limit?: number; startTime: number; startingAfter?: string; valueGroupingWindow?: string; body: GetAccountRequest }): Promise<GetBillingMetersIdEventSummariesResponse> {
   ...
   * 
   */
  async postBillingMetersIdReactivate(params: { id: string; body: PostAccountsAccountLoginLinksRequest }): Promise<BillingMeter> {
   ...
   * 
   */
  async getBillingPortalConfigurations(params: { active?: boolean; endingBefore?: string; expand?: Array<string>; isDefault?: boolean; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetBillingPortalConfigurationsResponse> {
   ...
   * 
   */
  async postBillingPortalConfigurations(params: { body: PostBillingPortalConfigurationsRequest }): Promise<BillingPortalConfiguration> {
    const path = '/v1/billing_portal/configurations';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getBillingPortalConfigurationsConfiguration(params: { configuration: string; expand?: Array<string>; body: GetAccountRequest }): Promise<BillingPortalConfiguration> {
   ...
   * 
   */
  async postBillingPortalConfigurationsConfiguration(params: { configuration: string; body: PostBillingPortalConfigurationsConfigurationRequest }): Promise<BillingPortalConfiguration> {
    const path = `/v1/billing_portal/configurations/{configuration}`.replace('{configuration}', String(params.configuration));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async postBillingPortalSessions(params: { body: PostBillingPortalSessionsRequest }): Promise<BillingPortalSession> {
   ...
   * 
   */
  async getCharges(params: { created?: GetAccountsUnion; customer?: string; endingBefore?: string; expand?: Array<string>; limit?: number; paymentIntent?: string; startingAfter?: string; transferGroup?: string; body: GetAccountRequest }): Promise<GetChargesResponse> {
...
object used to request payment.</p>
   * 
   */
  async postCharges(params: { body: PostChargesRequest }): Promise<Charge> {
    const path = '/v1/charges';
    const url = `${this.baseUrl}${path}`;
...
to an hour behind during outages. Search functionality is not available to merchants in India.</p>
   * 
   */
  async getChargesSearch(params: { expand?: Array<string>; limit?: number; page?: string; query: string; body: GetAccountRequest }): Promise<GetChargesSearchResponse> {
   ...
   * 
   */
  async getChargesCharge(params: { charge: string; expand?: Array<string>; body: GetAccountRequest }): Promise<Charge> {
   ...
   * 
   */
  async postChargesCharge(params: { charge: string; body: PostChargesChargeRequest }): Promise<Charge> {
    const path = `/v1/charges/{charge}`.replace('{charge}', String(params.charge));
    const url = `${this.baseUrl}${path}`;
...
<p>Don’t use this method to capture a PaymentIntent-initiated charge. Use <a href="/docs/api/payment_intents/capture">Capture a PaymentIntent</a>.</p>
   * 
   */
  async postChargesChargeCapture(params: { charge: string; body: PostChargesChargeCaptureRequest }): Promise<Charge> {
   ...
   * 
   */
  async getChargesChargeDispute(params: { charge: string; expand?: Array<string>; body: GetAccountRequest }): Promise<Dispute> {
   ...
   * 
   */
  async postChargesChargeDispute(params: { charge: string; body: PostChargesChargeDisputeRequest }): Promise<Dispute> {
    const path = `/v1/charges/{charge}/dispute`.replace('{charge}', String(params.charge));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async postChargesChargeDisputeClose(params: { charge: string; body: PostAccountsAccountLoginLinksRequest }): Promise<Dispute> {
...
or when you attempt to refund more money than is left on a charge.</p>
   * 
   */
  async postChargesChargeRefund(params: { charge: string; body: PostChargesChargeRefundRequest }): Promise<Charge> {
   ...
   * 
   */
  async getChargesChargeRefunds(params: { charge: string; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetChargesChargeRefundsResponse> {
...
or when trying to refund more money than is left on a charge.</p>
   * 
   */
  async postChargesChargeRefunds(params: { charge: string; body: PostChargesChargeRefundsRequest }): Promise<Refund> {
    const path = `/v1/charges/{charge}/refunds`.replace('{charge}', String(params.charge));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getChargesChargeRefundsRefund(params: { charge: string; refund: string; expand?: Array<string>; body: GetAccountRequest }): Promise<Refund> {
   ...
   * 
   */
  async postChargesChargeRefundsRefund(params: { charge: string; refund: string; body: PostChargesChargeRefundsRefundRequest }): Promise<Refund> {
    const path = `/v1/charges/{charge}/refunds/{refund}`.replace('{charge}', String(params.charge)).replace('{refund}', String(params.refund));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getCheckoutSessions(params: { created?: GetAccountsUnion; customer?: string; customerDetails?: GetCheckoutSessionsObject; endingBefore?: string; expand?: Array<string>; limit?: number; paymentIntent?: string; paymentLink?: string; startingAfter?: string; status?: string; subscription?: string; body: GetAccountRequest }): Promise<GetCheckoutSessionsResponse> {
   ...
   * 
   */
  async postCheckoutSessions(params: { body: PostCheckoutSessionsRequest }): Promise<CheckoutSession> {
    const path = '/v1/checkout/sessions';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getCheckoutSessionsSession(params: { session: string; expand?: Array<string>; body: GetAccountRequest }): Promise<CheckoutSession> {
...
<p>Related guide: <a href="/payments/checkout/dynamic-updates">Dynamically update Checkout</a></p>
   * 
   */
  async postCheckoutSessionsSession(params: { session: string; body: PostCheckoutSessionsSessionRequest }): Promise<CheckoutSession> {
    const path = `/v1/checkout/sessions/{session}`.replace('{session}', String(params.session));
    const url = `${this.baseUrl}${path}`;
...
<p>After it expires, a customer can’t complete a Checkout Session and customers loading the Checkout Session see a message saying the Checkout Session is expired.</p>
   * 
   */
  async postCheckoutSessionsSessionExpire(params: { session: string; body: PostAccountsAccountLoginLinksRequest }): Promise<CheckoutSession> {
   ...
   * 
   */
  async getCheckoutSessionsSessionLineItems(params: { session: string; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetCheckoutSessionsSessionLineItemsResponse> {
...
most recently created orders appearing first.</p>
   * 
   */
  async getClimateOrders(params: { endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetClimateOrdersResponse> {
...
after creation and payment will be deducted your Stripe balance.</p>
   * 
   */
  async postClimateOrders(params: { body: PostClimateOrdersRequest }): Promise<ClimateOrder> {
    const path = '/v1/climate/orders';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getClimateOrdersOrder(params: { order: string; expand?: Array<string>; body: GetAccountRequest }): Promise<ClimateOrder> {
   ...
   * 
   */
  async postClimateOrdersOrder(params: { order: string; body: PostClimateOrdersOrderRequest }): Promise<ClimateOrder> {
    const path = `/v1/climate/orders/{order}`.replace('{order}', String(params.order));
    const url = `${this.baseUrl}${path}`;
...
provides 90 days advance notice and refunds the <code>amount_total</code>.</p>
   * 
   */
  async postClimateOrdersOrderCancel(params: { order: string; body: PostAccountsAccountLoginLinksRequest }): Promise<ClimateOrder> {
   ...
   * 
   */
  async getClimateProducts(params: { endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetClimateProductsResponse> {
   ...
   * 
   */
  async getClimateProductsProduct(params: { product: string; expand?: Array<string>; body: GetAccountRequest }): Promise<ClimateProduct> {
   ...
   * 
   */
  async getClimateSuppliers(params: { endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetClimateSuppliersResponse> {
   ...
   * 
   */
  async getClimateSuppliersSupplier(params: { supplier: string; expand?: Array<string>; body: GetAccountRequest }): Promise<ClimateSupplier> {
   ...
   * 
   */
  async getConfirmationTokensConfirmationToken(params: { confirmationToken: string; expand?: Array<string>; body: GetAccountRequest }): Promise<ConfirmationToken> {
   ...
   * 
   */
  async getCountrySpecs(params: { endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetCountrySpecsResponse> {
   ...
   * 
   */
  async getCountrySpecsCountry(params: { country: string; expand?: Array<string>; body: GetAccountRequest }): Promise<CountrySpec> {
   ...
   * 
   */
  async getCoupons(params: { created?: GetAccountsUnion; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetCouponsResponse> {
...
<p>A coupon has either a <code>percent_off</code> or an <code>amount_off</code> and <code>currency</code>. If you set an <code>amount_off</code>, that amount will be subtracted from any invoice’s subtotal. For example, an invoice with a subtotal of <currency>100</currency> will have a final total of <currency>0</currency> if a coupon with an <code>amount_off</code> of <amount>200</amount> is applied to it and an invoice with a subtotal of <currency>300</currency> will have a final total of <currency>100</currency> if a coupon with an <code>amount_off</code> of <amount>200</amount> is applied to it.</p>
   * 
   */
  async postCoupons(params: { body: PostCouponsRequest }): Promise<Coupon> {
    const path = '/v1/coupons';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getCouponsCoupon(params: { coupon: string; expand?: Array<string>; body: GetAccountRequest }): Promise<Coupon> {
   ...
   * 
   */
  async postCouponsCoupon(params: { coupon: string; body: PostCouponsCouponRequest }): Promise<Coupon> {
    const path = `/v1/coupons/{coupon}`.replace('{coupon}', String(params.coupon));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async deleteCouponsCoupon(params: { coupon: string; body: GetAccountRequest }): Promise<DeletedCoupon> {
    const path = `/v1/coupons/{coupon}`.replace('{coupon}', String(params.coupon));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getCreditNotes(params: { created?: GetAccountsUnion; customer?: string; endingBefore?: string; expand?: Array<string>; invoice?: string; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetCreditNotesResponse> {
...
<code>post_payment_credit_notes_amount</code>, or both, depending on the invoice’s <code>amount_remaining</code> at the time of credit note creation.</p>
   * 
   */
  async postCreditNotes(params: { body: PostCreditNotesRequest }): Promise<CreditNote> {
    const path = '/v1/credit_notes';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getCreditNotesPreview(params: { amount?: number; creditAmount?: number; effectiveAt?: number; emailType?: string; expand?: Array<string>; invoice: string; lines?: Array<PostCreditNotesRequestLinesItem>; memo?: string; metadata?: PostAccountsRequestMetadataObject; outOfBandAmount?: number; reason?: string; refundAmount?: number; refunds?: Array<PostCreditNotesRequestRefundsItem>; shippingCost?: GetCreditNotesPreviewObject; body: GetAccountRequest }): Promise<CreditNote> {
   ...
   * 
   */
  async getCreditNotesPreviewLines(params: { amount?: number; creditAmount?: number; effectiveAt?: number; emailType?: string; endingBefore?: string; expand?: Array<string>; invoice: string; limit?: number; lines?: Array<PostCreditNotesRequestLinesItem>; memo?: string; metadata?: PostAccountsRequestMetadataObject; outOfBandAmount?: number; reason?: string; refundAmount?: number; refunds?: Array<PostCreditNotesRequestRefundsItem>; shippingCost?: GetCreditNotesPreviewObject; startingAfter?: string; body: GetAccountRequest }): Promise<GetCreditNotesPreviewLinesResponse> {
   ...
   * 
   */
  async getCreditNotesCreditNoteLines(params: { creditNote: string; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetCreditNotesPreviewLinesResponse> {
   ...
   * 
   */
  async getCreditNotesId(params: { id: string; expand?: Array<string>; body: GetAccountRequest }): Promise<CreditNote> {
   ...
   * 
   */
  async postCreditNotesId(params: { id: string; body: PostCreditNotesIdRequest }): Promise<CreditNote> {
    const path = `/v1/credit_notes/{id}`.replace('{id}', String(params.id));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async postCreditNotesIdVoid(params: { id: string; body: PostAccountsAccountLoginLinksRequest }): Promise<CreditNote> {
   ...
   * 
   */
  async postCustomerSessions(params: { body: PostCustomerSessionsRequest }): Promise<CustomerSession> {
   ...
   * 
   */
  async getCustomers(params: { created?: GetAccountsUnion; email?: string; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; testClock?: string; body: GetAccountRequest }): Promise<GetCustomersResponse> {
   ...
   * 
   */
  async postCustomers(params: { body: PostCustomersRequest }): Promise<Customer> {
    const path = '/v1/customers';
    const url = `${this.baseUrl}${path}`;
...
to an hour behind during outages. Search functionality is not available to merchants in India.</p>
   * 
   */
  async getCustomersSearch(params: { expand?: Array<string>; limit?: number; page?: string; query: string; body: GetAccountRequest }): Promise<GetCustomersSearchResponse> {
   ...
   * 
   */
  async getCustomersCustomer(params: { customer: string; expand?: Array<string>; body: GetAccountRequest }): Promise<GetCustomersCustomerUnion> {
...
<p>This request accepts mostly the same arguments as the customer creation call.</p>
   * 
   */
  async postCustomersCustomer(params: { customer: string; body: PostCustomersCustomerRequest }): Promise<Customer> {
    const path = `/v1/customers/{customer}`.replace('{customer}', String(params.customer));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async deleteCustomersCustomer(params: { customer: string; body: GetAccountRequest }): Promise<DeletedCustomer> {
    const path = `/v1/customers/{customer}`.replace('{customer}', String(params.customer));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getCustomersCustomerBalanceTransactions(params: { customer: string; created?: GetAccountsUnion; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetCustomersCustomerBalanceTransactionsResponse> {
   ...
   * 
   */
  async postCustomersCustomerBalanceTransactions(params: { customer: string; body: PostCustomersCustomerBalanceTransactionsRequest }): Promise<CustomerBalanceTransaction> {
    const path = `/v1/customers/{customer}/balance_transactions`.replace('{customer}', String(params.customer));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getCustomersCustomerBalanceTransactionsTransaction(params: { customer: string; transaction: string; expand?: Array<string>; body: GetAccountRequest }): Promise<CustomerBalanceTransaction> {
   ...
   * 
   */
  async postCustomersCustomerBalanceTransactionsTransaction(params: { customer: string; transaction: string; body: PostCustomersCustomerBalanceTransactionsTransactionRequest }): Promise<CustomerBalanceTransaction> {
    const path = `/v1/customers/{customer}/balance_transactions/{transaction}`.replace('{customer}', String(params.customer)).replace('{transaction}', String(params.transaction));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getCustomersCustomerBankAccounts(params: { customer: string; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetCustomersCustomerBankAccountsResponse> {
...
To change the default, you should <a href="/docs/api#update_customer">update the customer</a> to have a new <code>default_source</code>.</p>
   * 
   */
  async postCustomersCustomerBankAccounts(params: { customer: string; body: PostCustomersCustomerBankAccountsRequest }): Promise<PaymentSource> {
    const path = `/v1/customers/{customer}/bank_accounts`.replace('{customer}', String(params.customer));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getCustomersCustomerBankAccountsId(params: { customer: string; id: string; expand?: Array<string>; body: GetAccountRequest }): Promise<BankAccount> {
   ...
   * 
   */
  async postCustomersCustomerBankAccountsId(params: { customer: string; id: string; body: PostCustomersCustomerBankAccountsIdRequest }): Promise<PostCustomersCustomerBankAccountsIdUnion> {
    const path = `/v1/customers/{customer}/bank_accounts/{id}`.replace('{customer}', String(params.customer)).replace('{id}', String(params.id));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async deleteCustomersCustomerBankAccountsId(params: { customer: string; id: string; body: PostAccountsAccountLoginLinksRequest }): Promise<DeleteCustomersCustomerBankAccountsIdUnion> {
    const path = `/v1/customers/{customer}/bank_accounts/{id}`.replace('{customer}', String(params.customer)).replace('{id}', String(params.id));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async postCustomersCustomerBankAccountsIdVerify(params: { customer: string; id: string; body: PostCustomersCustomerBankAccountsIdVerifyRequest }): Promise<BankAccount> {
...
If you need more than those 10, you can use this API method and the <code>limit</code> and <code>starting_after</code> parameters to page through additional cards.</p>
   * 
   */
  async getCustomersCustomerCards(params: { customer: string; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetCustomersCustomerCardsResponse> {
...
To change the default, you should <a href="/docs/api#update_customer">update the customer</a> to have a new <code>default_source</code>.</p>
   * 
   */
  async postCustomersCustomerCards(params: { customer: string; body: PostCustomersCustomerBankAccountsRequest }): Promise<PaymentSource> {
    const path = `/v1/customers/{customer}/cards`.replace('{customer}', String(params.customer));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getCustomersCustomerCardsId(params: { customer: string; id: string; expand?: Array<string>; body: GetAccountRequest }): Promise<Card> {
   ...
   * 
   */
  async postCustomersCustomerCardsId(params: { customer: string; id: string; body: PostCustomersCustomerBankAccountsIdRequest }): Promise<PostCustomersCustomerBankAccountsIdUnion> {
    const path = `/v1/customers/{customer}/cards/{id}`.replace('{customer}', String(params.customer)).replace('{id}', String(params.id));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async deleteCustomersCustomerCardsId(params: { customer: string; id: string; body: PostAccountsAccountLoginLinksRequest }): Promise<DeleteCustomersCustomerBankAccountsIdUnion> {
    const path = `/v1/customers/{customer}/cards/{id}`.replace('{customer}', String(params.customer)).replace('{id}', String(params.id));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getCustomersCustomerCashBalance(params: { customer: string; expand?: Array<string>; body: GetAccountRequest }): Promise<CashBalance> {
   ...
   * 
   */
  async postCustomersCustomerCashBalance(params: { customer: string; body: PostCustomersCustomerCashBalanceRequest }): Promise<CashBalance> {
    const path = `/v1/customers/{customer}/cash_balance`.replace('{customer}', String(params.customer));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getCustomersCustomerCashBalanceTransactions(params: { customer: string; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetCustomersCustomerCashBalanceTransactionsResponse> {
   ...
   * 
   */
  async getCustomersCustomerCashBalanceTransactionsTransaction(params: { customer: string; transaction: string; expand?: Array<string>; body: GetAccountRequest }): Promise<CustomerCashBalanceTransaction> {
   ...
   * 
   */
  async getCustomersCustomerDiscount(params: { customer: string; expand?: Array<string>; body: GetAccountRequest }): Promise<Discount> {
   ...
   * 
   */
  async deleteCustomersCustomerDiscount(params: { customer: string; body: GetAccountRequest }): Promise<DeletedDiscount> {
    const path = `/v1/customers/{customer}/discount`.replace('{customer}', String(params.customer));
    const url = `${this.baseUrl}${path}`;
...
funding instructions will be retrieved. In other words, we will return the same funding instructions each time.</p>
   * 
   */
  async postCustomersCustomerFundingInstructions(params: { customer: string; body: PostCustomersCustomerFundingInstructionsRequest }): Promise<FundingInstructions> {
   ...
   * 
   */
  async getCustomersCustomerPaymentMethods(params: { customer: string; allowRedisplay?: string; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; type?: string; body: GetAccountRequest }): Promise<GetCustomersCustomerPaymentMethodsResponse> {
   ...
   * 
   */
  async getCustomersCustomerPaymentMethodsPaymentMethod(params: { customer: string; paymentMethod: string; expand?: Array<string>; body: GetAccountRequest }): Promise<PaymentMethod> {
   ...
   * 
   */
  async getCustomersCustomerSources(params: { customer: string; endingBefore?: string; expand?: Array<string>; limit?: number; object?: string; startingAfter?: string; body: GetAccountRequest }): Promise<GetCustomersCustomerSourcesResponse> {
...
To change the default, you should <a href="/docs/api#update_customer">update the customer</a> to have a new <code>default_source</code>.</p>
   * 
   */
  async postCustomersCustomerSources(params: { customer: string; body: PostCustomersCustomerBankAccountsRequest }): Promise<PaymentSource> {
    const path = `/v1/customers/{customer}/sources`.replace('{customer}', String(params.customer));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getCustomersCustomerSourcesId(params: { customer: string; id: string; expand?: Array<string>; body: GetAccountRequest }): Promise<PaymentSource> {
   ...
   * 
   */
  async postCustomersCustomerSourcesId(params: { customer: string; id: string; body: PostCustomersCustomerBankAccountsIdRequest }): Promise<PostCustomersCustomerBankAccountsIdUnion> {
    const path = `/v1/customers/{customer}/sources/{id}`.replace('{customer}', String(params.customer)).replace('{id}', String(params.id));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async deleteCustomersCustomerSourcesId(params: { customer: string; id: string; body: PostAccountsAccountLoginLinksRequest }): Promise<DeleteCustomersCustomerBankAccountsIdUnion> {
    const path = `/v1/customers/{customer}/sources/{id}`.replace('{customer}', String(params.customer)).replace('{id}', String(params.id));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async postCustomersCustomerSourcesIdVerify(params: { customer: string; id: string; body: PostCustomersCustomerBankAccountsIdVerifyRequest }): Promise<BankAccount> {
   ...
   * 
   */
  async getCustomersCustomerSubscriptions(params: { customer: string; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetCustomersCustomerSubscriptionsResponse> {
   ...
   * 
   */
  async postCustomersCustomerSubscriptions(params: { customer: string; body: PostCustomersCustomerSubscriptionsRequest }): Promise<Subscription> {
    const path = `/v1/customers/{customer}/subscriptions`.replace('{customer}', String(params.customer));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getCustomersCustomerSubscriptionsSubscriptionExposedId(params: { customer: string; subscriptionExposedId: string; expand?: Array<string>; body: GetAccountRequest }): Promise<Subscription> {
   ...
   * 
   */
  async postCustomersCustomerSubscriptionsSubscriptionExposedId(params: { customer: string; subscriptionExposedId: string; body: PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequest }): Promise<Subscription> {
    const path = `/v1/customers/{customer}/subscriptions/{subscription_exposed_id}`.replace('{customer}', String(params.customer)).replace('{subscription_exposed_id}', String(params.subscriptionExposedId));
    const url = `${this.baseUrl}${path}`;
...
<p>By default, upon subscription cancellation, Stripe will stop automatic collection of all finalized invoices for the customer. This is intended to prevent unexpected payment attempts after the customer has canceled a subscription. However, you can resume automatic collection of the invoices manually after subscription cancellation to have us proceed. Or, you could check for unpaid invoices before allowing the customer to cancel the subscription at all.</p>
   * 
   */
  async deleteCustomersCustomerSubscriptionsSubscriptionExposedId(params: { customer: string; subscriptionExposedId: string; body: DeleteCustomersCustomerSubscriptionsSubscriptionExposedIdRequest }): Promise<Subscription> {
    const path = `/v1/customers/{customer}/subscriptions/{subscription_exposed_id}`.replace('{customer}', String(params.customer)).replace('{subscription_exposed_id}', String(params.subscriptionExposedId));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getCustomersCustomerSubscriptionsSubscriptionExposedIdDiscount(params: { customer: string; subscriptionExposedId: string; expand?: Array<string>; body: GetAccountRequest }): Promise<Discount> {
   ...
   * 
   */
  async deleteCustomersCustomerSubscriptionsSubscriptionExposedIdDiscount(params: { customer: string; subscriptionExposedId: string; body: GetAccountRequest }): Promise<DeletedDiscount> {
    const path = `/v1/customers/{customer}/subscriptions/{subscription_exposed_id}/discount`.replace('{customer}', String(params.customer)).replace('{subscription_exposed_id}', String(params.subscriptionExposedId));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getCustomersCustomerTaxIds(params: { customer: string; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetCustomersCustomerTaxIdsResponse> {
   ...
   * 
   */
  async postCustomersCustomerTaxIds(params: { customer: string; body: PostCustomersCustomerTaxIdsRequest }): Promise<TaxId> {
    const path = `/v1/customers/{customer}/tax_ids`.replace('{customer}', String(params.customer));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getCustomersCustomerTaxIdsId(params: { customer: string; id: string; expand?: Array<string>; body: GetAccountRequest }): Promise<TaxId> {
   ...
   * 
   */
  async deleteCustomersCustomerTaxIdsId(params: { customer: string; id: string; body: GetAccountRequest }): Promise<DeletedTaxId> {
    const path = `/v1/customers/{customer}/tax_ids/{id}`.replace('{customer}', String(params.customer)).replace('{id}', String(params.id));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getDisputes(params: { charge?: string; created?: GetAccountsUnion; endingBefore?: string; expand?: Array<string>; limit?: number; paymentIntent?: string; startingAfter?: string; body: GetAccountRequest }): Promise<GetDisputesResponse> {
   ...
   * 
   */
  async getDisputesDispute(params: { dispute: string; expand?: Array<string>; body: GetAccountRequest }): Promise<Dispute> {
...
<p>Depending on your dispute type, different evidence fields will give you a better chance of winning your dispute. To figure out which evidence fields to provide, see our <a href="/docs/disputes/categories">guide to dispute types</a>.</p>
   * 
   */
  async postDisputesDispute(params: { dispute: string; body: PostChargesChargeDisputeRequest }): Promise<Dispute> {
    const path = `/v1/disputes/{dispute}`.replace('{dispute}', String(params.dispute));
    const url = `${this.baseUrl}${path}`;
...
<p>The status of the dispute will change from <code>needs_response</code> to <code>lost</code>. <em>Closing a dispute is irreversible</em>.</p>
   * 
   */
  async postDisputesDisputeClose(params: { dispute: string; body: PostAccountsAccountLoginLinksRequest }): Promise<Dispute> {
   ...
   * 
   */
  async getEntitlementsActiveEntitlements(params: { customer: string; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetEntitlementsActiveEntitlementsResponse> {
   ...
   * 
   */
  async getEntitlementsActiveEntitlementsId(params: { id: string; expand?: Array<string>; body: GetAccountRequest }): Promise<EntitlementsActiveEntitlement> {
   ...
   * 
   */
  async getEntitlementsFeatures(params: { archived?: boolean; endingBefore?: string; expand?: Array<string>; limit?: number; lookupKey?: string; startingAfter?: string; body: GetAccountRequest }): Promise<GetEntitlementsFeaturesResponse> {
   ...
   * 
   */
  async postEntitlementsFeatures(params: { body: PostEntitlementsFeaturesRequest }): Promise<EntitlementsFeature> {
    const path = '/v1/entitlements/features';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getEntitlementsFeaturesId(params: { id: string; expand?: Array<string>; body: GetAccountRequest }): Promise<EntitlementsFeature> {
   ...
   * 
   */
  async postEntitlementsFeaturesId(params: { id: string; body: PostEntitlementsFeaturesIdRequest }): Promise<EntitlementsFeature> {
    const path = `/v1/entitlements/features/{id}`.replace('{id}', String(params.id));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async postEphemeralKeys(params: { body: PostEphemeralKeysRequest }): Promise<EphemeralKey> {
   ...
   * 
   */
  async deleteEphemeralKeysKey(params: { key: string; body: PostAccountsAccountLoginLinksRequest }): Promise<EphemeralKey> {
   ...
   * 
   */
  async getEvents(params: { created?: GetAccountsUnion; deliverySuccess?: boolean; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; type?: string; types?: Array<string>; body: GetAccountRequest }): Promise<GetEventsResponse> {
   ...
   * 
   */
  async getEventsId(params: { id: string; expand?: Array<string>; body: GetAccountRequest }): Promise<Event> {
...
<p>Returns a list of objects that contain the rates at which foreign currencies are converted to one another. Only shows the currencies for which Stripe supports.</p>
   * 
   */
  async getExchangeRates(params: { endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetExchangeRatesResponse> {
...
<p>Retrieves the exchange rates from the given currency to every supported currency.</p>
   * 
   */
  async getExchangeRatesRateId(params: { rateId: string; expand?: Array<string>; body: GetAccountRequest }): Promise<ExchangeRate> {
...
arguments or changes.</p>
   * 
   */
  async postExternalAccountsId(params: { id: string; body: PostAccountsAccountBankAccountsIdRequest }): Promise<ExternalAccount> {
   ...
   * 
   */
  async getFileLinks(params: { created?: GetAccountsUnion; endingBefore?: string; expand?: Array<string>; expired?: boolean; file?: string; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetFileLinksResponse> {
   ...
   * 
   */
  async postFileLinks(params: { body: PostFileLinksRequest }): Promise<FileLink> {
    const path = '/v1/file_links';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getFileLinksLink(params: { link: string; expand?: Array<string>; body: GetAccountRequest }): Promise<FileLink> {
   ...
   * 
   */
  async postFileLinksLink(params: { link: string; body: PostFileLinksLinkRequest }): Promise<FileLink> {
    const path = `/v1/file_links/{link}`.replace('{link}', String(params.link));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getFiles(params: { created?: GetAccountsUnion; endingBefore?: string; expand?: Array<string>; limit?: number; purpose?: string; startingAfter?: string; body: GetAccountRequest }): Promise<GetFilesResponse> {
    const path = '/v1/files';
    const queryParams = new URLSearchParams();
    if (params.created !== undefined) {
      queryParams.append('created', String(params.created));
...
<p>All of Stripe’s officially supported Client libraries support sending <code>multipart/form-data</code>.</p>
   * 
   */
  async postFiles(params: { body: PostFilesRequest }): Promise<File> {
    const path = '/v1/files';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getFilesFile(params: { file: string; expand?: Array<string>; body: GetAccountRequest }): Promise<File> {
   ...
   * 
   */
  async getFinancialConnectionsAccounts(params: { accountHolder?: GetFinancialConnectionsAccountsObject; endingBefore?: string; expand?: Array<string>; limit?: number; session?: string; startingAfter?: string; body: GetAccountRequest }): Promise<GetFinancialConnectionsAccountsResponse> {
   ...
   * 
   */
  async getFinancialConnectionsAccountsAccount(params: { account: string; expand?: Array<string>; body: GetAccountRequest }): Promise<FinancialConnectionsAccount> {
   ...
   * 
   */
  async postFinancialConnectionsAccountsAccountDisconnect(params: { account: string; body: PostAccountsAccountLoginLinksRequest }): Promise<FinancialConnectionsAccount> {
   ...
   * 
   */
  async getFinancialConnectionsAccountsAccountOwners(params: { account: string; endingBefore?: string; expand?: Array<string>; limit?: number; ownership: string; startingAfter?: string; body: GetAccountRequest }): Promise<GetFinancialConnectionsAccountsAccountOwnersResponse> {
   ...
   * 
   */
  async postFinancialConnectionsAccountsAccountRefresh(params: { account: string; body: PostFinancialConnectionsAccountsAccountRefreshRequest }): Promise<FinancialConnectionsAccount> {
   ...
   * 
   */
  async postFinancialConnectionsAccountsAccountSubscribe(params: { account: string; body: PostFinancialConnectionsAccountsAccountSubscribeRequest }): Promise<FinancialConnectionsAccount> {
   ...
   * 
   */
  async postFinancialConnectionsAccountsAccountUnsubscribe(params: { account: string; body: PostFinancialConnectionsAccountsAccountUnsubscribeRequest }): Promise<FinancialConnectionsAccount> {
   ...
   * 
   */
  async postFinancialConnectionsSessions(params: { body: PostFinancialConnectionsSessionsRequest }): Promise<FinancialConnectionsSession> {
   ...
   * 
   */
  async getFinancialConnectionsSessionsSession(params: { session: string; expand?: Array<string>; body: GetAccountRequest }): Promise<FinancialConnectionsSession> {
   ...
   * 
   */
  async getFinancialConnectionsTransactions(params: { account: string; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; transactedAt?: GetAccountsUnion; transactionRefresh?: GetFinancialConnectionsTransactionsObject; body: GetAccountRequest }): Promise<GetFinancialConnectionsTransactionsResponse> {
   ...
   * 
   */
  async getFinancialConnectionsTransactionsTransaction(params: { transaction: string; expand?: Array<string>; body: GetAccountRequest }): Promise<FinancialConnectionsTransaction> {
   ...
   * 
   */
  async getForwardingRequests(params: { created?: GetForwardingRequestsObject; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetForwardingRequestsResponse> {
   ...
   * 
   */
  async postForwardingRequests(params: { body: PostForwardingRequestsRequest }): Promise<ForwardingRequest> {
    const path = '/v1/forwarding/requests';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getForwardingRequestsId(params: { id: string; expand?: Array<string>; body: GetAccountRequest }): Promise<ForwardingRequest> {
   ...
   * 
   */
  async getIdentityVerificationReports(params: { clientReferenceId?: string; created?: GetAccountsUnion; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; type?: string; verificationSession?: string; body: GetAccountRequest }): Promise<GetIdentityVerificationReportsResponse> {
   ...
   * 
   */
  async getIdentityVerificationReportsReport(params: { report: string; expand?: Array<string>; body: GetAccountRequest }): Promise<IdentityVerificationReport> {
   ...
   * 
   */
  async getIdentityVerificationSessions(params: { clientReferenceId?: string; created?: GetAccountsUnion; endingBefore?: string; expand?: Array<string>; limit?: number; relatedCustomer?: string; startingAfter?: string; status?: string; body: GetAccountRequest }): Promise<GetIdentityVerificationSessionsResponse> {
...
<p>Related guide: <a href="/docs/identity/verify-identity-documents">Verify your users’ identity documents</a></p>
   * 
   */
  async postIdentityVerificationSessions(params: { body: PostIdentityVerificationSessionsRequest }): Promise<IdentityVerificationSession> {
    const path = '/v1/identity/verification_sessions';
    const url = `${this.baseUrl}${path}`;
...
<code>client_secret</code> or <code>url</code> to allow re-submission.</p>
   * 
   */
  async getIdentityVerificationSessionsSession(params: { session: string; expand?: Array<string>; body: GetAccountRequest }): Promise<IdentityVerificationSession> {
...
verification check and options.</p>
   * 
   */
  async postIdentityVerificationSessionsSession(params: { session: string; body: PostIdentityVerificationSessionsSessionRequest }): Promise<IdentityVerificationSession> {
    const path = `/v1/identity/verification_sessions/{session}`.replace('{session}', String(params.session));
    const url = `${this.baseUrl}${path}`;
...
<p>Once canceled, future submission attempts are disabled. This cannot be undone. <a href="/docs/identity/verification-sessions#cancel">Learn more</a>.</p>
   * 
   */
  async postIdentityVerificationSessionsSessionCancel(params: { session: string; body: PostAccountsAccountLoginLinksRequest }): Promise<IdentityVerificationSession> {
...
<p><a href="/docs/identity/verification-sessions#redact">Learn more</a>.</p>
   * 
   */
  async postIdentityVerificationSessionsSessionRedact(params: { session: string; body: PostAccountsAccountLoginLinksRequest }): Promise<IdentityVerificationSession> {
   ...
   * 
   */
  async getInvoicePayments(params: { created?: GetAccountsUnion; endingBefore?: string; expand?: Array<string>; invoice?: string; limit?: number; payment?: GetInvoicePaymentsObject; startingAfter?: string; status?: string; body: GetAccountRequest }): Promise<GetInvoicePaymentsResponse> {
   ...
   * 
   */
  async getInvoicePaymentsInvoicePayment(params: { invoicePayment: string; expand?: Array<string>; body: GetAccountRequest }): Promise<InvoicePayment> {
   ...
   * 
   */
  async getInvoiceRenderingTemplates(params: { endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; status?: string; body: GetAccountRequest }): Promise<GetInvoiceRenderingTemplatesResponse> {
   ...
   * 
   */
  async getInvoiceRenderingTemplatesTemplate(params: { template: string; expand?: Array<string>; version?: number; body: GetAccountRequest }): Promise<InvoiceRenderingTemplate> {
   ...
   * 
   */
  async postInvoiceRenderingTemplatesTemplateArchive(params: { template: string; body: PostAccountsAccountLoginLinksRequest }): Promise<InvoiceRenderingTemplate> {
   ...
   * 
   */
  async postInvoiceRenderingTemplatesTemplateUnarchive(params: { template: string; body: PostAccountsAccountLoginLinksRequest }): Promise<InvoiceRenderingTemplate> {
   ...
   * 
   */
  async getInvoiceitems(params: { created?: GetAccountsUnion; customer?: string; endingBefore?: string; expand?: Array<string>; invoice?: string; limit?: number; pending?: boolean; startingAfter?: string; body: GetAccountRequest }): Promise<GetInvoiceitemsResponse> {
   ...
   * 
   */
  async postInvoiceitems(params: { body: PostInvoiceitemsRequest }): Promise<Invoiceitem> {
    const path = '/v1/invoiceitems';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getInvoiceitemsInvoiceitem(params: { invoiceitem: string; expand?: Array<string>; body: GetAccountRequest }): Promise<Invoiceitem> {
   ...
   * 
   */
  async postInvoiceitemsInvoiceitem(params: { invoiceitem: string; body: PostInvoiceitemsInvoiceitemRequest }): Promise<Invoiceitem> {
    const path = `/v1/invoiceitems/{invoiceitem}`.replace('{invoiceitem}', String(params.invoiceitem));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async deleteInvoiceitemsInvoiceitem(params: { invoiceitem: string; body: GetAccountRequest }): Promise<DeletedInvoiceitem> {
    const path = `/v1/invoiceitems/{invoiceitem}`.replace('{invoiceitem}', String(params.invoiceitem));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getInvoices(params: { collectionMethod?: string; created?: GetAccountsUnion; customer?: string; dueDate?: GetAccountsUnion; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; status?: string; subscription?: string; body: GetAccountRequest }): Promise<GetInvoicesResponse> {
   ...
   * 
   */
  async postInvoices(params: { body: PostInvoicesRequest }): Promise<Invoice> {
    const path = '/v1/invoices';
    const url = `${this.baseUrl}${path}`;
...
<p>Note: Currency conversion calculations use the latest exchange rates. Exchange rates may vary between the time of the preview and the time of the actual invoice creation. <a href="https://docs.stripe.com/currencies/conversions">Learn more</a></p>
   * 
   */
  async postInvoicesCreatePreview(params: { body: PostInvoicesCreatePreviewRequest }): Promise<Invoice> {
...
to an hour behind during outages. Search functionality is not available to merchants in India.</p>
   * 
   */
  async getInvoicesSearch(params: { expand?: Array<string>; limit?: number; page?: string; query: string; body: GetAccountRequest }): Promise<GetInvoicesSearchResponse> {
   ...
   * 
   */
  async getInvoicesInvoice(params: { invoice: string; expand?: Array<string>; body: GetAccountRequest }): Promise<Invoice> {
...
<code>auto_advance=false</code>.</p>
   * 
   */
  async postInvoicesInvoice(params: { invoice: string; body: PostInvoicesInvoiceRequest }): Promise<Invoice> {
    const path = `/v1/invoices/{invoice}`.replace('{invoice}', String(params.invoice));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async deleteInvoicesInvoice(params: { invoice: string; body: GetAccountRequest }): Promise<DeletedInvoice> {
    const path = `/v1/invoices/{invoice}`.replace('{invoice}', String(params.invoice));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async postInvoicesInvoiceAddLines(params: { invoice: string; body: PostInvoicesInvoiceAddLinesRequest }): Promise<Invoice> {
...
<p>See: <a href="/docs/invoicing/partial-payments">Partial payments</a> to learn more.</p>
   * 
   */
  async postInvoicesInvoiceAttachPayment(params: { invoice: string; body: PostInvoicesInvoiceAttachPaymentRequest }): Promise<Invoice> {
   ...
   * 
   */
  async postInvoicesInvoiceFinalize(params: { invoice: string; body: PostInvoicesInvoiceFinalizeRequest }): Promise<Invoice> {
   ...
   * 
   */
  async getInvoicesInvoiceLines(params: { invoice: string; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetInvoicesInvoiceLinesResponse> {
...
Updating an invoice’s line item is only possible before the invoice is finalized.</p>
   * 
   */
  async postInvoicesInvoiceLinesLineItemId(params: { invoice: string; lineItemId: string; body: PostInvoicesInvoiceLinesLineItemIdRequest }): Promise<LineItem> {
   ...
   * 
   */
  async postInvoicesInvoiceMarkUncollectible(params: { invoice: string; body: PostAccountsAccountLoginLinksRequest }): Promise<Invoice> {
   ...
   * 
   */
  async postInvoicesInvoicePay(params: { invoice: string; body: PostInvoicesInvoicePayRequest }): Promise<Invoice> {
   ...
   * 
   */
  async postInvoicesInvoiceRemoveLines(params: { invoice: string; body: PostInvoicesInvoiceRemoveLinesRequest }): Promise<Invoice> {
...
<p>Requests made in test-mode result in no emails being sent, despite sending an <code>invoice.sent</code> event.</p>
   * 
   */
  async postInvoicesInvoiceSend(params: { invoice: string; body: PostAccountsAccountLoginLinksRequest }): Promise<Invoice> {
   ...
   * 
   */
  async postInvoicesInvoiceUpdateLines(params: { invoice: string; body: PostInvoicesInvoiceUpdateLinesRequest }): Promise<Invoice> {
...
<p>Consult with local regulations to determine whether and how an invoice might be amended, canceled, or voided in the jurisdiction you’re doing business in. You might need to <a href="#create_invoice">issue another invoice</a> or <a href="#create_credit_note">credit note</a> instead. Stripe recommends that you consult with your legal counsel for advice specific to your business.</p>
   * 
   */
  async postInvoicesInvoiceVoid(params: { invoice: string; body: PostAccountsAccountLoginLinksRequest }): Promise<Invoice> {
   ...
   * 
   */
  async getIssuingAuthorizations(params: { card?: string; cardholder?: string; created?: GetAccountsUnion; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; status?: string; body: GetAccountRequest }): Promise<GetIssuingAuthorizationsResponse> {
   ...
   * 
   */
  async getIssuingAuthorizationsAuthorization(params: { authorization: string; expand?: Array<string>; body: GetAccountRequest }): Promise<IssuingAuthorization> {
   ...
   * 
   */
  async postIssuingAuthorizationsAuthorization(params: { authorization: string; body: PostApplicationFeesFeeRefundsIdRequest }): Promise<IssuingAuthorization> {
    const path = `/v1/issuing/authorizations/{authorization}`.replace('{authorization}', String(params.authorization));
    const url = `${this.baseUrl}${path}`;
...
This method is deprecated. Instead, <a href="/docs/issuing/controls/real-time-authorizations#authorization-handling">respond directly to the webhook request to approve an authorization</a>.</p>
   * 
   */
  async postIssuingAuthorizationsAuthorizationApprove(params: { authorization: string; body: PostIssuingAuthorizationsAuthorizationApproveRequest }): Promise<IssuingAuthorization> {
...
This method is deprecated. Instead, <a href="/docs/issuing/controls/real-time-authorizations#authorization-handling">respond directly to the webhook request to decline an authorization</a>.</p>
   * 
   */
  async postIssuingAuthorizationsAuthorizationDecline(params: { authorization: string; body: PostApplicationFeesFeeRefundsIdRequest }): Promise<IssuingAuthorization> {
   ...
   * 
   */
  async getIssuingCardholders(params: { created?: GetAccountsUnion; email?: string; endingBefore?: string; expand?: Array<string>; limit?: number; phoneNumber?: string; startingAfter?: string; status?: string; type?: string; body: GetAccountRequest }): Promise<GetIssuingCardholdersResponse> {
   ...
   * 
   */
  async postIssuingCardholders(params: { body: PostIssuingCardholdersRequest }): Promise<IssuingCardholder> {
    const path = '/v1/issuing/cardholders';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getIssuingCardholdersCardholder(params: { cardholder: string; expand?: Array<string>; body: GetAccountRequest }): Promise<IssuingCardholder> {
   ...
   * 
   */
  async postIssuingCardholdersCardholder(params: { cardholder: string; body: PostIssuingCardholdersCardholderRequest }): Promise<IssuingCardholder> {
    const path = `/v1/issuing/cardholders/{cardholder}`.replace('{cardholder}', String(params.cardholder));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getIssuingCards(params: { cardholder?: string; created?: GetAccountsUnion; endingBefore?: string; expMonth?: number; expYear?: number; expand?: Array<string>; last4?: string; limit?: number; personalizationDesign?: string; startingAfter?: string; status?: string; type?: string; body: GetAccountRequest }): Promise<GetIssuingCardsResponse> {
   ...
   * 
   */
  async postIssuingCards(params: { body: PostIssuingCardsRequest }): Promise<IssuingCard> {
    const path = '/v1/issuing/cards';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getIssuingCardsCard(params: { card: string; expand?: Array<string>; body: GetAccountRequest }): Promise<IssuingCard> {
   ...
   * 
   */
  async postIssuingCardsCard(params: { card: string; body: PostIssuingCardsCardRequest }): Promise<IssuingCard> {
    const path = `/v1/issuing/cards/{card}`.replace('{card}', String(params.card));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getIssuingDisputes(params: { created?: GetAccountsUnion; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; status?: string; transaction?: string; body: GetAccountRequest }): Promise<GetIssuingDisputesResponse> {
   ...
   * 
   */
  async postIssuingDisputes(params: { body: PostIssuingDisputesRequest }): Promise<IssuingDispute> {
    const path = '/v1/issuing/disputes';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getIssuingDisputesDispute(params: { dispute: string; expand?: Array<string>; body: GetAccountRequest }): Promise<IssuingDispute> {
   ...
   * 
   */
  async postIssuingDisputesDispute(params: { dispute: string; body: PostIssuingDisputesDisputeRequest }): Promise<IssuingDispute> {
    const path = `/v1/issuing/disputes/{dispute}`.replace('{dispute}', String(params.dispute));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async postIssuingDisputesDisputeSubmit(params: { dispute: string; body: PostApplicationFeesFeeRefundsIdRequest }): Promise<IssuingDispute> {
   ...
   * 
   */
  async getIssuingPersonalizationDesigns(params: { endingBefore?: string; expand?: Array<string>; limit?: number; lookupKeys?: Array<string>; preferences?: GetIssuingPersonalizationDesignsObject; startingAfter?: string; status?: string; body: GetAccountRequest }): Promise<GetIssuingPersonalizationDesignsResponse> {
   ...
   * 
   */
  async postIssuingPersonalizationDesigns(params: { body: PostIssuingPersonalizationDesignsRequest }): Promise<IssuingPersonalizationDesign> {
    const path = '/v1/issuing/personalization_designs';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getIssuingPersonalizationDesignsPersonalizationDesign(params: { personalizationDesign: string; expand?: Array<string>; body: GetAccountRequest }): Promise<IssuingPersonalizationDesign> {
   ...
   * 
   */
  async postIssuingPersonalizationDesignsPersonalizationDesign(params: { personalizationDesign: string; body: PostIssuingPersonalizationDesignsPersonalizationDesignRequest }): Promise<IssuingPersonalizationDesign> {
    const path = `/v1/issuing/personalization_designs/{personalization_design}`.replace('{personalization_design}', String(params.personalizationDesign));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getIssuingPhysicalBundles(params: { endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; status?: string; type?: string; body: GetAccountRequest }): Promise<GetIssuingPhysicalBundlesResponse> {
   ...
   * 
   */
  async getIssuingPhysicalBundlesPhysicalBundle(params: { physicalBundle: string; expand?: Array<string>; body: GetAccountRequest }): Promise<IssuingPhysicalBundle> {
   ...
   * 
   */
  async getIssuingSettlementsSettlement(params: { settlement: string; expand?: Array<string>; body: GetAccountRequest }): Promise<IssuingSettlement> {
   ...
   * 
   */
  async postIssuingSettlementsSettlement(params: { settlement: string; body: PostIssuingSettlementsSettlementRequest }): Promise<IssuingSettlement> {
    const path = `/v1/issuing/settlements/{settlement}`.replace('{settlement}', String(params.settlement));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getIssuingTokens(params: { card: string; created?: GetAccountsUnion; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; status?: string; body: GetAccountRequest }): Promise<GetIssuingTokensResponse> {
   ...
   * 
   */
  async getIssuingTokensToken(params: { token: string; expand?: Array<string>; body: GetAccountRequest }): Promise<IssuingToken> {
   ...
   * 
   */
  async postIssuingTokensToken(params: { token: string; body: PostIssuingTokensTokenRequest }): Promise<IssuingToken> {
    const path = `/v1/issuing/tokens/{token}`.replace('{token}', String(params.token));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getIssuingTransactions(params: { card?: string; cardholder?: string; created?: GetAccountsUnion; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; type?: string; body: GetAccountRequest }): Promise<GetIssuingTransactionsResponse> {
   ...
   * 
   */
  async getIssuingTransactionsTransaction(params: { transaction: string; expand?: Array<string>; body: GetAccountRequest }): Promise<IssuingTransaction> {
   ...
   * 
   */
  async postIssuingTransactionsTransaction(params: { transaction: string; body: PostApplicationFeesFeeRefundsIdRequest }): Promise<IssuingTransaction> {
    const path = `/v1/issuing/transactions/{transaction}`.replace('{transaction}', String(params.transaction));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async postLinkAccountSessions(params: { body: PostFinancialConnectionsSessionsRequest }): Promise<FinancialConnectionsSession> {
   ...
   * 
   */
  async getLinkAccountSessionsSession(params: { session: string; expand?: Array<string>; body: GetAccountRequest }): Promise<FinancialConnectionsSession> {
   ...
   * 
   */
  async getLinkedAccounts(params: { accountHolder?: GetFinancialConnectionsAccountsObject; endingBefore?: string; expand?: Array<string>; limit?: number; session?: string; startingAfter?: string; body: GetAccountRequest }): Promise<GetFinancialConnectionsAccountsResponse> {
   ...
   * 
   */
  async getLinkedAccountsAccount(params: { account: string; expand?: Array<string>; body: GetAccountRequest }): Promise<FinancialConnectionsAccount> {
   ...
   * 
   */
  async postLinkedAccountsAccountDisconnect(params: { account: string; body: PostAccountsAccountLoginLinksRequest }): Promise<FinancialConnectionsAccount> {
   ...
   * 
   */
  async getLinkedAccountsAccountOwners(params: { account: string; endingBefore?: string; expand?: Array<string>; limit?: number; ownership: string; startingAfter?: string; body: GetAccountRequest }): Promise<GetFinancialConnectionsAccountsAccountOwnersResponse> {
   ...
   * 
   */
  async postLinkedAccountsAccountRefresh(params: { account: string; body: PostFinancialConnectionsAccountsAccountRefreshRequest }): Promise<FinancialConnectionsAccount> {
   ...
   * 
   */
  async getMandatesMandate(params: { mandate: string; expand?: Array<string>; body: GetAccountRequest }): Promise<Mandate> {
   ...
   * 
   */
  async getPaymentAttemptRecords(params: { expand?: Array<string>; limit?: number; paymentRecord: string; startingAfter?: string; body: GetAccountRequest }): Promise<GetPaymentAttemptRecordsResponse> {
   ...
   * 
   */
  async getPaymentAttemptRecordsId(params: { id: string; expand?: Array<string>; body: GetAccountRequest }): Promise<PaymentAttemptRecord> {
   ...
   * 
   */
  async getPaymentIntents(params: { created?: GetAccountsUnion; customer?: string; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetPaymentIntentsResponse> {
...
<code>confirm=true</code>.</p>
   * 
   */
  async postPaymentIntents(params: { body: PostPaymentIntentsRequest }): Promise<PaymentIntent> {
    const path = '/v1/payment_intents';
    const url = `${this.baseUrl}${path}`;
...
to an hour behind during outages. Search functionality is not available to merchants in India.</p>
   * 
   */
  async getPaymentIntentsSearch(params: { expand?: Array<string>; limit?: number; page?: string; query: string; body: GetAccountRequest }): Promise<GetPaymentIntentsSearchResponse> {
...
<p>If you retrieve a PaymentIntent with a publishable key, it only returns a subset of properties. Refer to the <a href="#payment_intent_object">payment intent</a> object reference for more details.</p>
   * 
   */
  async getPaymentIntentsIntent(params: { intent: string; clientSecret?: string; expand?: Array<string>; body: GetAccountRequest }): Promise<PaymentIntent> {
...
the <a href="/docs/api/payment_intents/confirm">confirm API</a> instead.</p>
   * 
   */
  async postPaymentIntentsIntent(params: { intent: string; body: PostPaymentIntentsIntentRequest }): Promise<PaymentIntent> {
    const path = `/v1/payment_intents/{intent}`.replace('{intent}', String(params.intent));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getPaymentIntentsIntentAmountDetailsLineItems(params: { intent: string; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetPaymentIntentsIntentAmountDetailsLineItemsResponse> {
   ...
   * 
   */
  async postPaymentIntentsIntentApplyCustomerBalance(params: { intent: string; body: PostPaymentIntentsIntentApplyCustomerBalanceRequest }): Promise<PaymentIntent> {
...
<p>You can’t cancel the PaymentIntent for a Checkout Session. <a href="/docs/api/checkout/sessions/expire">Expire the Checkout Session</a> instead.</p>
   * 
   */
  async postPaymentIntentsIntentCancel(params: { intent: string; body: PostPaymentIntentsIntentCancelRequest }): Promise<PaymentIntent> {
...
<p>Learn more about <a href="/docs/payments/capture-later">separate authorization and capture</a>.</p>
   * 
   */
  async postPaymentIntentsIntentCapture(params: { intent: string; body: PostPaymentIntentsIntentCaptureRequest }): Promise<PaymentIntent> {
...
transition the PaymentIntent to the <code>canceled</code> state.</p>
   * 
   */
  async postPaymentIntentsIntentConfirm(params: { intent: string; body: PostPaymentIntentsIntentConfirmRequest }): Promise<PaymentIntent> {
...
<p>Learn more about <a href="/docs/terminal/features/incremental-authorizations">incremental authorizations</a>.</p>
   * 
   */
  async postPaymentIntentsIntentIncrementAuthorization(params: { intent: string; body: PostPaymentIntentsIntentIncrementAuthorizationRequest }): Promise<PaymentIntent> {
   ...
   * 
   */
  async postPaymentIntentsIntentVerifyMicrodeposits(params: { intent: string; body: PostPaymentIntentsIntentVerifyMicrodepositsRequest }): Promise<PaymentIntent> {
   ...
   * 
   */
  async getPaymentLinks(params: { active?: boolean; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetPaymentLinksResponse> {
   ...
   * 
   */
  async postPaymentLinks(params: { body: PostPaymentLinksRequest }): Promise<PaymentLink> {
    const path = '/v1/payment_links';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getPaymentLinksPaymentLink(params: { paymentLink: string; expand?: Array<string>; body: GetAccountRequest }): Promise<PaymentLink> {
   ...
   * 
   */
  async postPaymentLinksPaymentLink(params: { paymentLink: string; body: PostPaymentLinksPaymentLinkRequest }): Promise<PaymentLink> {
    const path = `/v1/payment_links/{payment_link}`.replace('{payment_link}', String(params.paymentLink));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getPaymentLinksPaymentLinkLineItems(params: { paymentLink: string; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetPaymentLinksPaymentLinkLineItemsResponse> {
   ...
   * 
   */
  async getPaymentMethodConfigurations(params: { application?: GetPaymentMethodConfigurationsUnion; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetPaymentMethodConfigurationsResponse> {
   ...
   * 
   */
  async postPaymentMethodConfigurations(params: { body: PostPaymentMethodConfigurationsRequest }): Promise<PaymentMethodConfiguration> {
    const path = '/v1/payment_method_configurations';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getPaymentMethodConfigurationsConfiguration(params: { configuration: string; expand?: Array<string>; body: GetAccountRequest }): Promise<PaymentMethodConfiguration> {
   ...
   * 
   */
  async postPaymentMethodConfigurationsConfiguration(params: { configuration: string; body: PostPaymentMethodConfigurationsConfigurationRequest }): Promise<PaymentMethodConfiguration> {
    const path = `/v1/payment_method_configurations/{configuration}`.replace('{configuration}', String(params.configuration));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getPaymentMethodDomains(params: { domainName?: string; enabled?: boolean; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetPaymentMethodDomainsResponse> {
   ...
   * 
   */
  async postPaymentMethodDomains(params: { body: PostPaymentMethodDomainsRequest }): Promise<PaymentMethodDomain> {
    const path = '/v1/payment_method_domains';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getPaymentMethodDomainsPaymentMethodDomain(params: { paymentMethodDomain: string; expand?: Array<string>; body: GetAccountRequest }): Promise<PaymentMethodDomain> {
   ...
   * 
   */
  async postPaymentMethodDomainsPaymentMethodDomain(params: { paymentMethodDomain: string; body: PostPaymentMethodDomainsPaymentMethodDomainRequest }): Promise<PaymentMethodDomain> {
    const path = `/v1/payment_method_domains/{payment_method_domain}`.replace('{payment_method_domain}', String(params.paymentMethodDomain));
    const url = `${this.baseUrl}${path}`;
...
<p>Related guides: <a href="/docs/payments/payment-methods/pmd-registration">Payment method domains</a>.</p>
   * 
   */
  async postPaymentMethodDomainsPaymentMethodDomainValidate(params: { paymentMethodDomain: string; body: PostAccountsAccountLoginLinksRequest }): Promise<PaymentMethodDomain> {
   ...
   * 
   */
  async getPaymentMethods(params: { customer?: string; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; type?: string; body: GetAccountRequest }): Promise<GetPaymentMethodsResponse> {
...
<p>Instead of creating a PaymentMethod directly, we recommend using the <a href="/docs/payments/accept-a-payment">PaymentIntents</a> API to accept a payment immediately or the <a href="/docs/payments/save-and-reuse">SetupIntent</a> API to collect payment method details ahead of a future payment.</p>
   * 
   */
  async postPaymentMethods(params: { body: PostPaymentMethodsRequest }): Promise<PaymentMethod> {
    const path = '/v1/payment_methods';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getPaymentMethodsPaymentMethod(params: { paymentMethod: string; expand?: Array<string>; body: GetAccountRequest }): Promise<PaymentMethod> {
   ...
   * 
   */
  async postPaymentMethodsPaymentMethod(params: { paymentMethod: string; body: PostPaymentMethodsPaymentMethodRequest }): Promise<PaymentMethod> {
    const path = `/v1/payment_methods/{payment_method}`.replace('{payment_method}', String(params.paymentMethod));
    const url = `${this.baseUrl}${path}`;
...
on the Customer to the PaymentMethod’s ID.</p>
   * 
   */
  async postPaymentMethodsPaymentMethodAttach(params: { paymentMethod: string; body: PostPaymentMethodsPaymentMethodAttachRequest }): Promise<PaymentMethod> {
   ...
   * 
   */
  async postPaymentMethodsPaymentMethodDetach(params: { paymentMethod: string; body: PostAccountsAccountLoginLinksRequest }): Promise<PaymentMethod> {
 ...
 Records in a terminal state directly, through this method.</p>
   * 
   */
  async postPaymentRecordsReportPayment(params: { body: PostPaymentRecordsReportPaymentRequest }): Promise<PaymentRecord> {
   ...
   * 
   */
  async getPaymentRecordsId(params: { id: string; expand?: Array<string>; body: GetAccountRequest }): Promise<PaymentRecord> {
 ...
 attempt can only be specified if all other payment attempts are canceled or failed.</p>
   * 
   */
  async postPaymentRecordsIdReportPaymentAttempt(params: { id: string; body: PostPaymentRecordsIdReportPaymentAttemptRequest }): Promise<PaymentRecord> {
 ...
 was canceled.</p>
   * 
   */
  async postPaymentRecordsIdReportPaymentAttemptCanceled(params: { id: string; body: PostPaymentRecordsIdReportPaymentAttemptCanceledRequest }): Promise<PaymentRecord> {
 ...
 failed or errored.</p>
   * 
   */
  async postPaymentRecordsIdReportPaymentAttemptFailed(params: { id: string; body: PostPaymentRecordsIdReportPaymentAttemptFailedRequest }): Promise<PaymentRecord> {
 ...
 was guaranteed.</p>
   * 
   */
  async postPaymentRecordsIdReportPaymentAttemptGuaranteed(params: { id: string; body: PostPaymentRecordsIdReportPaymentAttemptGuaranteedRequest }): Promise<PaymentRecord> {
   ...
   * 
   */
  async postPaymentRecordsIdReportPaymentAttemptInformational(params: { id: string; body: PostPaymentRecordsIdReportPaymentAttemptInformationalRequest }): Promise<PaymentRecord> {
 ...
 was refunded.</p>
   * 
   */
  async postPaymentRecordsIdReportRefund(params: { id: string; body: PostPaymentRecordsIdReportRefundRequest }): Promise<PaymentRecord> {
   ...
   * 
   */
  async getPayouts(params: { arrivalDate?: GetAccountsUnion; created?: GetAccountsUnion; destination?: string; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; status?: string; body: GetAccountRequest }): Promise<GetPayoutsResponse> {
...
<p>If you create a manual payout on a Stripe account that uses multiple payment source types, you need to specify the source type balance that the payout draws from. The <a href="#balance_object">balance object</a> details available and pending amounts by source type.</p>
   * 
   */
  async postPayouts(params: { body: PostPayoutsRequest }): Promise<Payout> {
    const path = '/v1/payouts';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getPayoutsPayout(params: { payout: string; expand?: Array<string>; body: GetAccountRequest }): Promise<Payout> {
   ...
   * 
   */
  async postPayoutsPayout(params: { payout: string; body: PostApplicationFeesFeeRefundsIdRequest }): Promise<Payout> {
    const path = `/v1/payouts/{payout}`.replace('{payout}', String(params.payout));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async postPayoutsPayoutCancel(params: { payout: string; body: PostAccountsAccountLoginLinksRequest }): Promise<Payout> {
...
<p>By requesting a reversal through <code>/v1/payouts/:id/reverse</code>, you confirm that the authorized signatory of the selected bank account authorizes the debit on the bank account and that no other authorization is required.</p>
   * 
   */
  async postPayoutsPayoutReverse(params: { payout: string; body: PostIssuingSettlementsSettlementRequest }): Promise<Payout> {
   ...
   * 
   */
  async getPlans(params: { active?: boolean; created?: GetAccountsUnion; endingBefore?: string; expand?: Array<string>; limit?: number; product?: string; startingAfter?: string; body: GetAccountRequest }): Promise<GetPlansResponse> {
    const path = '/v1/plans';
    const queryParams = new URLSearchParams();
    if (params.active !== undefined) {
      queryParams.append('active', String(params.active));
   ...
   * 
   */
  async postPlans(params: { body: PostPlansRequest }): Promise<Plan> {
    const path = '/v1/plans';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getPlansPlan(params: { plan: string; expand?: Array<string>; body: GetAccountRequest }): Promise<Plan> {
   ...
   * 
   */
  async postPlansPlan(params: { plan: string; body: PostPlansPlanRequest }): Promise<Plan> {
    const path = `/v1/plans/{plan}`.replace('{plan}', String(params.plan));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async deletePlansPlan(params: { plan: string; body: GetAccountRequest }): Promise<DeletedPlan> {
    const path = `/v1/plans/{plan}`.replace('{plan}', String(params.plan));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getPrices(params: { active?: boolean; created?: GetAccountsUnion; currency?: string; endingBefore?: string; expand?: Array<string>; limit?: number; lookupKeys?: Array<string>; product?: string; recurring?: GetPricesObject; startingAfter?: string; type?: string; body: GetAccountRequest }): Promise<GetPricesResponse> {
   ...
   * 
   */
  async postPrices(params: { body: PostPricesRequest }): Promise<Price> {
    const path = '/v1/prices';
    const url = `${this.baseUrl}${path}`;
...
to an hour behind during outages. Search functionality is not available to merchants in India.</p>
   * 
   */
  async getPricesSearch(params: { expand?: Array<string>; limit?: number; page?: string; query: string; body: GetAccountRequest }): Promise<GetPricesSearchResponse> {
   ...
   * 
   */
  async getPricesPrice(params: { price: string; expand?: Array<string>; body: GetAccountRequest }): Promise<Price> {
   ...
   * 
   */
  async postPricesPrice(params: { price: string; body: PostPricesPriceRequest }): Promise<Price> {
    const path = `/v1/prices/{price}`.replace('{price}', String(params.price));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getProducts(params: { active?: boolean; created?: GetAccountsUnion; endingBefore?: string; expand?: Array<string>; ids?: Array<string>; limit?: number; shippable?: boolean; startingAfter?: string; url?: string; body: GetAccountRequest }): Promise<GetProductsResponse> {
   ...
   * 
   */
  async postProducts(params: { body: PostProductsRequest }): Promise<Product> {
    const path = '/v1/products';
    const url = `${this.baseUrl}${path}`;
...
to an hour behind during outages. Search functionality is not available to merchants in India.</p>
   * 
   */
  async getProductsSearch(params: { expand?: Array<string>; limit?: number; page?: string; query: string; body: GetAccountRequest }): Promise<GetProductsSearchResponse> {
   ...
   * 
   */
  async getProductsId(params: { id: string; expand?: Array<string>; body: GetAccountRequest }): Promise<Product> {
   ...
   * 
   */
  async postProductsId(params: { id: string; body: PostProductsIdRequest }): Promise<Product> {
    const path = `/v1/products/{id}`.replace('{id}', String(params.id));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async deleteProductsId(params: { id: string; body: GetAccountRequest }): Promise<DeletedProduct> {
    const path = `/v1/products/{id}`.replace('{id}', String(params.id));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getProductsProductFeatures(params: { product: string; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetProductsProductFeaturesResponse> {
   ...
   * 
   */
  async postProductsProductFeatures(params: { product: string; body: PostProductsProductFeaturesRequest }): Promise<ProductFeature> {
    const path = `/v1/products/{product}/features`.replace('{product}', String(params.product));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getProductsProductFeaturesId(params: { id: string; product: string; expand?: Array<string>; body: GetAccountRequest }): Promise<ProductFeature> {
   ...
   * 
   */
  async deleteProductsProductFeaturesId(params: { id: string; product: string; body: GetAccountRequest }): Promise<DeletedProductFeature> {
    const path = `/v1/products/{product}/features/{id}`.replace('{id}', String(params.id)).replace('{product}', String(params.product));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getPromotionCodes(params: { active?: boolean; code?: string; coupon?: string; created?: GetAccountsUnion; customer?: string; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetPromotionCodesResponse> {
   ...
   * 
   */
  async postPromotionCodes(params: { body: PostPromotionCodesRequest }): Promise<PromotionCode> {
    const path = '/v1/promotion_codes';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getPromotionCodesPromotionCode(params: { promotionCode: string; expand?: Array<string>; body: GetAccountRequest }): Promise<PromotionCode> {
   ...
   * 
   */
  async postPromotionCodesPromotionCode(params: { promotionCode: string; body: PostPromotionCodesPromotionCodeRequest }): Promise<PromotionCode> {
    const path = `/v1/promotion_codes/{promotion_code}`.replace('{promotion_code}', String(params.promotionCode));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getQuotes(params: { customer?: string; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; status?: string; testClock?: string; body: GetAccountRequest }): Promise<GetQuotesResponse> {
   ...
   * 
   */
  async postQuotes(params: { body: PostQuotesRequest }): Promise<Quote> {
    const path = '/v1/quotes';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getQuotesQuote(params: { quote: string; expand?: Array<string>; body: GetAccountRequest }): Promise<Quote> {
   ...
   * 
   */
  async postQuotesQuote(params: { quote: string; body: PostQuotesQuoteRequest }): Promise<Quote> {
    const path = `/v1/quotes/{quote}`.replace('{quote}', String(params.quote));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async postQuotesQuoteAccept(params: { quote: string; body: PostAccountsAccountLoginLinksRequest }): Promise<Quote> {
   ...
   * 
   */
  async postQuotesQuoteCancel(params: { quote: string; body: PostAccountsAccountLoginLinksRequest }): Promise<Quote> {
   ...
   * 
   */
  async getQuotesQuoteComputedUpfrontLineItems(params: { quote: string; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetQuotesQuoteComputedUpfrontLineItemsResponse> {
   ...
   * 
   */
  async postQuotesQuoteFinalize(params: { quote: string; body: PostQuotesQuoteFinalizeRequest }): Promise<Quote> {
   ...
   * 
   */
  async getQuotesQuoteLineItems(params: { quote: string; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetQuotesQuoteComputedUpfrontLineItemsResponse> {
   ...
   * 
   */
  async getQuotesQuotePdf(params: { quote: string; expand?: Array<string>; body: GetAccountRequest }): Promise<Uint8Array> {
   ...
   * 
   */
  async getRadarEarlyFraudWarnings(params: { charge?: string; created?: GetAccountsUnion; endingBefore?: string; expand?: Array<string>; limit?: number; paymentIntent?: string; startingAfter?: string; body: GetAccountRequest }): Promise<GetRadarEarlyFraudWarningsResponse> {
...
<p>Please refer to the <a href="#early_fraud_warning_object">early fraud warning</a> object reference for more details.</p>
   * 
   */
  async getRadarEarlyFraudWarningsEarlyFraudWarning(params: { earlyFraudWarning: string; expand?: Array<string>; body: GetAccountRequest }): Promise<RadarEarlyFraudWarning> {
   ...
   * 
   */
  async getRadarValueListItems(params: { created?: GetAccountsUnion; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; value?: string; valueList: string; body: GetAccountRequest }): Promise<GetRadarValueListItemsResponse> {
   ...
   * 
   */
  async postRadarValueListItems(params: { body: PostRadarValueListItemsRequest }): Promise<RadarValueListItem> {
    const path = '/v1/radar/value_list_items';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getRadarValueListItemsItem(params: { item: string; expand?: Array<string>; body: GetAccountRequest }): Promise<RadarValueListItem> {
   ...
   * 
   */
  async deleteRadarValueListItemsItem(params: { item: string; body: GetAccountRequest }): Promise<DeletedRadarValueListItem> {
    const path = `/v1/radar/value_list_items/{item}`.replace('{item}', String(params.item));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getRadarValueLists(params: { alias?: string; contains?: string; created?: GetAccountsUnion; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetRadarValueListsResponse> {
   ...
   * 
   */
  async postRadarValueLists(params: { body: PostRadarValueListsRequest }): Promise<RadarValueList> {
    const path = '/v1/radar/value_lists';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getRadarValueListsValueList(params: { valueList: string; expand?: Array<string>; body: GetAccountRequest }): Promise<RadarValueList> {
   ...
   * 
   */
  async postRadarValueListsValueList(params: { valueList: string; body: PostRadarValueListsValueListRequest }): Promise<RadarValueList> {
    const path = `/v1/radar/value_lists/{value_list}`.replace('{value_list}', String(params.valueList));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async deleteRadarValueListsValueList(params: { valueList: string; body: GetAccountRequest }): Promise<DeletedRadarValueList> {
    const path = `/v1/radar/value_lists/{value_list}`.replace('{value_list}', String(params.valueList));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getRefunds(params: { charge?: string; created?: GetAccountsUnion; endingBefore?: string; expand?: Array<string>; limit?: number; paymentIntent?: string; startingAfter?: string; body: GetAccountRequest }): Promise<GetRefundsResponse> {
...
or when trying to refund more money than is left on a charge.</p>
   * 
   */
  async postRefunds(params: { body: PostRefundsRequest }): Promise<Refund> {
    const path = '/v1/refunds';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getRefundsRefund(params: { refund: string; expand?: Array<string>; body: GetAccountRequest }): Promise<Refund> {
...
<p>This request only accepts <code>metadata</code> as an argument.</p>
   * 
   */
  async postRefundsRefund(params: { refund: string; body: PostApplicationFeesFeeRefundsIdRequest }): Promise<Refund> {
    const path = `/v1/refunds/{refund}`.replace('{refund}', String(params.refund));
    const url = `${this.baseUrl}${path}`;
...
<p>You can’t cancel refunds in other states. Only refunds for payment methods that require customer action can enter the <code>requires_action</code> state.</p>
   * 
   */
  async postRefundsRefundCancel(params: { refund: string; body: PostAccountsAccountLoginLinksRequest }): Promise<Refund> {
   ...
   * 
   */
  async getReportingReportRuns(params: { created?: GetAccountsUnion; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetReportingReportRunsResponse> {
   ...
   * 
   */
  async postReportingReportRuns(params: { body: PostReportingReportRunsRequest }): Promise<ReportingReportRun> {
    const path = '/v1/reporting/report_runs';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getReportingReportRunsReportRun(params: { reportRun: string; expand?: Array<string>; body: GetAccountRequest }): Promise<ReportingReportRun> {
   ...
   * 
   */
  async getReportingReportTypes(params: { expand?: Array<string>; body: GetAccountRequest }): Promise<GetReportingReportTypesResponse> {
   ...
   * 
   */
  async getReportingReportTypesReportType(params: { reportType: string; expand?: Array<string>; body: GetAccountRequest }): Promise<ReportingReportType> {
   ...
   * 
   */
  async getReviews(params: { created?: GetAccountsUnion; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetReviewsResponse> {
   ...
   * 
   */
  async getReviewsReview(params: { review: string; expand?: Array<string>; body: GetAccountRequest }): Promise<Review> {
   ...
   * 
   */
  async postReviewsReviewApprove(params: { review: string; body: PostAccountsAccountLoginLinksRequest }): Promise<Review> {
   ...
   * 
   */
  async getSetupAttempts(params: { created?: GetAccountsUnion; endingBefore?: string; expand?: Array<string>; limit?: number; setupIntent: string; startingAfter?: string; body: GetAccountRequest }): Promise<GetSetupAttemptsResponse> {
   ...
   * 
   */
  async getSetupIntents(params: { attachToSelf?: boolean; created?: GetAccountsUnion; customer?: string; endingBefore?: string; expand?: Array<string>; limit?: number; paymentMethod?: string; startingAfter?: string; body: GetAccountRequest }): Promise<GetSetupIntentsResponse> {
...
it to collect any required permissions to charge the payment method later.</p>
   * 
   */
  async postSetupIntents(params: { body: PostSetupIntentsRequest }): Promise<SetupIntent> {
    const path = '/v1/setup_intents';
    const url = `${this.baseUrl}${path}`;
...
<p>When retrieved with a publishable key, only a subset of properties will be returned. Please refer to the <a href="#setup_intent_object">SetupIntent</a> object reference for more details.</p>
   * 
   */
  async getSetupIntentsIntent(params: { intent: string; clientSecret?: string; expand?: Array<string>; body: GetAccountRequest }): Promise<SetupIntent> {
   ...
   * 
   */
  async postSetupIntentsIntent(params: { intent: string; body: PostSetupIntentsIntentRequest }): Promise<SetupIntent> {
    const path = `/v1/setup_intents/{intent}`.replace('{intent}', String(params.intent));
    const url = `${this.baseUrl}${path}`;
...
<p>After you cancel it, setup is abandoned and any operations on the SetupIntent fail with an error. You can’t cancel the SetupIntent for a Checkout Session. <a href="/docs/api/checkout/sessions/expire">Expire the Checkout Session</a> instead.</p>
   * 
   */
  async postSetupIntentsIntentCancel(params: { intent: string; body: PostSetupIntentsIntentCancelRequest }): Promise<SetupIntent> {
...
confirmation limit is reached.</p>
   * 
   */
  async postSetupIntentsIntentConfirm(params: { intent: string; body: PostSetupIntentsIntentConfirmRequest }): Promise<SetupIntent> {
   ...
   * 
   */
  async postSetupIntentsIntentVerifyMicrodeposits(params: { intent: string; body: PostSetupIntentsIntentVerifyMicrodepositsRequest }): Promise<SetupIntent> {
   ...
   * 
   */
  async getShippingRates(params: { active?: boolean; created?: GetAccountsUnion; currency?: string; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetShippingRatesResponse> {
   ...
   * 
   */
  async postShippingRates(params: { body: PostShippingRatesRequest }): Promise<ShippingRate> {
    const path = '/v1/shipping_rates';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getShippingRatesShippingRateToken(params: { shippingRateToken: string; expand?: Array<string>; body: GetAccountRequest }): Promise<ShippingRate> {
   ...
   * 
   */
  async postShippingRatesShippingRateToken(params: { shippingRateToken: string; body: PostShippingRatesShippingRateTokenRequest }): Promise<ShippingRate> {
    const path = `/v1/shipping_rates/{shipping_rate_token}`.replace('{shipping_rate_token}', String(params.shippingRateToken));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async postSigmaSavedQueriesId(params: { id: string; body: PostSigmaSavedQueriesIdRequest }): Promise<SigmaSigmaApiQuery> {
   ...
   * 
   */
  async getSigmaScheduledQueryRuns(params: { endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetSigmaScheduledQueryRunsResponse> {
   ...
   * 
   */
  async getSigmaScheduledQueryRunsScheduledQueryRun(params: { scheduledQueryRun: string; expand?: Array<string>; body: GetAccountRequest }): Promise<ScheduledQueryRun> {
   ...
   * 
   */
  async postSources(params: { body: PostSourcesRequest }): Promise<Source> {
   ...
   * 
   */
  async getSourcesSource(params: { source: string; clientSecret?: string; expand?: Array<string>; body: GetAccountRequest }): Promise<Source> {
...
<p>This request accepts the <code>metadata</code> and <code>owner</code> as arguments. It is also possible to update type specific information for selected payment methods. Please refer to our <a href="/docs/sources">payment method guides</a> for more detail.</p>
   * 
   */
  async postSourcesSource(params: { source: string; body: PostSourcesSourceRequest }): Promise<Source> {
    const path = `/v1/sources/{source}`.replace('{source}', String(params.source));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getSourcesSourceMandateNotificationsMandateNotification(params: { mandateNotification: string; source: string; expand?: Array<string>; body: GetAccountRequest }): Promise<SourceMandateNotification> {
   ...
   * 
   */
  async getSourcesSourceSourceTransactions(params: { source: string; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetSourcesSourceSourceTransactionsResponse> {
   ...
   * 
   */
  async getSourcesSourceSourceTransactionsSourceTransaction(params: { source: string; sourceTransaction: string; expand?: Array<string>; body: GetAccountRequest }): Promise<SourceTransaction> {
   ...
   * 
   */
  async postSourcesSourceVerify(params: { source: string; body: PostSourcesSourceVerifyRequest }): Promise<Source> {
   ...
   * 
   */
  async getSubscriptionItems(params: { endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; subscription: string; body: GetAccountRequest }): Promise<GetSubscriptionItemsResponse> {
   ...
   * 
   */
  async postSubscriptionItems(params: { body: PostSubscriptionItemsRequest }): Promise<SubscriptionItem> {
    const path = '/v1/subscription_items';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getSubscriptionItemsItem(params: { item: string; expand?: Array<string>; body: GetAccountRequest }): Promise<SubscriptionItem> {
   ...
   * 
   */
  async postSubscriptionItemsItem(params: { item: string; body: PostSubscriptionItemsItemRequest }): Promise<SubscriptionItem> {
    const path = `/v1/subscription_items/{item}`.replace('{item}', String(params.item));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async deleteSubscriptionItemsItem(params: { item: string; body: DeleteSubscriptionItemsItemRequest }): Promise<DeletedSubscriptionItem> {
    const path = `/v1/subscription_items/{item}`.replace('{item}', String(params.item));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getSubscriptionSchedules(params: { canceledAt?: GetAccountsUnion; completedAt?: GetAccountsUnion; created?: GetAccountsUnion; customer?: string; endingBefore?: string; expand?: Array<string>; limit?: number; releasedAt?: GetAccountsUnion; scheduled?: boolean; startingAfter?: string; body: GetAccountRequest }): Promise<GetSubscriptionSchedulesResponse> {
   ...
   * 
   */
  async postSubscriptionSchedules(params: { body: PostSubscriptionSchedulesRequest }): Promise<SubscriptionSchedule> {
    const path = '/v1/subscription_schedules';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getSubscriptionSchedulesSchedule(params: { schedule: string; expand?: Array<string>; body: GetAccountRequest }): Promise<SubscriptionSchedule> {
   ...
   * 
   */
  async postSubscriptionSchedulesSchedule(params: { schedule: string; body: PostSubscriptionSchedulesScheduleRequest }): Promise<SubscriptionSchedule> {
    const path = `/v1/subscription_schedules/{schedule}`.replace('{schedule}', String(params.schedule));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async postSubscriptionSchedulesScheduleCancel(params: { schedule: string; body: PostSubscriptionSchedulesScheduleCancelRequest }): Promise<SubscriptionSchedule> {
   ...
   * 
   */
  async postSubscriptionSchedulesScheduleRelease(params: { schedule: string; body: PostSubscriptionSchedulesScheduleReleaseRequest }): Promise<SubscriptionSchedule> {
   ...
   * 
   */
  async getSubscriptions(params: { automaticTax?: GetSubscriptionsObject; collectionMethod?: string; created?: GetAccountsUnion; currentPeriodEnd?: GetAccountsUnion; currentPeriodStart?: GetAccountsUnion; customer?: string; endingBefore?: string; expand?: Array<string>; limit?: number; price?: string; startingAfter?: string; status?: string; testClock?: string; body: GetAccountRequest }): Promise<GetSubscriptionsResponse> {
...
Schedules provide the flexibility to model more complex billing configurations that change over time.</p>
   * 
   */
  async postSubscriptions(params: { body: PostSubscriptionsRequest }): Promise<Subscription> {
    const path = '/v1/subscriptions';
    const url = `${this.baseUrl}${path}`;
...
to an hour behind during outages. Search functionality is not available to merchants in India.</p>
   * 
   */
  async getSubscriptionsSearch(params: { expand?: Array<string>; limit?: number; page?: string; query: string; body: GetAccountRequest }): Promise<GetSubscriptionsSearchResponse> {
   ...
   * 
   */
  async getSubscriptionsSubscriptionExposedId(params: { subscriptionExposedId: string; expand?: Array<string>; body: GetAccountRequest }): Promise<Subscription> {
...
<p>Updating the quantity on a subscription many times in an hour may result in <a href="/docs/rate-limits">rate limiting</a>. If you need to bill for a frequently changing quantity, consider integrating <a href="/docs/billing/subscriptions/usage-based">usage-based billing</a> instead.</p>
   * 
   */
  async postSubscriptionsSubscriptionExposedId(params: { subscriptionExposedId: string; body: PostSubscriptionsSubscriptionExposedIdRequest }): Promise<Subscription> {
    const path = `/v1/subscriptions/{subscription_exposed_id}`.replace('{subscription_exposed_id}', String(params.subscriptionExposedId));
    const url = `${this.baseUrl}${path}`;
...
<p>By default, upon subscription cancellation, Stripe stops automatic collection of all finalized invoices for the customer. This is intended to prevent unexpected payment attempts after the customer has canceled a subscription. However, you can resume automatic collection of the invoices manually after subscription cancellation to have us proceed. Or, you could check for unpaid invoices before allowing the customer to cancel the subscription at all.</p>
   * 
   */
  async deleteSubscriptionsSubscriptionExposedId(params: { subscriptionExposedId: string; body: DeleteSubscriptionsSubscriptionExposedIdRequest }): Promise<Subscription> {
    const path = `/v1/subscriptions/{subscription_exposed_id}`.replace('{subscription_exposed_id}', String(params.subscriptionExposedId));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async deleteSubscriptionsSubscriptionExposedIdDiscount(params: { subscriptionExposedId: string; body: GetAccountRequest }): Promise<DeletedDiscount> {
   ...
   * 
   */
  async postSubscriptionsSubscriptionMigrate(params: { subscription: string; body: PostSubscriptionsSubscriptionMigrateRequest }): Promise<Subscription> {
   ...
   * 
   */
  async postSubscriptionsSubscriptionResume(params: { subscription: string; body: PostSubscriptionsSubscriptionResumeRequest }): Promise<Subscription> {
   ...
   * 
   */
  async getTaxAssociationsFind(params: { expand?: Array<string>; paymentIntent: string; body: GetAccountRequest }): Promise<TaxAssociation> {
   ...
   * 
   */
  async postTaxCalculations(params: { body: PostTaxCalculationsRequest }): Promise<TaxCalculation> {
   ...
   * 
   */
  async getTaxCalculationsCalculation(params: { calculation: string; expand?: Array<string>; body: GetAccountRequest }): Promise<TaxCalculation> {
   ...
   * 
   */
  async getTaxCalculationsCalculationLineItems(params: { calculation: string; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetTaxCalculationsCalculationLineItemsResponse> {
   ...
   * 
   */
  async getTaxRegistrations(params: { endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; status?: string; body: GetAccountRequest }): Promise<GetTaxRegistrationsResponse> {
   ...
   * 
   */
  async postTaxRegistrations(params: { body: PostTaxRegistrationsRequest }): Promise<TaxRegistration> {
    const path = '/v1/tax/registrations';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getTaxRegistrationsId(params: { id: string; expand?: Array<string>; body: GetAccountRequest }): Promise<TaxRegistration> {
...
<p>A registration cannot be deleted after it has been created. If you wish to end a registration you may do so by setting <code>expires_at</code>.</p>
   * 
   */
  async postTaxRegistrationsId(params: { id: string; body: PostTaxRegistrationsIdRequest }): Promise<TaxRegistration> {
    const path = `/v1/tax/registrations/{id}`.replace('{id}', String(params.id));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getTaxSettings(params: { expand?: Array<string>; body: GetAccountRequest }): Promise<TaxSettings> {
   ...
   * 
   */
  async postTaxSettings(params: { body: PostTaxSettingsRequest }): Promise<TaxSettings> {
    const path = '/v1/tax/settings';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async postTaxTransactionsCreateFromCalculation(params: { body: PostTaxTransactionsCreateFromCalculationRequest }): Promise<TaxTransaction> {
   ...
   * 
   */
  async postTaxTransactionsCreateReversal(params: { body: PostTaxTransactionsCreateReversalRequest }): Promise<TaxTransaction> {
   ...
   * 
   */
  async getTaxTransactionsTransaction(params: { transaction: string; expand?: Array<string>; body: GetAccountRequest }): Promise<TaxTransaction> {
   ...
   * 
   */
  async getTaxTransactionsTransactionLineItems(params: { transaction: string; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetTaxTransactionsTransactionLineItemsResponse> {
   ...
   * 
   */
  async getTaxCodes(params: { endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetTaxCodesResponse> {
   ...
   * 
   */
  async getTaxCodesId(params: { id: string; expand?: Array<string>; body: GetAccountRequest }): Promise<TaxCode> {
   ...
   * 
   */
  async getTaxIds(params: { endingBefore?: string; expand?: Array<string>; limit?: number; owner?: GetTaxIdsObject; startingAfter?: string; body: GetAccountRequest }): Promise<GetCustomersCustomerTaxIdsResponse> {
   ...
   * 
   */
  async postTaxIds(params: { body: PostTaxIdsRequest }): Promise<TaxId> {
    const path = '/v1/tax_ids';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getTaxIdsId(params: { id: string; expand?: Array<string>; body: GetAccountRequest }): Promise<TaxId> {
   ...
   * 
   */
  async deleteTaxIdsId(params: { id: string; body: GetAccountRequest }): Promise<DeletedTaxId> {
    const path = `/v1/tax_ids/{id}`.replace('{id}', String(params.id));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getTaxRates(params: { active?: boolean; created?: GetAccountsUnion; endingBefore?: string; expand?: Array<string>; inclusive?: boolean; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetTaxRatesResponse> {
   ...
   * 
   */
  async postTaxRates(params: { body: PostTaxRatesRequest }): Promise<TaxRate> {
    const path = '/v1/tax_rates';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getTaxRatesTaxRate(params: { taxRate: string; expand?: Array<string>; body: GetAccountRequest }): Promise<TaxRate> {
   ...
   * 
   */
  async postTaxRatesTaxRate(params: { taxRate: string; body: PostTaxRatesTaxRateRequest }): Promise<TaxRate> {
    const path = `/v1/tax_rates/{tax_rate}`.replace('{tax_rate}', String(params.taxRate));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getTerminalConfigurations(params: { endingBefore?: string; expand?: Array<string>; isAccountDefault?: boolean; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetTerminalConfigurationsResponse> {
   ...
   * 
   */
  async postTerminalConfigurations(params: { body: PostTerminalConfigurationsRequest }): Promise<TerminalConfiguration> {
    const path = '/v1/terminal/configurations';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getTerminalConfigurationsConfiguration(params: { configuration: string; expand?: Array<string>; body: GetAccountRequest }): Promise<GetTerminalConfigurationsConfigurationUnion> {
   ...
   * 
   */
  async postTerminalConfigurationsConfiguration(params: { configuration: string; body: PostTerminalConfigurationsConfigurationRequest }): Promise<GetTerminalConfigurationsConfigurationUnion> {
    const path = `/v1/terminal/configurations/{configuration}`.replace('{configuration}', String(params.configuration));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async deleteTerminalConfigurationsConfiguration(params: { configuration: string; body: GetAccountRequest }): Promise<DeletedTerminalConfiguration> {
    const path = `/v1/terminal/configurations/{configuration}`.replace('{configuration}', String(params.configuration));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async postTerminalConnectionTokens(params: { body: PostTerminalConnectionTokensRequest }): Promise<TerminalConnectionToken> {
   ...
   * 
   */
  async getTerminalLocations(params: { endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetTerminalLocationsResponse> {
...
For further details, including which address fields are required in each country, see the <a href="/docs/terminal/fleet/locations">Manage locations</a> guide.</p>
   * 
   */
  async postTerminalLocations(params: { body: PostTerminalLocationsRequest }): Promise<TerminalLocation> {
    const path = '/v1/terminal/locations';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getTerminalLocationsLocation(params: { location: string; expand?: Array<string>; body: GetAccountRequest }): Promise<GetTerminalLocationsLocationUnion> {
   ...
   * 
   */
  async postTerminalLocationsLocation(params: { location: string; body: PostTerminalLocationsLocationRequest }): Promise<GetTerminalLocationsLocationUnion> {
    const path = `/v1/terminal/locations/{location}`.replace('{location}', String(params.location));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async deleteTerminalLocationsLocation(params: { location: string; body: GetAccountRequest }): Promise<DeletedTerminalLocation> {
    const path = `/v1/terminal/locations/{location}`.replace('{location}', String(params.location));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async postTerminalOnboardingLinks(params: { body: PostTerminalOnboardingLinksRequest }): Promise<TerminalOnboardingLink> {
   ...
   * 
   */
  async getTerminalReaders(params: { deviceType?: string; endingBefore?: string; expand?: Array<string>; limit?: number; location?: string; serialNumber?: string; startingAfter?: string; status?: string; body: GetAccountRequest }): Promise<GetTerminalReadersResponse> {
   ...
   * 
   */
  async postTerminalReaders(params: { body: PostTerminalReadersRequest }): Promise<TerminalReader> {
    const path = '/v1/terminal/readers';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getTerminalReadersReader(params: { reader: string; expand?: Array<string>; body: GetAccountRequest }): Promise<GetTerminalReadersReaderUnion> {
   ...
   * 
   */
  async postTerminalReadersReader(params: { reader: string; body: PostTerminalReadersReaderRequest }): Promise<GetTerminalReadersReaderUnion> {
    const path = `/v1/terminal/readers/{reader}`.replace('{reader}', String(params.reader));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async deleteTerminalReadersReader(params: { reader: string; body: GetAccountRequest }): Promise<DeletedTerminalReader> {
    const path = `/v1/terminal/readers/{reader}`.replace('{reader}', String(params.reader));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async postTerminalReadersReaderCancelAction(params: { reader: string; body: PostAccountsAccountLoginLinksRequest }): Promise<TerminalReader> {
   ...
   * 
   */
  async postTerminalReadersReaderCollectInputs(params: { reader: string; body: PostTerminalReadersReaderCollectInputsRequest }): Promise<TerminalReader> {
   ...
   * 
   */
  async postTerminalReadersReaderCollectPaymentMethod(params: { reader: string; body: PostTerminalReadersReaderCollectPaymentMethodRequest }): Promise<TerminalReader> {
   ...
   * 
   */
  async postTerminalReadersReaderConfirmPaymentIntent(params: { reader: string; body: PostTerminalReadersReaderConfirmPaymentIntentRequest }): Promise<TerminalReader> {
   ...
   * 
   */
  async postTerminalReadersReaderProcessPaymentIntent(params: { reader: string; body: PostTerminalReadersReaderProcessPaymentIntentRequest }): Promise<TerminalReader> {
   ...
   * 
   */
  async postTerminalReadersReaderProcessSetupIntent(params: { reader: string; body: PostTerminalReadersReaderProcessSetupIntentRequest }): Promise<TerminalReader> {
   ...
   * 
   */
  async postTerminalReadersReaderRefundPayment(params: { reader: string; body: PostTerminalReadersReaderRefundPaymentRequest }): Promise<TerminalReader> {
   ...
   * 
   */
  async postTerminalReadersReaderSetReaderDisplay(params: { reader: string; body: PostTerminalReadersReaderSetReaderDisplayRequest }): Promise<TerminalReader> {
   ...
   * 
   */
  async postTestHelpersConfirmationTokens(params: { body: PostTestHelpersConfirmationTokensRequest }): Promise<ConfirmationToken> {
   ...
   * 
   */
  async postTestHelpersCustomersCustomerFundCashBalance(params: { customer: string; body: PostTestHelpersCustomersCustomerFundCashBalanceRequest }): Promise<CustomerCashBalanceTransaction> {
   ...
   * 
   */
  async postTestHelpersIssuingAuthorizations(params: { body: PostTestHelpersIssuingAuthorizationsRequest }): Promise<IssuingAuthorization> {
   ...
   * 
   */
  async postTestHelpersIssuingAuthorizationsAuthorizationCapture(params: { authorization: string; body: PostTestHelpersIssuingAuthorizationsAuthorizationCaptureRequest }): Promise<IssuingAuthorization> {
   ...
   * 
   */
  async postTestHelpersIssuingAuthorizationsAuthorizationExpire(params: { authorization: string; body: PostAccountsAccountLoginLinksRequest }): Promise<IssuingAuthorization> {
   ...
   * 
   */
  async postTestHelpersIssuingAuthorizationsAuthorizationFinalizeAmount(params: { authorization: string; body: PostTestHelpersIssuingAuthorizationsAuthorizationFinalizeAmountRequest }): Promise<IssuingAuthorization> {
   ...
   * 
   */
  async postTestHelpersIssuingAuthorizationsAuthorizationFraudChallengesRespond(params: { authorization: string; body: PostTestHelpersIssuingAuthorizationsAuthorizationFraudChallengesRespondRequest }): Promise<IssuingAuthorization> {
   ...
   * 
   */
  async postTestHelpersIssuingAuthorizationsAuthorizationIncrement(params: { authorization: string; body: PostTestHelpersIssuingAuthorizationsAuthorizationIncrementRequest }): Promise<IssuingAuthorization> {
   ...
   * 
   */
  async postTestHelpersIssuingAuthorizationsAuthorizationReverse(params: { authorization: string; body: PostTestHelpersIssuingAuthorizationsAuthorizationReverseRequest }): Promise<IssuingAuthorization> {
   ...
   * 
   */
  async postTestHelpersIssuingCardsCardShippingDeliver(params: { card: string; body: PostAccountsAccountLoginLinksRequest }): Promise<IssuingCard> {
   ...
   * 
   */
  async postTestHelpersIssuingCardsCardShippingFail(params: { card: string; body: PostAccountsAccountLoginLinksRequest }): Promise<IssuingCard> {
   ...
   * 
   */
  async postTestHelpersIssuingCardsCardShippingReturn(params: { card: string; body: PostAccountsAccountLoginLinksRequest }): Promise<IssuingCard> {
   ...
   * 
   */
  async postTestHelpersIssuingCardsCardShippingShip(params: { card: string; body: PostAccountsAccountLoginLinksRequest }): Promise<IssuingCard> {
   ...
   * 
   */
  async postTestHelpersIssuingCardsCardShippingSubmit(params: { card: string; body: PostAccountsAccountLoginLinksRequest }): Promise<IssuingCard> {
   ...
   * 
   */
  async postTestHelpersIssuingPersonalizationDesignsPersonalizationDesignActivate(params: { personalizationDesign: string; body: PostAccountsAccountLoginLinksRequest }): Promise<IssuingPersonalizationDesign> {
   ...
   * 
   */
  async postTestHelpersIssuingPersonalizationDesignsPersonalizationDesignDeactivate(params: { personalizationDesign: string; body: PostAccountsAccountLoginLinksRequest }): Promise<IssuingPersonalizationDesign> {
   ...
   * 
   */
  async postTestHelpersIssuingPersonalizationDesignsPersonalizationDesignReject(params: { personalizationDesign: string; body: PostTestHelpersIssuingPersonalizationDesignsPersonalizationDesignRejectRequest }): Promise<IssuingPersonalizationDesign> {
   ...
   * 
   */
  async postTestHelpersIssuingSettlements(params: { body: PostTestHelpersIssuingSettlementsRequest }): Promise<IssuingSettlement> {
   ...
   * 
   */
  async postTestHelpersIssuingSettlementsSettlementComplete(params: { settlement: string; body: PostAccountsAccountLoginLinksRequest }): Promise<IssuingSettlement> {
   ...
   * 
   */
  async postTestHelpersIssuingTransactionsCreateForceCapture(params: { body: PostTestHelpersIssuingTransactionsCreateForceCaptureRequest }): Promise<IssuingTransaction> {
   ...
   * 
   */
  async postTestHelpersIssuingTransactionsCreateUnlinkedRefund(params: { body: PostTestHelpersIssuingTransactionsCreateUnlinkedRefundRequest }): Promise<IssuingTransaction> {
   ...
   * 
   */
  async postTestHelpersIssuingTransactionsTransactionRefund(params: { transaction: string; body: PostTestHelpersIssuingTransactionsTransactionRefundRequest }): Promise<IssuingTransaction> {
   ...
   * 
   */
  async postTestHelpersRefundsRefundExpire(params: { refund: string; body: PostAccountsAccountLoginLinksRequest }): Promise<Refund> {
   ...
   * 
   */
  async postTestHelpersTerminalReadersReaderPresentPaymentMethod(params: { reader: string; body: PostTestHelpersTerminalReadersReaderPresentPaymentMethodRequest }): Promise<TerminalReader> {
   ...
   * 
   */
  async postTestHelpersTerminalReadersReaderSucceedInputCollection(params: { reader: string; body: PostTestHelpersTerminalReadersReaderSucceedInputCollectionRequest }): Promise<TerminalReader> {
   ...
   * 
   */
  async postTestHelpersTerminalReadersReaderTimeoutInputCollection(params: { reader: string; body: PostAccountsAccountLoginLinksRequest }): Promise<TerminalReader> {
   ...
   * 
   */
  async getTestHelpersTestClocks(params: { endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetTestHelpersTestClocksResponse> {
   ...
   * 
   */
  async postTestHelpersTestClocks(params: { body: PostTestHelpersTestClocksRequest }): Promise<TestHelpersTestClock> {
    const path = '/v1/test_helpers/test_clocks';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getTestHelpersTestClocksTestClock(params: { testClock: string; expand?: Array<string>; body: GetAccountRequest }): Promise<TestHelpersTestClock> {
   ...
   * 
   */
  async deleteTestHelpersTestClocksTestClock(params: { testClock: string; body: GetAccountRequest }): Promise<DeletedTestHelpersTestClock> {
    const path = `/v1/test_helpers/test_clocks/{test_clock}`.replace('{test_clock}', String(params.testClock));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async postTestHelpersTestClocksTestClockAdvance(params: { testClock: string; body: PostTestHelpersTestClocksTestClockAdvanceRequest }): Promise<TestHelpersTestClock> {
   ...
   * 
   */
  async postTestHelpersTreasuryInboundTransfersIdFail(params: { id: string; body: PostTestHelpersTreasuryInboundTransfersIdFailRequest }): Promise<TreasuryInboundTransfer> {
   ...
   * 
   */
  async postTestHelpersTreasuryInboundTransfersIdReturn(params: { id: string; body: PostAccountsAccountLoginLinksRequest }): Promise<TreasuryInboundTransfer> {
   ...
   * 
   */
  async postTestHelpersTreasuryInboundTransfersIdSucceed(params: { id: string; body: PostAccountsAccountLoginLinksRequest }): Promise<TreasuryInboundTransfer> {
   ...
   * 
   */
  async postTestHelpersTreasuryOutboundPaymentsId(params: { id: string; body: PostTestHelpersTreasuryOutboundPaymentsIdRequest }): Promise<TreasuryOutboundPayment> {
   ...
   * 
   */
  async postTestHelpersTreasuryOutboundPaymentsIdFail(params: { id: string; body: PostAccountsAccountLoginLinksRequest }): Promise<TreasuryOutboundPayment> {
   ...
   * 
   */
  async postTestHelpersTreasuryOutboundPaymentsIdPost(params: { id: string; body: PostAccountsAccountLoginLinksRequest }): Promise<TreasuryOutboundPayment> {
   ...
   * 
   */
  async postTestHelpersTreasuryOutboundPaymentsIdReturn(params: { id: string; body: PostTestHelpersTreasuryOutboundPaymentsIdReturnRequest }): Promise<TreasuryOutboundPayment> {
   ...
   * 
   */
  async postTestHelpersTreasuryOutboundTransfersOutboundTransfer(params: { outboundTransfer: string; body: PostTestHelpersTreasuryOutboundPaymentsIdRequest }): Promise<TreasuryOutboundTransfer> {
   ...
   * 
   */
  async postTestHelpersTreasuryOutboundTransfersOutboundTransferFail(params: { outboundTransfer: string; body: PostAccountsAccountLoginLinksRequest }): Promise<TreasuryOutboundTransfer> {
   ...
   * 
   */
  async postTestHelpersTreasuryOutboundTransfersOutboundTransferPost(params: { outboundTransfer: string; body: PostAccountsAccountLoginLinksRequest }): Promise<TreasuryOutboundTransfer> {
   ...
   * 
   */
  async postTestHelpersTreasuryOutboundTransfersOutboundTransferReturn(params: { outboundTransfer: string; body: PostTestHelpersTreasuryOutboundTransfersOutboundTransferReturnRequest }): Promise<TreasuryOutboundTransfer> {
   ...
   * 
   */
  async postTestHelpersTreasuryReceivedCredits(params: { body: PostTestHelpersTreasuryReceivedCreditsRequest }): Promise<TreasuryReceivedCredit> {
   ...
   * 
   */
  async postTestHelpersTreasuryReceivedDebits(params: { body: PostTestHelpersTreasuryReceivedDebitsRequest }): Promise<TreasuryReceivedDebit> {
...
You can use this token with any v1 API method in place of a bank account dictionary. You can only use this token once. To do so, attach it to a <a href="#accounts">connected account</a> where <a href="/api/accounts/object#account_object-controller-requirement_collection">controller.requirement_collection</a> is <code>application</code>, which includes Custom accounts.</p>
   * 
   */
  async postTokens(params: { body: PostTokensRequest }): Promise<Token> {
   ...
   * 
   */
  async getTokensToken(params: { token: string; expand?: Array<string>; body: GetAccountRequest }): Promise<Token> {
   ...
   * 
   */
  async getTopups(params: { amount?: GetAccountsUnion; created?: GetAccountsUnion; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; status?: string; body: GetAccountRequest }): Promise<GetTopupsResponse> {
   ...
   * 
   */
  async postTopups(params: { body: PostTopupsRequest }): Promise<Topup> {
    const path = '/v1/topups';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getTopupsTopup(params: { topup: string; expand?: Array<string>; body: GetAccountRequest }): Promise<Topup> {
   ...
   * 
   */
  async postTopupsTopup(params: { topup: string; body: PostTopupsTopupRequest }): Promise<Topup> {
    const path = `/v1/topups/{topup}`.replace('{topup}', String(params.topup));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async postTopupsTopupCancel(params: { topup: string; body: PostAccountsAccountLoginLinksRequest }): Promise<Topup> {
   ...
   * 
   */
  async getTransfers(params: { created?: GetAccountsUnion; destination?: string; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; transferGroup?: string; body: GetAccountRequest }): Promise<GetTransfersResponse> {
   ...
   * 
   */
  async postTransfers(params: { body: PostTransfersRequest }): Promise<Transfer> {
    const path = '/v1/transfers';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getTransfersIdReversals(params: { id: string; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetTransfersIdReversalsResponse> {
...
<p>Once entirely reversed, a transfer can’t be reversed again. This method will return an error when called on an already-reversed transfer, or when trying to reverse more money than is left on a transfer.</p>
   * 
   */
  async postTransfersIdReversals(params: { id: string; body: PostTransfersIdReversalsRequest }): Promise<TransferReversal> {
    const path = `/v1/transfers/{id}/reversals`.replace('{id}', String(params.id));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getTransfersTransfer(params: { transfer: string; expand?: Array<string>; body: GetAccountRequest }): Promise<Transfer> {
...
<p>This request accepts only metadata as an argument.</p>
   * 
   */
  async postTransfersTransfer(params: { transfer: string; body: PostTopupsTopupRequest }): Promise<Transfer> {
    const path = `/v1/transfers/{transfer}`.replace('{transfer}', String(params.transfer));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getTransfersTransferReversalsId(params: { id: string; transfer: string; expand?: Array<string>; body: GetAccountRequest }): Promise<TransferReversal> {
...
<p>This request only accepts metadata and description as arguments.</p>
   * 
   */
  async postTransfersTransferReversalsId(params: { id: string; transfer: string; body: PostApplicationFeesFeeRefundsIdRequest }): Promise<TransferReversal> {
    const path = `/v1/transfers/{transfer}/reversals/{id}`.replace('{id}', String(params.id)).replace('{transfer}', String(params.transfer));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getTreasuryCreditReversals(params: { endingBefore?: string; expand?: Array<string>; financialAccount: string; limit?: number; receivedCredit?: string; startingAfter?: string; status?: string; body: GetAccountRequest }): Promise<GetTreasuryCreditReversalsResponse> {
   ...
   * 
   */
  async postTreasuryCreditReversals(params: { body: PostTreasuryCreditReversalsRequest }): Promise<TreasuryCreditReversal> {
    const path = '/v1/treasury/credit_reversals';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getTreasuryCreditReversalsCreditReversal(params: { creditReversal: string; expand?: Array<string>; body: GetAccountRequest }): Promise<TreasuryCreditReversal> {
   ...
   * 
   */
  async getTreasuryDebitReversals(params: { endingBefore?: string; expand?: Array<string>; financialAccount: string; limit?: number; receivedDebit?: string; resolution?: string; startingAfter?: string; status?: string; body: GetAccountRequest }): Promise<GetTreasuryDebitReversalsResponse> {
   ...
   * 
   */
  async postTreasuryDebitReversals(params: { body: PostTreasuryDebitReversalsRequest }): Promise<TreasuryDebitReversal> {
    const path = '/v1/treasury/debit_reversals';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getTreasuryDebitReversalsDebitReversal(params: { debitReversal: string; expand?: Array<string>; body: GetAccountRequest }): Promise<TreasuryDebitReversal> {
   ...
   * 
   */
  async getTreasuryFinancialAccounts(params: { created?: GetAccountsUnion; endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; status?: string; body: GetAccountRequest }): Promise<GetTreasuryFinancialAccountsResponse> {
   ...
   * 
   */
  async postTreasuryFinancialAccounts(params: { body: PostTreasuryFinancialAccountsRequest }): Promise<TreasuryFinancialAccount> {
    const path = '/v1/treasury/financial_accounts';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getTreasuryFinancialAccountsFinancialAccount(params: { financialAccount: string; expand?: Array<string>; body: GetAccountRequest }): Promise<TreasuryFinancialAccount> {
   ...
   * 
   */
  async postTreasuryFinancialAccountsFinancialAccount(params: { financialAccount: string; body: PostTreasuryFinancialAccountsFinancialAccountRequest }): Promise<TreasuryFinancialAccount> {
    const path = `/v1/treasury/financial_accounts/{financial_account}`.replace('{financial_account}', String(params.financialAccount));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async postTreasuryFinancialAccountsFinancialAccountClose(params: { financialAccount: string; body: PostTreasuryFinancialAccountsFinancialAccountCloseRequest }): Promise<TreasuryFinancialAccount> {
   ...
   * 
   */
  async getTreasuryFinancialAccountsFinancialAccountFeatures(params: { financialAccount: string; expand?: Array<string>; body: GetAccountRequest }): Promise<TreasuryFinancialAccountFeatures> {
   ...
   * 
   */
  async postTreasuryFinancialAccountsFinancialAccountFeatures(params: { financialAccount: string; body: PostTreasuryFinancialAccountsFinancialAccountFeaturesRequest }): Promise<TreasuryFinancialAccountFeatures> {
    const path = `/v1/treasury/financial_accounts/{financial_account}/features`.replace('{financial_account}', String(params.financialAccount));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getTreasuryInboundTransfers(params: { endingBefore?: string; expand?: Array<string>; financialAccount: string; limit?: number; startingAfter?: string; status?: string; body: GetAccountRequest }): Promise<GetTreasuryInboundTransfersResponse> {
   ...
   * 
   */
  async postTreasuryInboundTransfers(params: { body: PostTreasuryInboundTransfersRequest }): Promise<TreasuryInboundTransfer> {
    const path = '/v1/treasury/inbound_transfers';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getTreasuryInboundTransfersId(params: { id: string; expand?: Array<string>; body: GetAccountRequest }): Promise<TreasuryInboundTransfer> {
   ...
   * 
   */
  async postTreasuryInboundTransfersInboundTransferCancel(params: { inboundTransfer: string; body: PostAccountsAccountLoginLinksRequest }): Promise<TreasuryInboundTransfer> {
   ...
   * 
   */
  async getTreasuryOutboundPayments(params: { created?: GetAccountsUnion; customer?: string; endingBefore?: string; expand?: Array<string>; financialAccount: string; limit?: number; startingAfter?: string; status?: string; body: GetAccountRequest }): Promise<GetTreasuryOutboundPaymentsResponse> {
   ...
   * 
   */
  async postTreasuryOutboundPayments(params: { body: PostTreasuryOutboundPaymentsRequest }): Promise<TreasuryOutboundPayment> {
    const path = '/v1/treasury/outbound_payments';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getTreasuryOutboundPaymentsId(params: { id: string; expand?: Array<string>; body: GetAccountRequest }): Promise<TreasuryOutboundPayment> {
   ...
   * 
   */
  async postTreasuryOutboundPaymentsIdCancel(params: { id: string; body: PostAccountsAccountLoginLinksRequest }): Promise<TreasuryOutboundPayment> {
   ...
   * 
   */
  async getTreasuryOutboundTransfers(params: { endingBefore?: string; expand?: Array<string>; financialAccount: string; limit?: number; startingAfter?: string; status?: string; body: GetAccountRequest }): Promise<GetTreasuryOutboundTransfersResponse> {
   ...
   * 
   */
  async postTreasuryOutboundTransfers(params: { body: PostTreasuryOutboundTransfersRequest }): Promise<TreasuryOutboundTransfer> {
    const path = '/v1/treasury/outbound_transfers';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getTreasuryOutboundTransfersOutboundTransfer(params: { outboundTransfer: string; expand?: Array<string>; body: GetAccountRequest }): Promise<TreasuryOutboundTransfer> {
   ...
   * 
   */
  async postTreasuryOutboundTransfersOutboundTransferCancel(params: { outboundTransfer: string; body: PostAccountsAccountLoginLinksRequest }): Promise<TreasuryOutboundTransfer> {
   ...
   * 
   */
  async getTreasuryReceivedCredits(params: { endingBefore?: string; expand?: Array<string>; financialAccount: string; limit?: number; linkedFlows?: GetTreasuryReceivedCreditsObject; startingAfter?: string; status?: string; body: GetAccountRequest }): Promise<GetTreasuryReceivedCreditsResponse> {
   ...
   * 
   */
  async getTreasuryReceivedCreditsId(params: { id: string; expand?: Array<string>; body: GetAccountRequest }): Promise<TreasuryReceivedCredit> {
   ...
   * 
   */
  async getTreasuryReceivedDebits(params: { endingBefore?: string; expand?: Array<string>; financialAccount: string; limit?: number; startingAfter?: string; status?: string; body: GetAccountRequest }): Promise<GetTreasuryReceivedDebitsResponse> {
   ...
   * 
   */
  async getTreasuryReceivedDebitsId(params: { id: string; expand?: Array<string>; body: GetAccountRequest }): Promise<TreasuryReceivedDebit> {
   ...
   * 
   */
  async getTreasuryTransactionEntries(params: { created?: GetAccountsUnion; effectiveAt?: GetAccountsUnion; endingBefore?: string; expand?: Array<string>; financialAccount: string; limit?: number; orderBy?: string; startingAfter?: string; transaction?: string; body: GetAccountRequest }): Promise<GetTreasuryTransactionEntriesResponse> {
   ...
   * 
   */
  async getTreasuryTransactionEntriesId(params: { id: string; expand?: Array<string>; body: GetAccountRequest }): Promise<TreasuryTransactionEntry> {
   ...
   * 
   */
  async getTreasuryTransactions(params: { created?: GetAccountsUnion; endingBefore?: string; expand?: Array<string>; financialAccount: string; limit?: number; orderBy?: string; startingAfter?: string; status?: string; statusTransitions?: GetTreasuryTransactionsObject; body: GetAccountRequest }): Promise<GetTreasuryTransactionsResponse> {
   ...
   * 
   */
  async getTreasuryTransactionsId(params: { id: string; expand?: Array<string>; body: GetAccountRequest }): Promise<TreasuryTransaction> {
   ...
   * 
   */
  async getWebhookEndpoints(params: { endingBefore?: string; expand?: Array<string>; limit?: number; startingAfter?: string; body: GetAccountRequest }): Promise<GetWebhookEndpointsResponse> {
   ...
   * 
   */
  async postWebhookEndpoints(params: { body: PostWebhookEndpointsRequest }): Promise<WebhookEndpoint> {
    const path = '/v1/webhook_endpoints';
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async getWebhookEndpointsWebhookEndpoint(params: { webhookEndpoint: string; expand?: Array<string>; body: GetAccountRequest }): Promise<WebhookEndpoint> {
   ...
   * 
   */
  async postWebhookEndpointsWebhookEndpoint(params: { webhookEndpoint: string; body: PostWebhookEndpointsWebhookEndpointRequest }): Promise<WebhookEndpoint> {
    const path = `/v1/webhook_endpoints/{webhook_endpoint}`.replace('{webhook_endpoint}', String(params.webhookEndpoint));
    const url = `${this.baseUrl}${path}`;
   ...
   * 
   */
  async deleteWebhookEndpointsWebhookEndpoint(params: { webhookEndpoint: string; body: GetAccountRequest }): Promise<DeletedWebhookEndpoint> {
    const path = `/v1/webhook_endpoints/{webhook_endpoint}`.replace('{webhook_endpoint}', String(params.webhookEndpoint));
    const url = `${this.baseUrl}${path}`;
