...
export const PostTestHelpersTerminalReadersReaderPresentPaymentMethodRequestSchema: TypedSchema<PostTestHelpersTerminalReadersReaderPresentPaymentMethodRequest> = typed<PostTestHelpersTerminalReadersReaderPresentPaymentMethodRequest>(object({
  ...
  get card() {
    return optional(PostTestHelpersTerminalReadersReaderPresentPaymentMethodRequestCardSchema);
  },
  get cardPresent() {
    return optional(PostTestHelpersTerminalReadersReaderPresentPaymentMethodRequestCardPresentSchema);
  },
  expand: optional(array(string())),
  get interacPresent() {
    return optional(PostTestHelpersTerminalReadersReaderPresentPaymentMethodRequestInteracPresentSchema);
  },
