...
export const PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCustomDetailsSchema: TypedSchema<PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCustomDetails> = typed<PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCustomDetails>(object({ displayName: string(), type: optional(string()) }));
