...
export const PostTestHelpersIssuingAuthorizationsRequestReportedBreakdownSchema: TypedSchema<PostTestHelpersIssuingAuthorizationsRequestReportedBreakdown> = typed<PostTestHelpersIssuingAuthorizationsRequestReportedBreakdown>(object({
  get fuel() {
    return optional(PostTestHelpersIssuingAuthorizationsRequestFuelSchema);
  },
  get nonFuel() {
    return optional(PostTestHelpersIssuingAuthorizationsRequestNonFuelSchema);
  },
  get tax() {
    return optional(PostTestHelpersIssuingAuthorizationsRequestTaxSchema);
  },
}));
