...
export const DisputeEvidenceSchema: TypedSchema<DisputeEvidence> = typed<DisputeEvidence>(object({
  ...
  get receipt() {
    return optional(ReceiptOrRefSchema);
  },
  get refundPolicy() {
    return optional(RefundPolicyOrRefSchema);
  },
