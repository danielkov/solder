...
export const SubscriptionsResourcePaymentMethodOptionsSchema: TypedSchema<SubscriptionsResourcePaymentMethodOptions> = typed<SubscriptionsResourcePaymentMethodOptions>(object({
  get acssDebit() {
    return optional(InvoicePaymentMethodOptionsAcssDebitSchema);
  },
  get bancontact() {
    return optional(InvoicePaymentMethodOptionsBancontactSchema);
  },
  get card() {
    return optional(SubscriptionPaymentMethodOptionsCardSchema);
  },
  get customerBalance() {
    return optional(InvoicePaymentMethodOptionsCustomerBalanceSchema);
  },
  get konbini() {
    return optional(InvoicePaymentMethodOptionsKonbiniSchema);
  },
  get sepaDebit() {
    return optional(InvoicePaymentMethodOptionsSepaDebitSchema);
  },
  get usBankAccount() {
    return optional(InvoicePaymentMethodOptionsUsBankAccountSchema);
  },
}));
