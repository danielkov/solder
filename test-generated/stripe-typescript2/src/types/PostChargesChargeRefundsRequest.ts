...
export interface PostChargesChargeRefundsRequest {
  amount?: number;
  /**
...
export const PostChargesChargeRefundsRequestSchema: TypedSchema<PostChargesChargeRefundsRequest> = typed<PostChargesChargeRefundsRequest>(object({
