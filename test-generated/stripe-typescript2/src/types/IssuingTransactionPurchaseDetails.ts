...
export const IssuingTransactionPurchaseDetailsSchema: TypedSchema<IssuingTransactionPurchaseDetails> = typed<IssuingTransactionPurchaseDetails>(object({
  get fleet() {
    return optional(IssuingTransactionFleetDataSchema);
  },
  get flight() {
    return optional(IssuingTransactionFlightDataSchema);
  },
  get fuel() {
    return optional(IssuingTransactionFuelDataSchema);
  },
  get lodging() {
    return optional(IssuingTransactionLodgingDataSchema);
  },
  get receipt() {
    return optional(array(IssuingTransactionReceiptDataSchema));
  },
