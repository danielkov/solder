 ...
 */
export interface PostQuotesRequestLineItemsItem {
...
export const PostQuotesRequestLineItemsItemSchema: TypedSchema<PostQuotesRequestLineItemsItem> = typed<PostQuotesRequestLineItemsItem>(object({
  get discounts() {
    return optional(PostCustomersCustomerSubscriptionsRequestItemsItemDiscountsSchema);
  },
  price: optional(string()),
  get priceData() {
    return optional(PostQuotesRequestLineItemsItemPriceDataSchema);
  },
