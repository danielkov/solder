...
export const BillingCreditGrantsResourceApplicabilityConfigSchema: TypedSchema<BillingCreditGrantsResourceApplicabilityConfig> = typed<BillingCreditGrantsResourceApplicabilityConfig>(object({ scope: BillingCreditGrantsResourceScopeSchema }));
