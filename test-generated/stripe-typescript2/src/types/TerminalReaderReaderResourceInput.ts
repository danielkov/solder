...
export const TerminalReaderReaderResourceInputSchema: TypedSchema<TerminalReaderReaderResourceInput> = typed<TerminalReaderReaderResourceInput>(object({
  get customText() {
    return optional(TerminalReaderReaderResourceCustomTextSchema);
  },
  get email() {
    return optional(TerminalReaderReaderResourceEmailSchema);
  },
  get numeric() {
    return optional(TerminalReaderReaderResourceNumericSchema);
  },
  get phone() {
    return optional(TerminalReaderReaderResourcePhoneSchema);
  },
  required: optional(boolean()),
  get selection() {
    return optional(TerminalReaderReaderResourceSelectionSchema);
  },
  get signature() {
    return optional(TerminalReaderReaderResourceSignatureSchema);
  },
  skipped: optional(boolean()),
  get text() {
    return optional(TerminalReaderReaderResourceTextSchema);
  },
  get toggles() {
    return optional(array(TerminalReaderReaderResourceToggleSchema));
  },
  type: string(),
}));
