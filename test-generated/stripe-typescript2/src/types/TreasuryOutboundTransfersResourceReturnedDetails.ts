...
export const TreasuryOutboundTransfersResourceReturnedDetailsSchema: TypedSchema<TreasuryOutboundTransfersResourceReturnedDetails> = typed<TreasuryOutboundTransfersResourceReturnedDetails>(object({ code: string(), transaction: TransactionOrRef2Schema }));
