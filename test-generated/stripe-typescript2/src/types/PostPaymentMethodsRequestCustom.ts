...
export const PostPaymentMethodsRequestCustomSchema: TypedSchema<PostPaymentMethodsRequestCustom> = typed<PostPaymentMethodsRequestCustom>(object({ type: string() }));
