...
export const TreasuryFinancialAccountsResourceAbaToggleSettingsSchema: TypedSchema<TreasuryFinancialAccountsResourceAbaToggleSettings> = typed<TreasuryFinancialAccountsResourceAbaToggleSettings>(object({
  requested: boolean(),
  status: string(),
