...
export const IdentityVerificationReportSchema: TypedSchema<IdentityVerificationReport> = typed<IdentityVerificationReport>(object({
  ...
  created: number(),
  get document() {
    return optional(GelatoDocumentReportSchema);
  },
  get email() {
    return optional(GelatoEmailReportSchema);
  },
  id: string(),
  get idNumber() {
    return optional(GelatoIdNumberReportSchema);
  },
  livemode: boolean(),
  object: string(),
  get options() {
    return optional(GelatoVerificationReportOptionsSchema);
  },
  get phone() {
    return optional(GelatoPhoneReportSchema);
  },
  get selfie() {
    return optional(GelatoSelfieReportSchema);
  },
  type: string(),
