...
export const TreasuryFinancialAccountFeaturesSchema: TypedSchema<TreasuryFinancialAccountFeatures> = typed<TreasuryFinancialAccountFeatures>(object({
  get cardIssuing() {
    return optional(TreasuryFinancialAccountsResourceToggleSettingsSchema);
  },
  get depositInsurance() {
    return optional(TreasuryFinancialAccountsResourceToggleSettingsSchema);
  },
  get financialAddresses() {
    return optional(TreasuryFinancialAccountsResourceFinancialAddressesFeaturesSchema);
  },
  get inboundTransfers() {
    return optional(TreasuryFinancialAccountsResourceInboundTransfersSchema);
  },
  ...
  get outboundPayments() {
    return optional(TreasuryFinancialAccountsResourceOutboundPaymentsSchema);
  },
  get outboundTransfers() {
    return optional(TreasuryFinancialAccountsResourceOutboundTransfersSchema);
  },
}));
