...
export const PaymentLinksResourceInvoiceSettingsSchema: TypedSchema<PaymentLinksResourceInvoiceSettings> = typed<PaymentLinksResourceInvoiceSettings>(object({
  get accountTaxIds() {
  ...
  get issuer() {
    return optional(ConnectAccountReferenceSchema);
  },
  get metadata() {
    return optional(MetadataPropertySchema);
  },
  get renderingOptions() {
    return optional(InvoiceSettingCheckoutRenderingOptionsSchema);
  },
}));
