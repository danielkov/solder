...
export const PaymentMethodDetailsCardSchema: TypedSchema<PaymentMethodDetailsCard> = typed<PaymentMethodDetailsCard>(object({
  ...
  get checks() {
    return optional(PaymentMethodDetailsCardChecksSchema);
  },
  country: optional(string()),
  expMonth: number(),
  expYear: number(),
  get extendedAuthorization() {
    return optional(PaymentFlowsPrivatePaymentMethodsCardDetailsApiResourceEnterpriseFeaturesExtendedAuthorizationExtendedAuthorizationSchema);
  },
  fingerprint: optional(string()),
  funding: optional(string()),
  get incrementalAuthorization() {
    return optional(PaymentFlowsPrivatePaymentMethodsCardDetailsApiResourceEnterpriseFeaturesIncrementalAuthorizationIncrementalAuthorizationSchema);
  },
  get installments() {
    return optional(PaymentMethodDetailsCardInstallmentsSchema);
  },
  last4: optional(string()),
  mandate: optional(string()),
  get multicapture() {
    return optional(PaymentFlowsPrivatePaymentMethodsCardDetailsApiResourceMulticaptureSchema);
  },
  network: optional(string()),
  get networkToken() {
    return optional(PaymentMethodDetailsCardNetworkTokenSchema);
  },
  networkTransactionId: optional(string()),
  get overcapture() {
    return optional(PaymentFlowsPrivatePaymentMethodsCardDetailsApiResourceEnterpriseFeaturesOvercaptureOvercaptureSchema);
  },
  regulatedStatus: optional(string()),
  get threeDSecure() {
    return optional(ThreeDSecureDetailsChargeSchema);
  },
  get wallet() {
    return optional(PaymentMethodDetailsCardWalletSchema);
  },
}));
