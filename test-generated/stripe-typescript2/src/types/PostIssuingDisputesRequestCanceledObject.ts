...
export const PostIssuingDisputesRequestCanceledObjectSchema: TypedSchema<PostIssuingDisputesRequestCanceledObject> = typed<PostIssuingDisputesRequestCanceledObject>(object({
  get additionalDocumentation() {
    return optional(PostAccountsRequestSupportUrlSchema);
  },
  get canceledAt() {
    return optional(PostIssuingDisputesRequestCanceledObjectCanceledAtSchema);
  },
  get cancellationPolicyProvided() {
    return optional(PostIssuingDisputesRequestCanceledObjectCancellationPolicyProvidedSchema);
  },
  get cancellationReason() {
    return optional(PostIssuingDisputesRequestCanceledObjectCancellationReasonSchema);
  },
  get expectedAt() {
    return optional(PostIssuingDisputesRequestCanceledObjectCanceledAtSchema);
  },
