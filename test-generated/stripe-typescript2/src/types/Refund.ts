...
export const RefundSchema: TypedSchema<Refund> = typed<Refund>(object({
  ...
  get destinationDetails() {
    return optional(RefundDestinationDetailsSchema);
  },
  ...
  get nextAction() {
    return optional(RefundNextActionSchema);
  },
  object: string(),
  get paymentIntent() {
  ...
  get sourceTransferReversal() {
    return optional(SourceTransferReversalOrRefSchema);
  },
  status: optional(string()),
  get transferReversal() {
    return optional(TransferReversalOrRefSchema);
  },
}));
