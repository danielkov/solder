...
export const PostTestHelpersConfirmationTokensRequestSchema: TypedSchema<PostTestHelpersConfirmationTokensRequest> = typed<PostTestHelpersConfirmationTokensRequest>(object({
  ...
  get paymentMethodData() {
    return optional(PostTestHelpersConfirmationTokensRequestPaymentMethodDataSchema);
  },
  get paymentMethodOptions() {
    return optional(PostTestHelpersConfirmationTokensRequestPaymentMethodOptionsSchema);
  },
  returnUrl: optional(string()),
  setupFutureUsage: optional(string()),
  get shipping() {
    return optional(PostTestHelpersConfirmationTokensRequestShippingSchema);
  },
}));
