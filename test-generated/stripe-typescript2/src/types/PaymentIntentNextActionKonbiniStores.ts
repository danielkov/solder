...
export const PaymentIntentNextActionKonbiniStoresSchema: TypedSchema<PaymentIntentNextActionKonbiniStores> = typed<PaymentIntentNextActionKonbiniStores>(object({
  get familymart() {
    return optional(PaymentIntentNextActionKonbiniFamilymartSchema);
  },
  get lawson() {
    return optional(PaymentIntentNextActionKonbiniLawsonSchema);
  },
  get ministop() {
    return optional(PaymentIntentNextActionKonbiniMinistopSchema);
  },
  get seicomart() {
    return optional(PaymentIntentNextActionKonbiniSeicomartSchema);
  },
}));
