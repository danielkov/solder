...
export const InboundTransfersPaymentMethodDetailsUsBankAccountSchema: TypedSchema<InboundTransfersPaymentMethodDetailsUsBankAccount> = typed<InboundTransfersPaymentMethodDetailsUsBankAccount>(object({
