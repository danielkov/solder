...
export const PostPaymentLinksRequestSchema: TypedSchema<PostPaymentLinksRequest> = typed<PostPaymentLinksRequest>(object({
  ...
  get consentCollection() {
    return optional(PostPaymentLinksRequestConsentCollectionSchema);
  },
  ...
  get invoiceCreation() {
    return optional(PostPaymentLinksRequestInvoiceCreationSchema);
  },
  ...
  get nameCollection() {
    return optional(PostPaymentLinksRequestNameCollectionSchema);
  },
  ...
  get paymentIntentData() {
    return optional(PostPaymentLinksRequestPaymentIntentDataSchema);
  },
  ...
  get restrictions() {
    return optional(PostPaymentLinksRequestRestrictionsSchema);
  },
  get shippingAddressCollection() {
    return optional(PostPaymentLinksRequestShippingAddressCollectionSchema);
  },
  get shippingOptions() {
    return optional(array(PostPaymentLinksRequestShippingOptionsItemSchema));
  },
  submitType: optional(string()),
  get subscriptionData() {
    return optional(PostPaymentLinksRequestSubscriptionDataSchema);
  },
  get taxIdCollection() {
    return optional(PostCheckoutSessionsRequestTaxIdCollectionSchema);
  },
  get transferData() {
    return optional(PostPaymentLinksRequestTransferDataSchema);
  },
}));
