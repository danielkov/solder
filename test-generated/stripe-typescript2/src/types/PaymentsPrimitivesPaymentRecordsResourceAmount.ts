...
export const PaymentsPrimitivesPaymentRecordsResourceAmountSchema: TypedSchema<PaymentsPrimitivesPaymentRecordsResourceAmount> = typed<PaymentsPrimitivesPaymentRecordsResourceAmount>(object({ currency: string(), value: number() }));
