...
export const PostPaymentIntentsRequestLineItemsObjectPaymentMethodOptionsSchema: TypedSchema<PostPaymentIntentsRequestLineItemsObjectPaymentMethodOptions> = typed<PostPaymentIntentsRequestLineItemsObjectPaymentMethodOptions>(object({
  get card() {
    return optional(PostPaymentIntentsRequestLineItemsObjectCardSchema);
  },
  get cardPresent() {
    return optional(PostPaymentIntentsRequestLineItemsObjectCardPresentSchema);
  },
  get klarna() {
    return optional(PostPaymentIntentsRequestLineItemsObjectKlarnaSchema);
  },
  get paypal() {
    return optional(PostPaymentIntentsRequestLineItemsObjectPaypalSchema);
  },
}));
