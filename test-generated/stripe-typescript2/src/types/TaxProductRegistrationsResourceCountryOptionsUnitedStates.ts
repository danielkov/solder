...
export const TaxProductRegistrationsResourceCountryOptionsUnitedStatesSchema: TypedSchema<TaxProductRegistrationsResourceCountryOptionsUnitedStates> = typed<TaxProductRegistrationsResourceCountryOptionsUnitedStates>(object({
  get localAmusementTax() {
    return optional(TaxProductRegistrationsResourceCountryOptionsUsLocalAmusementTaxSchema);
  },
  get localLeaseTax() {
    return optional(TaxProductRegistrationsResourceCountryOptionsUsLocalLeaseTaxSchema);
  },
  state: string(),
  get stateSalesTax() {
    return optional(TaxProductRegistrationsResourceCountryOptionsUsStateSalesTaxSchema);
  },
  type: string(),
}));
