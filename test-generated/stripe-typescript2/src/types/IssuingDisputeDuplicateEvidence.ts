...
export const IssuingDisputeDuplicateEvidenceSchema: TypedSchema<IssuingDisputeDuplicateEvidence> = typed<IssuingDisputeDuplicateEvidence>(object({
  get additionalDocumentation() {
    return optional(AdditionalDocumentationOrRefSchema);
  },
  get cardStatement() {
    return optional(CardStatementOrRefSchema);
  },
  get cashReceipt() {
    return optional(CashReceiptOrRefSchema);
  },
  get checkImage() {
    return optional(CheckImageOrRefSchema);
  },
