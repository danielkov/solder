...
export const TreasuryOutboundTransferSchema: TypedSchema<TreasuryOutboundTransfer> = typed<TreasuryOutboundTransfer>(object({
  ...
  object: string(),
  get returnedDetails() {
    return optional(TreasuryOutboundTransfersResourceReturnedDetailsSchema);
  },
  statementDescriptor: string(),
  status: string(),
  statusTransitions: TreasuryOutboundTransfersResourceStatusTransitionsSchema,
  get trackingDetails() {
    return optional(TreasuryOutboundTransfersResourceOutboundTransferResourceTrackingDetailsSchema);
  },
