...
export const SetupIntentSchema: TypedSchema<SetupIntent> = typed<SetupIntent>(object({
  ...
  get automaticPaymentMethods() {
    return optional(PaymentFlowsAutomaticPaymentMethodsSetupIntentSchema);
  },
  ...
  get latestAttempt() {
    return optional(LatestAttemptOrRefSchema);
  },
  livemode: boolean(),
  get mandate() {
    return optional(MandateOrRefSchema);
  },
  get metadata() {
    return optional(MetadataPropertySchema);
  },
  get nextAction() {
    return optional(SetupIntentNextActionSchema);
  },
  object: string(),
  get onBehalfOf() {
  ...
  get paymentMethodOptions() {
    return optional(SetupIntentPaymentMethodOptionsSchema);
  },
  paymentMethodTypes: array(string()),
  get singleUseMandate() {
    return optional(SingleUseMandateOrRefSchema);
  },
  status: string(),
  usage: string(),
}));
