...
export const PostPaymentRecordsIdReportRefundRequestAmountSchema: TypedSchema<PostPaymentRecordsIdReportRefundRequestAmount> = typed<PostPaymentRecordsIdReportRefundRequestAmount>(object({ currency: string(), value: number() }));
