import { array, object, optional, typed } from '@speakeasy-api/tonic';
...
export const PostChargesChargeDisputeRequestEnhancedEvidenceObjectVisaCompellingEvidence3Schema: TypedSchema<PostChargesChargeDisputeRequestEnhancedEvidenceObjectVisaCompellingEvidence3> = typed<PostChargesChargeDisputeRequestEnhancedEvidenceObjectVisaCompellingEvidence3>(object({
  get disputedTransaction() {
    return optional(PostChargesChargeDisputeRequestEnhancedEvidenceObjectDisputedTransactionSchema);
  },
  get priorUndisputedTransactions() {
    return optional(array(PostChargesChargeDisputeRequestEnhancedEvidenceObjectPriorUndisputedTransactionsItemSchema));
  },
}));
