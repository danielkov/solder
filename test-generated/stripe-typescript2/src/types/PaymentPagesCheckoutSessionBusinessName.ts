...
export const PaymentPagesCheckoutSessionBusinessNameSchema: TypedSchema<PaymentPagesCheckoutSessionBusinessName> = typed<PaymentPagesCheckoutSessionBusinessName>(object({ enabled: boolean(), optional: boolean() }));
