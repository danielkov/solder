...
export const PostBillingPortalConfigurationsConfigurationRequestFeaturesSchema: TypedSchema<PostBillingPortalConfigurationsConfigurationRequestFeatures> = typed<PostBillingPortalConfigurationsConfigurationRequestFeatures>(object({
  get customerUpdate() {
    return optional(PostBillingPortalConfigurationsConfigurationRequestCustomerUpdateSchema);
  },
  get invoiceHistory() {
    return optional(PostBillingPortalConfigurationsRequestInvoiceHistorySchema);
  },
  get paymentMethodUpdate() {
    return optional(PostBillingPortalConfigurationsRequestPaymentMethodUpdateSchema);
  },
  get subscriptionCancel() {
    return optional(PostBillingPortalConfigurationsConfigurationRequestSubscriptionCancelSchema);
  },
  get subscriptionUpdate() {
    return optional(PostBillingPortalConfigurationsConfigurationRequestSubscriptionUpdateSchema);
  },
}));
