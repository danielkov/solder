import { object, optional, string, typed, unknown } from '@speakeasy-api/tonic';
 ...
 */
export interface PostTestHelpersConfirmationTokensRequestPaymentMethodData {
  /**
...
export const PostTestHelpersConfirmationTokensRequestPaymentMethodDataSchema: TypedSchema<PostTestHelpersConfirmationTokensRequestPaymentMethodData> = typed<PostTestHelpersConfirmationTokensRequestPaymentMethodData>(object({
  get acssDebit() {
    return optional(PostPaymentIntentsRequestAcssDebitSchema);
  },
  ...
  get auBecsDebit() {
    return optional(PostPaymentIntentsRequestAuBecsDebitSchema);
  },
  get bacsDebit() {
    return optional(PostPaymentIntentsRequestBacsDebitSchema);
  },
  bancontact: optional(unknown()),
  billie: optional(unknown()),
  get billingDetails() {
    return optional(PostPaymentIntentsRequestBillingDetailsSchema);
  },
  blik: optional(unknown()),
  get boleto() {
    return optional(PostPaymentIntentsRequestBoletoSchema);
  },
  cashapp: optional(unknown()),
  crypto: optional(unknown()),
  customerBalance: optional(unknown()),
  get eps() {
    return optional(PostPaymentIntentsRequestEpsSchema);
  },
  get fpx() {
    return optional(PostPaymentIntentsRequestFpxSchema);
  },
  giropay: optional(unknown()),
  grabpay: optional(unknown()),
  get ideal() {
    return optional(PostPaymentIntentsRequestIdealSchema);
  },
  interacPresent: optional(unknown()),
  kakaoPay: optional(unknown()),
  get klarna() {
    return optional(PostPaymentIntentsRequestKlarnaSchema);
  },
  ...
  get naverPay() {
    return optional(PostPaymentIntentsRequestNaverPaySchema);
  },
  get nzBankAccount() {
    return optional(PostPaymentIntentsRequestNzBankAccountSchema);
  },
  oxxo: optional(unknown()),
  get p24() {
    return optional(PostPaymentIntentsRequestP24Schema);
  },
  ...
  get radarOptions() {
    return optional(PostPaymentIntentsRequestRadarOptionsSchema);
  },
  revolutPay: optional(unknown()),
  samsungPay: optional(unknown()),
  satispay: optional(unknown()),
  get sepaDebit() {
    return optional(PostPaymentIntentsRequestSepaDebitSchema);
  },
  get sofort() {
    return optional(PostPaymentIntentsRequestSofortSchema);
  },
  swish: optional(unknown()),
  twint: optional(unknown()),
  type: string(),
  get usBankAccount() {
    return optional(PostPaymentIntentsRequestUsBankAccountSchema);
  },
