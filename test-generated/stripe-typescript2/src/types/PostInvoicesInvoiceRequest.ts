...
export const PostInvoicesInvoiceRequestSchema: TypedSchema<PostInvoicesInvoiceRequest> = typed<PostInvoicesInvoiceRequest>(object({
  get accountTaxIds() {
    return optional(PostInvoicesRequestAccountTaxIdsSchema);
  },
  applicationFeeAmount: optional(number()),
  autoAdvance: optional(boolean()),
  get automaticTax() {
    return optional(PostInvoicesRequestAutomaticTaxSchema);
  },
  automaticallyFinalizesAt: optional(number()),
  collectionMethod: optional(string()),
  get customFields() {
    return optional(PostInvoicesInvoiceRequestCustomFieldsSchema);
  },
  daysUntilDue: optional(number()),
  defaultPaymentMethod: optional(string()),
  get defaultSource() {
    return optional(PostInvoicesInvoiceRequestDefaultSourceSchema);
  },
  get defaultTaxRates() {
    return optional(PostInvoicesInvoiceRequestDefaultTaxRatesSchema);
  },
  description: optional(string()),
  get discounts() {
    return optional(PostInvoicesInvoiceRequestDiscountsSchema);
  },
  dueDate: optional(number()),
  get effectiveAt() {
    return optional(PostInvoicesInvoiceRequestEffectiveAtSchema);
  },
  expand: optional(array(string())),
  footer: optional(string()),
  get issuer() {
    return optional(PostInvoicesRequestIssuerSchema);
  },
  get metadata() {
    return optional(DefaultPostAccountsRequestMetadataSchema);
  },
  get number() {
    return optional(PostInvoicesInvoiceRequestNumberSchema);
  },
  get onBehalfOf() {
    return optional(PostInvoicesCreatePreviewRequestOnBehalfOfSchema);
  },
  get paymentSettings() {
    return optional(PostInvoicesRequestPaymentSettingsSchema);
  },
  get rendering() {
    return optional(PostInvoicesRequestRenderingSchema);
  },
  get shippingCost() {
    return optional(PostInvoicesInvoiceRequestShippingCostSchema);
  },
  get shippingDetails() {
    return optional(PostInvoicesInvoiceRequestShippingDetailsSchema);
  },
  statementDescriptor: optional(string()),
  get transferData() {
    return optional(PostInvoicesInvoiceRequestTransferDataSchema);
  },
}));
