...
import type { TaxProductRegistrationsResourceCountryOptionsCanada } from './TaxProductRegistrationsResourceCountryOptionsCanada';
import { TaxProductRegistrationsResourceCountryOptionsCanadaSchema } from './TaxProductRegistrationsResourceCountryOptionsCanada';
import type { TaxProductRegistrationsResourceCountryOptionsDefault } from './TaxProductRegistrationsResourceCountryOptionsDefault';
import { TaxProductRegistrationsResourceCountryOptionsDefaultSchema } from './TaxProductRegistrationsResourceCountryOptionsDefault';
import type { TaxProductRegistrationsResourceCountryOptionsDefaultInboundGoods } from './TaxProductRegistrationsResourceCountryOptionsDefaultInboundGoods';
import { TaxProductRegistrationsResourceCountryOptionsDefaultInboundGoodsSchema } from './TaxProductRegistrationsResourceCountryOptionsDefaultInboundGoods';
import type { TaxProductRegistrationsResourceCountryOptionsEurope } from './TaxProductRegistrationsResourceCountryOptionsEurope';
import { TaxProductRegistrationsResourceCountryOptionsEuropeSchema } from './TaxProductRegistrationsResourceCountryOptionsEurope';
import type { TaxProductRegistrationsResourceCountryOptionsSimplified } from './TaxProductRegistrationsResourceCountryOptionsSimplified';
import { TaxProductRegistrationsResourceCountryOptionsSimplifiedSchema } from './TaxProductRegistrationsResourceCountryOptionsSimplified';
import type { TaxProductRegistrationsResourceCountryOptionsThailand } from './TaxProductRegistrationsResourceCountryOptionsThailand';
import { TaxProductRegistrationsResourceCountryOptionsThailandSchema } from './TaxProductRegistrationsResourceCountryOptionsThailand';
import type { TaxProductRegistrationsResourceCountryOptionsUnitedStates } from './TaxProductRegistrationsResourceCountryOptionsUnitedStates';
import { TaxProductRegistrationsResourceCountryOptionsUnitedStatesSchema } from './TaxProductRegistrationsResourceCountryOptionsUnitedStates';
/**
...
export const TaxProductRegistrationsResourceCountryOptionsSchema: TypedSchema<TaxProductRegistrationsResourceCountryOptions> = typed<TaxProductRegistrationsResourceCountryOptions>(object({
  get ae() {
    return optional(TaxProductRegistrationsResourceCountryOptionsDefaultInboundGoodsSchema);
  },
  get al() {
    return optional(TaxProductRegistrationsResourceCountryOptionsDefaultSchema);
  },
  get am() {
    return optional(TaxProductRegistrationsResourceCountryOptionsSimplifiedSchema);
  },
  get ao() {
    return optional(TaxProductRegistrationsResourceCountryOptionsDefaultSchema);
  },
  get at() {
    return optional(TaxProductRegistrationsResourceCountryOptionsEuropeSchema);
  },
  get au() {
    return optional(TaxProductRegistrationsResourceCountryOptionsDefaultInboundGoodsSchema);
  },
  ...
  get ca() {
    return optional(TaxProductRegistrationsResourceCountryOptionsCanadaSchema);
  },
  get cd() {
    return optional(TaxProductRegistrationsResourceCountryOptionsDefaultSchema);
  },
  ...
  get th() {
    return optional(TaxProductRegistrationsResourceCountryOptionsThailandSchema);
  },
  get tj() {
    return optional(TaxProductRegistrationsResourceCountryOptionsSimplifiedSchema);
  },
  ...
  get us() {
    return optional(TaxProductRegistrationsResourceCountryOptionsUnitedStatesSchema);
  },
  get uy() {
    return optional(TaxProductRegistrationsResourceCountryOptionsDefaultSchema);
  },
