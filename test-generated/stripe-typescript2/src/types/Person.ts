...
export const PersonSchema: TypedSchema<Person> = typed<Person>(object({
  ...
  get additionalTosAcceptances() {
    return optional(PersonAdditionalTosAcceptancesSchema);
  },
  get address() {
    return optional(AddressSchema);
  },
  get addressKana() {
    return optional(LegalEntityJapanAddressSchema);
  },
  get addressKanji() {
    return optional(LegalEntityJapanAddressSchema);
  },
  created: number(),
  get dob() {
    return optional(LegalEntityDobSchema);
  },
  ...
  get futureRequirements() {
    return optional(PersonFutureRequirementsSchema);
  },
  ...
  get relationship() {
    return optional(PersonRelationshipSchema);
  },
  get requirements() {
    return optional(PersonRequirementsSchema);
  },
  ssnLast4Provided: optional(boolean()),
  get usCfpbData() {
    return optional(PersonUsCfpbDataSchema);
  },
  get verification() {
    return optional(LegalEntityPersonVerificationSchema);
  },
}));
