...
export const PostAccountsAccountRequestSettingsSchema: TypedSchema<PostAccountsAccountRequestSettings> = typed<PostAccountsAccountRequestSettings>(object({
  get bacsDebitPayments() {
    return optional(PostAccountsRequestBacsDebitPaymentsSchema);
  },
  get branding() {
    return optional(PostAccountsRequestBrandingSchema);
  },
  get cardIssuing() {
    return optional(PostAccountsRequestCardIssuingSchema);
  },
  get cardPayments() {
    return optional(PostAccountsRequestCardPaymentsSchema);
  },
  get invoices() {
    return optional(PostAccountsAccountRequestInvoicesSchema);
  },
  get payments() {
    return optional(PostAccountsRequestPaymentsSchema);
  },
  get payouts() {
    return optional(PostAccountsRequestPayoutsSchema);
  },
  get treasury() {
    return optional(PostAccountsRequestTreasurySchema);
  },
}));
