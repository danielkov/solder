...
export const PaymentLinkSchema: TypedSchema<PaymentLink> = typed<PaymentLink>(object({
  ...
  get consentCollection() {
    return optional(PaymentLinksResourceConsentCollectionSchema);
  },
  currency: string(),
  ...
  get invoiceCreation() {
    return optional(PaymentLinksResourceInvoiceCreationSchema);
  },
  get lineItems() {
  ...
  get nameCollection() {
    return optional(PaymentLinksResourceNameCollectionSchema);
  },
  object: string(),
  get onBehalfOf() {
  ...
  get optionalItems() {
    return optional(array(PaymentLinksResourceOptionalItemSchema));
  },
  get paymentIntentData() {
    return optional(PaymentLinksResourcePaymentIntentDataSchema);
  },
  paymentMethodCollection: string(),
  paymentMethodTypes: optional(array(string())),
  phoneNumberCollection: PaymentLinksResourcePhoneNumberCollectionSchema,
  get restrictions() {
    return optional(PaymentLinksResourceRestrictionsSchema);
  },
  get shippingAddressCollection() {
    return optional(PaymentLinksResourceShippingAddressCollectionSchema);
  },
  shippingOptions: array(PaymentLinksResourceShippingOptionSchema),
  submitType: string(),
  get subscriptionData() {
    return optional(PaymentLinksResourceSubscriptionDataSchema);
  },
  taxIdCollection: PaymentLinksResourceTaxIdCollectionSchema,
  get transferData() {
    return optional(PaymentLinksResourceTransferDataSchema);
  },
  url: string(),
}));
