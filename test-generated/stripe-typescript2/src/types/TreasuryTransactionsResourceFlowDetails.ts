...
export const TreasuryTransactionsResourceFlowDetailsSchema: TypedSchema<TreasuryTransactionsResourceFlowDetails> = typed<TreasuryTransactionsResourceFlowDetails>(object({
  get creditReversal() {
    return optional(TreasuryCreditReversalSchema);
  },
  get debitReversal() {
    return optional(TreasuryDebitReversalSchema);
  },
  get inboundTransfer() {
    return optional(TreasuryInboundTransferSchema);
  },
  get issuingAuthorization() {
    return optional(IssuingAuthorizationSchema);
  },
  get outboundPayment() {
    return optional(TreasuryOutboundPaymentSchema);
  },
  get outboundTransfer() {
    return optional(TreasuryOutboundTransferSchema);
  },
  get receivedCredit() {
    return optional(TreasuryReceivedCreditSchema);
  },
  get receivedDebit() {
    return optional(TreasuryReceivedDebitSchema);
  },
  type: string(),
}));
