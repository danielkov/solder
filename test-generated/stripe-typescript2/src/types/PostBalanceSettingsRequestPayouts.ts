...
export const PostBalanceSettingsRequestPayoutsSchema: TypedSchema<PostBalanceSettingsRequestPayouts> = typed<PostBalanceSettingsRequestPayouts>(object({
  get minimumBalanceByCurrency() {
    return optional(PostBalanceSettingsRequestMinimumBalanceByCurrencySchema);
  },
  get schedule() {
    return optional(PostBalanceSettingsRequestScheduleSchema);
  },
