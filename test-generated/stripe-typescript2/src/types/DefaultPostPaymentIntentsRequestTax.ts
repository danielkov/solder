...
export const DefaultPostPaymentIntentsRequestTaxSchema: TypedSchema<DefaultPostPaymentIntentsRequestTax> = typed<DefaultPostPaymentIntentsRequestTax>(object({ calculation: PostAccountsRequestPaymentsPricingSchema }));
