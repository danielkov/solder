...
export const PostSourcesRequestSchema: TypedSchema<PostSourcesRequest> = typed<PostSourcesRequest>(object({
  ...
  get mandate() {
    return optional(PostSourcesRequestMandateSchema);
  },
  get metadata() {
  ...
  get owner() {
    return optional(PostSourcesRequestOwnerSchema);
  },
  get receiver() {
    return optional(PostSourcesRequestReceiverSchema);
  },
  get redirect() {
    return optional(PostSourcesRequestRedirectSchema);
  },
  get sourceOrder() {
    return optional(PostSourcesRequestSourceOrderSchema);
  },
