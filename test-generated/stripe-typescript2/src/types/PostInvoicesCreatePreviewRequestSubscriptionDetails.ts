...
export const PostInvoicesCreatePreviewRequestSubscriptionDetailsSchema: TypedSchema<PostInvoicesCreatePreviewRequestSubscriptionDetails> = typed<PostInvoicesCreatePreviewRequestSubscriptionDetails>(object({
  get billingCycleAnchor() {
    return optional(PostInvoicesCreatePreviewRequestBillingCycleAnchorSchema);
  },
  get billingMode() {
    return optional(PostCheckoutSessionsRequestBillingModeSchema);
  },
  get cancelAt() {
    return optional(PostInvoicesCreatePreviewRequestCancelAtSchema);
  },
  ...
  get trialEnd() {
    return optional(PostInvoicesCreatePreviewRequestTrialEndSchema);
  },
}));
