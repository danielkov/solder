...
export const PostTaxCalculationsRequestSchema: TypedSchema<PostTaxCalculationsRequest> = typed<PostTaxCalculationsRequest>(object({
  ...
  get customerDetails() {
    return optional(PostTaxCalculationsRequestCustomerDetailsSchema);
  },
  expand: optional(array(string())),
  lineItems: array(PostTaxCalculationsRequestLineItemsItemSchema),
  get shipFromDetails() {
    return optional(PostTaxCalculationsRequestShipFromDetailsSchema);
  },
  get shippingCost() {
    return optional(PostTaxCalculationsRequestShippingCostSchema);
  },
