...
export const AccountSettingsSchema: TypedSchema<AccountSettings> = typed<AccountSettings>(object({
  get bacsDebitPayments() {
    return optional(AccountBacsDebitPaymentsSettingsSchema);
  },
  branding: AccountBrandingSettingsSchema,
  get cardIssuing() {
    return optional(AccountCardIssuingSettingsSchema);
  },
  cardPayments: AccountCardPaymentsSettingsSchema,
  dashboard: AccountDashboardSettingsSchema,
  get invoices() {
    return optional(AccountInvoicesSettingsSchema);
  },
  payments: AccountPaymentsSettingsSchema,
  get payouts() {
    return optional(AccountPayoutSettingsSchema);
  },
  get sepaDebitPayments() {
    return optional(AccountSepaDebitPaymentsSettingsSchema);
  },
  get treasury() {
    return optional(AccountTreasurySettingsSchema);
  },
}));
