...
export const SourceMandateNotificationSchema: TypedSchema<SourceMandateNotification> = typed<SourceMandateNotification>(object({
  get acssDebit() {
    return optional(SourceMandateNotificationAcssDebitDataSchema);
  },
  amount: optional(number()),
  get bacsDebit() {
    return optional(SourceMandateNotificationBacsDebitDataSchema);
  },
  created: number(),
  id: string(),
  livemode: boolean(),
  ...
  reason: string(),
  get sepaDebit() {
    return optional(SourceMandateNotificationSepaDebitDataSchema);
  },
  source: SourceSchema,
  status: string(),
  type: string(),
