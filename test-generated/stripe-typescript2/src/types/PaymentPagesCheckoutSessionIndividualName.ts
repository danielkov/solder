...
export const PaymentPagesCheckoutSessionIndividualNameSchema: TypedSchema<PaymentPagesCheckoutSessionIndividualName> = typed<PaymentPagesCheckoutSessionIndividualName>(object({ enabled: boolean(), optional: boolean() }));
