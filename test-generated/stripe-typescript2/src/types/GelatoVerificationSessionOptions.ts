...
export const GelatoVerificationSessionOptionsSchema: TypedSchema<GelatoVerificationSessionOptions> = typed<GelatoVerificationSessionOptions>(object({
  get document() {
    return optional(GelatoSessionDocumentOptionsSchema);
  },
  get email() {
    return optional(GelatoSessionEmailOptionsSchema);
  },
  get idNumber() {
    return optional(GelatoSessionIdNumberOptionsSchema);
  },
  get matching() {
    return optional(GelatoSessionMatchingOptionsSchema);
  },
  get phone() {
    return optional(GelatoSessionPhoneOptionsSchema);
  },
}));
