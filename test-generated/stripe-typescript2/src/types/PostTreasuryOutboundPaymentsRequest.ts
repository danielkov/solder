...
export const PostTreasuryOutboundPaymentsRequestSchema: TypedSchema<PostTreasuryOutboundPaymentsRequest> = typed<PostTreasuryOutboundPaymentsRequest>(object({
  ...
  get destinationPaymentMethodData() {
    return optional(PostTreasuryOutboundPaymentsRequestDestinationPaymentMethodDataSchema);
  },
  get destinationPaymentMethodOptions() {
    return optional(PostTreasuryOutboundPaymentsRequestDestinationPaymentMethodOptionsSchema);
  },
  get endUserDetails() {
    return optional(PostTreasuryOutboundPaymentsRequestEndUserDetailsSchema);
  },
