...
export const PostBillingPortalConfigurationsRequestFeaturesSchema: TypedSchema<PostBillingPortalConfigurationsRequestFeatures> = typed<PostBillingPortalConfigurationsRequestFeatures>(object({
  get customerUpdate() {
    return optional(PostBillingPortalConfigurationsRequestCustomerUpdateSchema);
  },
  get invoiceHistory() {
  ...
  get subscriptionCancel() {
    return optional(PostBillingPortalConfigurationsRequestSubscriptionCancelSchema);
  },
  get subscriptionUpdate() {
    return optional(PostBillingPortalConfigurationsRequestSubscriptionUpdateSchema);
  },
}));
