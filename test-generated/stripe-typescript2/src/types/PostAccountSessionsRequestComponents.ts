...
export const PostAccountSessionsRequestComponentsSchema: TypedSchema<PostAccountSessionsRequestComponents> = typed<PostAccountSessionsRequestComponents>(object({
  get accountManagement() {
    return optional(PostAccountSessionsRequestAccountManagementSchema);
  },
  get accountOnboarding() {
    return optional(PostAccountSessionsRequestAccountManagementSchema);
  },
  get balances() {
    return optional(PostAccountSessionsRequestBalancesSchema);
  },
  get disputesList() {
    return optional(PostAccountSessionsRequestDisputesListSchema);
  },
  get documents() {
    return optional(PostAccountSessionsRequestDocumentsSchema);
  },
  get financialAccount() {
    return optional(PostAccountSessionsRequestFinancialAccountSchema);
  },
  get financialAccountTransactions() {
    return optional(PostAccountSessionsRequestFinancialAccountTransactionsSchema);
  },
  get instantPayoutsPromotion() {
    return optional(PostAccountSessionsRequestInstantPayoutsPromotionSchema);
  },
  get issuingCard() {
    return optional(PostAccountSessionsRequestIssuingCardSchema);
  },
  get issuingCardsList() {
    return optional(PostAccountSessionsRequestIssuingCardsListSchema);
  },
  get notificationBanner() {
    return optional(PostAccountSessionsRequestAccountManagementSchema);
  },
  get paymentDetails() {
    return optional(PostAccountSessionsRequestPaymentDetailsSchema);
  },
  get paymentDisputes() {
    return optional(PostAccountSessionsRequestPaymentDisputesSchema);
  },
  get payments() {
    return optional(PostAccountSessionsRequestPaymentDetailsSchema);
  },
