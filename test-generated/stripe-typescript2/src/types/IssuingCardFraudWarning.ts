...
export const IssuingCardFraudWarningSchema: TypedSchema<IssuingCardFraudWarning> = typed<IssuingCardFraudWarning>(object({ startedAt: optional(number()), type: optional(string()) }));
