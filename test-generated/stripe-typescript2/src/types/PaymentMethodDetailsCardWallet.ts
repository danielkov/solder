...
export const PaymentMethodDetailsCardWalletSchema: TypedSchema<PaymentMethodDetailsCardWallet> = typed<PaymentMethodDetailsCardWallet>(object({
  get amexExpressCheckout() {
    return optional(PaymentMethodDetailsCardWalletAmexExpressCheckoutSchema);
  },
  get applePay() {
    return optional(PaymentMethodDetailsCardWalletApplePaySchema);
  },
  dynamicLast4: optional(string()),
  get googlePay() {
    return optional(PaymentMethodDetailsCardWalletGooglePaySchema);
  },
  get link() {
    return optional(PaymentMethodDetailsCardWalletLinkSchema);
  },
  get masterpass() {
    return optional(PaymentMethodDetailsCardWalletMasterpassSchema);
  },
  get samsungPay() {
    return optional(PaymentMethodDetailsCardWalletSamsungPaySchema);
  },
  type: string(),
  get visaCheckout() {
    return optional(PaymentMethodDetailsCardWalletVisaCheckoutSchema);
  },
}));
