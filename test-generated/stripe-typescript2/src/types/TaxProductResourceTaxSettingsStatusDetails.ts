...
export const TaxProductResourceTaxSettingsStatusDetailsSchema: TypedSchema<TaxProductResourceTaxSettingsStatusDetails> = typed<TaxProductResourceTaxSettingsStatusDetails>(object({
  get active() {
    return optional(TaxProductResourceTaxSettingsStatusDetailsResourceActiveSchema);
  },
  get pending() {
    return optional(TaxProductResourceTaxSettingsStatusDetailsResourcePendingSchema);
  },
}));
