...
export const PaymentRecordSchema: TypedSchema<PaymentRecord> = typed<PaymentRecord>(object({
  ...
  created: number(),
  get customerDetails() {
    return optional(PaymentsPrimitivesPaymentRecordsResourceCustomerDetailsSchema);
  },
  ...
  get paymentMethodDetails() {
    return optional(PaymentsPrimitivesPaymentRecordsResourcePaymentMethodDetailsSchema);
  },
  processorDetails: PaymentsPrimitivesPaymentRecordsResourceProcessorDetailsSchema,
  get shippingDetails() {
    return optional(PaymentsPrimitivesPaymentRecordsResourceShippingDetailsSchema);
  },
}));
