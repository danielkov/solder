...
export const PostTaxTransactionsCreateReversalRequestSchema: TypedSchema<PostTaxTransactionsCreateReversalRequest> = typed<PostTaxTransactionsCreateReversalRequest>(object({
  ...
  get lineItems() {
    return optional(array(PostTaxTransactionsCreateReversalRequestLineItemsItemSchema));
  },
  get metadata() {
  ...
  reference: string(),
  get shippingCost() {
    return optional(PostTaxTransactionsCreateReversalRequestShippingCostSchema);
  },
}));
