...
export const PortalFlowsFlowSchema: TypedSchema<PortalFlowsFlow> = typed<PortalFlowsFlow>(object({
  ...
  get subscriptionCancel() {
    return optional(PortalFlowsFlowSubscriptionCancelSchema);
  },
  get subscriptionUpdate() {
    return optional(PortalFlowsFlowSubscriptionUpdateSchema);
  },
  get subscriptionUpdateConfirm() {
    return optional(PortalFlowsFlowSubscriptionUpdateConfirmSchema);
  },
  type: string(),
}));
