...
export const IssuingCardholderIndividualSchema: TypedSchema<IssuingCardholderIndividual> = typed<IssuingCardholderIndividual>(object({
  get cardIssuing() {
    return optional(IssuingCardholderCardIssuingSchema);
  },
  get dob() {
    return optional(IssuingCardholderIndividualDobSchema);
  },
  firstName: optional(string()),
  lastName: optional(string()),
  get verification() {
    return optional(IssuingCardholderVerificationSchema);
  },
}));
