...
export const DefaultPostPaymentIntentsRequestUsBankAccountObjectSchema: TypedSchema<DefaultPostPaymentIntentsRequestUsBankAccountObject> = typed<DefaultPostPaymentIntentsRequestUsBankAccountObject>(object({
  get financialConnections() {
    return optional(DefaultPostPaymentIntentsRequestUsBankAccountObjectFinancialConnectionsSchema);
  },
  get mandateOptions() {
    return optional(DefaultPostPaymentIntentsRequestUsBankAccountObjectMandateOptionsSchema);
  },
  get networks() {
    return optional(DefaultPostPaymentIntentsRequestUsBankAccountObjectNetworksSchema);
  },
