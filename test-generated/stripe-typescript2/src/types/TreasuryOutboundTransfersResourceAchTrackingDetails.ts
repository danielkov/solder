...
export const TreasuryOutboundTransfersResourceAchTrackingDetailsSchema: TypedSchema<TreasuryOutboundTransfersResourceAchTrackingDetails> = typed<TreasuryOutboundTransfersResourceAchTrackingDetails>(object({ traceId: string() }));
