...
export const PostBillingPortalConfigurationsConfigurationRequestSchema: TypedSchema<PostBillingPortalConfigurationsConfigurationRequest> = typed<PostBillingPortalConfigurationsConfigurationRequest>(object({
  ...
  get businessProfile() {
    return optional(PostBillingPortalConfigurationsConfigurationRequestBusinessProfileSchema);
  },
  get defaultReturnUrl() {
    return optional(PostBillingPortalConfigurationsRequestDefaultReturnUrlSchema);
  },
  expand: optional(array(string())),
  get features() {
    return optional(PostBillingPortalConfigurationsConfigurationRequestFeaturesSchema);
  },
  get loginPage() {
    return optional(PostBillingPortalConfigurationsConfigurationRequestLoginPageSchema);
  },
  get metadata() {
    return optional(DefaultPostAccountsRequestMetadataSchema);
  },
  get name() {
    return optional(PostBillingPortalConfigurationsRequestNameSchema);
  },
}));
