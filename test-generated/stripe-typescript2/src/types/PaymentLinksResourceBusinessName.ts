...
export const PaymentLinksResourceBusinessNameSchema: TypedSchema<PaymentLinksResourceBusinessName> = typed<PaymentLinksResourceBusinessName>(object({ enabled: boolean(), optional: boolean() }));
