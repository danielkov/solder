...
export const DiscountsResourceDiscountAmountSchema: TypedSchema<DiscountsResourceDiscountAmount> = typed<DiscountsResourceDiscountAmount>(object({ amount: number(), discount: DiscountUnionSchema }));
