...
export interface PostIssuingSettlementsSettlementRequest {
  /**
...
export const PostIssuingSettlementsSettlementRequestSchema: TypedSchema<PostIssuingSettlementsSettlementRequest> = typed<PostIssuingSettlementsSettlementRequest>(object({
