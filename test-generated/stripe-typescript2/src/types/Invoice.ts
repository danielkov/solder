...
export const InvoiceSchema: TypedSchema<Invoice> = typed<Invoice>(object({
  ...
  get accountTaxIds() {
    return optional(array(AccountTaxIdsItemUnionSchema));
  },
  amountDue: number(),
  amountOverpaid: number(),
  amountPaid: number(),
  ...
  amountShipping: number(),
  get application() {
    return optional(ApplicationUnionSchema);
  },
  attemptCount: number(),
  attempted: boolean(),
  autoAdvance: boolean(),
  ...
  collectionMethod: string(),
  get confirmationSecret() {
    return optional(InvoicesResourceConfirmationSecretSchema);
  },
  created: number(),
  currency: string(),
  get customFields() {
    return optional(array(InvoiceSettingCustomFieldSchema));
  },
  customer: CustomerUnionSchema,
  get customerAddress() {
    return optional(AddressSchema);
  },
  customerEmail: optional(string()),
  customerName: optional(string()),
  customerPhone: optional(string()),
  get customerShipping() {
    return optional(ShippingSchema);
  },
  customerTaxExempt: optional(string()),
  get customerTaxIds() {
    return optional(array(InvoicesResourceInvoiceTaxIdSchema));
  },
  get defaultPaymentMethod() {
    return optional(DefaultPaymentMethodOrRefSchema);
  },
  get defaultSource() {
    return optional(DefaultSourceUnionSchema);
  },
  ...
  get fromInvoice() {
    return optional(InvoicesResourceFromInvoiceSchema);
  },
  hostedInvoiceUrl: optional(string()),
  id: string(),
  invoicePdf: optional(string()),
  issuer: ConnectAccountReferenceSchema,
  get lastFinalizationError() {
    return optional(ApiErrorsSchema);
  },
  get latestRevision() {
    return optional(LatestRevisionOrRefSchema);
  },
  ...
  object: string(),
  get onBehalfOf() {
    return optional(OnBehalfOfOrRefSchema);
  },
  get parent() {
    return optional(BillingBillResourceInvoicingParentsInvoiceParentSchema);
  },
  paymentSettings: InvoicesPaymentSettingsSchema,
  get payments() {
    return optional(PaymentsPropertySchema);
  },
  periodEnd: number(),
  periodStart: number(),
  postPaymentCreditNotesAmount: number(),
  ...
  get rendering() {
    return optional(InvoicesResourceInvoiceRenderingSchema);
  },
  get shippingCost() {
    return optional(InvoicesResourceShippingCostSchema);
  },
  get shippingDetails() {
    return optional(ShippingSchema);
  },
  ...
  get testClock() {
    return optional(TestClockOrRefSchema);
  },
  get thresholdReason() {
    return optional(InvoiceThresholdReasonSchema);
  },
  total: number(),
  get totalDiscountAmounts() {
    return optional(array(DiscountsResourceDiscountAmountSchema));
  },
  totalExcludingTax: optional(number()),
  get totalPretaxCreditAmounts() {
    return optional(array(InvoicesResourcePretaxCreditAmountSchema));
  },
  get totalTaxes() {
    return optional(array(BillingBillResourceInvoicingTaxesTaxSchema));
  },
