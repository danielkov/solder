...
export const LegalEntityCompanySchema: TypedSchema<LegalEntityCompany> = typed<LegalEntityCompany>(object({
  ...
  get directorshipDeclaration() {
    return optional(LegalEntityDirectorshipDeclarationSchema);
  },
  ...
  get ownershipDeclaration() {
    return optional(LegalEntityUboDeclarationSchema);
  },
  ownershipExemptionReason: optional(string()),
  phone: optional(string()),
  get registrationDate() {
    return optional(LegalEntityRegistrationDateSchema);
  },
  get representativeDeclaration() {
    return optional(LegalEntityRepresentativeDeclarationSchema);
  },
  ...
  get verification() {
    return optional(LegalEntityCompanyVerificationSchema);
  },
}));
