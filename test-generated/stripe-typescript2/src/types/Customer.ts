...
export const CustomerSchema: TypedSchema<Customer> = typed<Customer>(object({
  ...
  get cashBalance() {
    return optional(CashBalanceSchema);
  },
  created: number(),
  ...
  get discount() {
    return optional(DiscountSchema);
  },
  email: optional(string()),
  id: string(),
  individualName: optional(string()),
  get invoiceCreditBalance() {
    return optional(InvoiceCreditBalancePropertySchema);
  },
  invoicePrefix: optional(string()),
  get invoiceSettings() {
    return optional(InvoiceSettingCustomerSettingSchema);
  },
  livemode: boolean(),
  get metadata() {
  ...
  get sources() {
    return optional(SourcesPropertySchema);
  },
  get subscriptions() {
    return optional(SubscriptionsPropertySchema);
  },
  get tax() {
    return optional(CustomerTaxSchema);
  },
  taxExempt: optional(string()),
  get taxIds() {
    return optional(TaxIdsPropertySchema);
  },
  get testClock() {
