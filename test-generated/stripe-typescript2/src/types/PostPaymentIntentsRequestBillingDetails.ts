 ...
 */
export interface PostPaymentIntentsRequestBillingDetails {
...
export const PostPaymentIntentsRequestBillingDetailsSchema: TypedSchema<PostPaymentIntentsRequestBillingDetails> = typed<PostPaymentIntentsRequestBillingDetails>(object({
  get address() {
    return optional(PostPaymentIntentsRequestAddressSchema);
  },
  get email() {
    return optional(PostAccountsRequestSupportUrlSchema);
  },
  get name() {
    return optional(PostAccountsRequestPaymentsPricingSchema);
  },
  get phone() {
    return optional(PostAccountsRequestPaymentsPricingSchema);
  },
