...
export const PostCheckoutSessionsRequestSchema: TypedSchema<PostCheckoutSessionsRequest> = typed<PostCheckoutSessionsRequest>(object({
  get adaptivePricing() {
    return optional(PostCheckoutSessionsRequestAdaptivePricingSchema);
  },
  get afterExpiration() {
    return optional(PostCheckoutSessionsRequestAfterExpirationSchema);
  },
  allowPromotionCodes: optional(boolean()),
  get automaticTax() {
    return optional(PostCheckoutSessionsRequestAutomaticTaxSchema);
  },
  billingAddressCollection: optional(string()),
  get brandingSettings() {
    return optional(PostCheckoutSessionsRequestBrandingSettingsSchema);
  },
  cancelUrl: optional(string()),
  clientReferenceId: optional(string()),
  get consentCollection() {
    return optional(PostCheckoutSessionsRequestConsentCollectionSchema);
  },
  currency: optional(string()),
  get customFields() {
    return optional(array(PostCheckoutSessionsRequestCustomFieldsItemSchema));
  },
  get customText() {
    return optional(PostCheckoutSessionsRequestCustomTextSchema);
  },
  customer: optional(string()),
  customerCreation: optional(string()),
  customerEmail: optional(string()),
  get customerUpdate() {
    return optional(PostCheckoutSessionsRequestCustomerUpdateSchema);
  },
  get discounts() {
    return optional(array(PostCheckoutSessionsRequestDiscountsItemSchema));
  },
  excludedPaymentMethodTypes: optional(array(string())),
  expand: optional(array(string())),
  expiresAt: optional(number()),
  get invoiceCreation() {
    return optional(PostCheckoutSessionsRequestInvoiceCreationSchema);
  },
  get lineItems() {
    return optional(array(PostCheckoutSessionsRequestLineItemsItemSchema));
  },
  locale: optional(string()),
  get metadata() {
    return optional(PostAccountsAccountBankAccountsRequestMetadataSchema);
  },
  mode: optional(string()),
  get nameCollection() {
    return optional(PostCheckoutSessionsRequestNameCollectionSchema);
  },
  get optionalItems() {
    return optional(array(PostCheckoutSessionsRequestOptionalItemsItemSchema));
  },
  originContext: optional(string()),
  get paymentIntentData() {
    return optional(PostCheckoutSessionsRequestPaymentIntentDataSchema);
  },
  paymentMethodCollection: optional(string()),
  paymentMethodConfiguration: optional(string()),
  get paymentMethodData() {
    return optional(PostCheckoutSessionsRequestPaymentMethodDataSchema);
  },
  get paymentMethodOptions() {
    return optional(PostCheckoutSessionsRequestPaymentMethodOptionsSchema);
  },
  paymentMethodTypes: optional(array(string())),
  get permissions() {
    return optional(PostCheckoutSessionsRequestPermissionsSchema);
  },
  get phoneNumberCollection() {
    return optional(PostCheckoutSessionsRequestPhoneNumberCollectionSchema);
  },
  redirectOnCompletion: optional(string()),
  returnUrl: optional(string()),
  get savedPaymentMethodOptions() {
    return optional(PostCheckoutSessionsRequestSavedPaymentMethodOptionsSchema);
  },
  get setupIntentData() {
    return optional(PostCheckoutSessionsRequestSetupIntentDataSchema);
  },
  get shippingAddressCollection() {
    return optional(PostCheckoutSessionsRequestShippingAddressCollectionSchema);
  },
  get shippingOptions() {
    return optional(array(PostCheckoutSessionsRequestShippingOptionsItemSchema));
  },
  submitType: optional(string()),
  get subscriptionData() {
    return optional(PostCheckoutSessionsRequestSubscriptionDataSchema);
  },
  successUrl: optional(string()),
  get taxIdCollection() {
    return optional(PostCheckoutSessionsRequestTaxIdCollectionSchema);
  },
  uiMode: optional(string()),
  get walletOptions() {
    return optional(PostCheckoutSessionsRequestWalletOptionsSchema);
  },
}));
