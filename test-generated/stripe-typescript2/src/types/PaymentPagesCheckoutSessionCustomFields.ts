...
export const PaymentPagesCheckoutSessionCustomFieldsSchema: TypedSchema<PaymentPagesCheckoutSessionCustomFields> = typed<PaymentPagesCheckoutSessionCustomFields>(object({
  get dropdown() {
    return optional(PaymentPagesCheckoutSessionCustomFieldsDropdownSchema);
  },
  key: string(),
  label: PaymentPagesCheckoutSessionCustomFieldsLabelSchema,
  get numeric() {
    return optional(PaymentPagesCheckoutSessionCustomFieldsNumericSchema);
  },
  optional: boolean(),
  get text() {
    return optional(PaymentPagesCheckoutSessionCustomFieldsTextSchema);
  },
  type: string(),
}));
