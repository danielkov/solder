...
export const IssuingDisputeEvidenceSchema: TypedSchema<IssuingDisputeEvidence> = typed<IssuingDisputeEvidence>(object({
  get canceled() {
    return optional(IssuingDisputeCanceledEvidenceSchema);
  },
  get duplicate() {
    return optional(IssuingDisputeDuplicateEvidenceSchema);
  },
  get fraudulent() {
    return optional(IssuingDisputeFraudulentEvidenceSchema);
  },
  get merchandiseNotAsDescribed() {
    return optional(IssuingDisputeMerchandiseNotAsDescribedEvidenceSchema);
  },
  get noValidAuthorization() {
    return optional(IssuingDisputeNoValidAuthorizationEvidenceSchema);
  },
  get notReceived() {
    return optional(IssuingDisputeNotReceivedEvidenceSchema);
  },
  get other() {
    return optional(IssuingDisputeOtherEvidenceSchema);
  },
  reason: string(),
  get serviceNotAsDescribed() {
    return optional(IssuingDisputeServiceNotAsDescribedEvidenceSchema);
  },
}));
