import { array, number, object, optional, string, typed } from '@speakeasy-api/tonic';
...
export const PostQuotesRequestSchema: TypedSchema<PostQuotesRequest> = typed<PostQuotesRequest>(object({
  get applicationFeeAmount() {
    return optional(PostQuotesRequestApplicationFeeAmountSchema);
  },
  get applicationFeePercent() {
    return optional(PostQuotesRequestApplicationFeePercentSchema);
  },
  get automaticTax() {
    return optional(PostQuotesRequestAutomaticTaxSchema);
  },
  collectionMethod: optional(string()),
  customer: optional(string()),
  get defaultTaxRates() {
    return optional(PostQuotesRequestDefaultTaxRatesSchema);
  },
  get description() {
    return optional(PostQuotesRequestDescriptionSchema);
  },
  get discounts() {
    return optional(PostQuotesRequestDiscountsSchema);
  },
  expand: optional(array(string())),
  expiresAt: optional(number()),
  get footer() {
    return optional(PostQuotesRequestFooterSchema);
  },
  get fromQuote() {
    return optional(PostQuotesRequestFromQuoteSchema);
  },
  get header() {
    return optional(PostQuotesRequestHeaderSchema);
  },
  get invoiceSettings() {
    return optional(PostQuotesRequestInvoiceSettingsSchema);
  },
  get lineItems() {
    return optional(array(PostQuotesRequestLineItemsItemSchema));
  },
  get metadata() {
    return optional(PostAccountsAccountBankAccountsRequestMetadataSchema);
  },
  get onBehalfOf() {
    return optional(PostQuotesRequestOnBehalfOfSchema);
  },
  get subscriptionData() {
    return optional(PostQuotesRequestSubscriptionDataSchema);
  },
  testClock: optional(string()),
  get transferData() {
    return optional(PostQuotesRequestTransferDataSchema);
  },
}));
