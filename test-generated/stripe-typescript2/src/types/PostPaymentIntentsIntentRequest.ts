...
export const PostPaymentIntentsIntentRequestSchema: TypedSchema<PostPaymentIntentsIntentRequest> = typed<PostPaymentIntentsIntentRequest>(object({
  ...
  get applicationFeeAmount() {
    return optional(PostPaymentIntentsIntentRequestApplicationFeeAmountSchema);
  },
  ...
  get paymentMethodOptions() {
    return optional(PostPaymentIntentsIntentRequestPaymentMethodOptionsSchema);
  },
  ...
  get transferData() {
    return optional(PostPaymentIntentsIntentRequestTransferDataSchema);
  },
