 ...
 * postal_address
 */
export interface PostTaxCalculationsRequestAddress {
...
export const PostTaxCalculationsRequestAddressSchema: TypedSchema<PostTaxCalculationsRequestAddress> = typed<PostTaxCalculationsRequestAddress>(object({
  get city() {
