...
export const PostPaymentIntentsIntentRequestTransferDataSchema: TypedSchema<PostPaymentIntentsIntentRequestTransferData> = typed<PostPaymentIntentsIntentRequestTransferData>(object({ amount: optional(number()) }));
