...
export const CheckoutCustomerBalanceBankTransferPaymentMethodOptionsSchema: TypedSchema<CheckoutCustomerBalanceBankTransferPaymentMethodOptions> = typed<CheckoutCustomerBalanceBankTransferPaymentMethodOptions>(object({
  get euBankTransfer() {
    return optional(PaymentMethodOptionsCustomerBalanceEuBankAccountSchema);
  },
