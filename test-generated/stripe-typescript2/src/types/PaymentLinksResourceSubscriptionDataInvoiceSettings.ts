...
export const PaymentLinksResourceSubscriptionDataInvoiceSettingsSchema: TypedSchema<PaymentLinksResourceSubscriptionDataInvoiceSettings> = typed<PaymentLinksResourceSubscriptionDataInvoiceSettings>(object({ issuer: ConnectAccountReferenceSchema }));
