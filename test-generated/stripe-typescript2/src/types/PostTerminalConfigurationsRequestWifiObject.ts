...
export const PostTerminalConfigurationsRequestWifiObjectSchema: TypedSchema<PostTerminalConfigurationsRequestWifiObject> = typed<PostTerminalConfigurationsRequestWifiObject>(object({
  get enterpriseEapPeap() {
    return optional(PostTerminalConfigurationsRequestWifiObjectEnterpriseEapPeapSchema);
  },
  get enterpriseEapTls() {
    return optional(PostTerminalConfigurationsRequestWifiObjectEnterpriseEapTlsSchema);
  },
  get personalPsk() {
    return optional(PostTerminalConfigurationsRequestWifiObjectPersonalPskSchema);
  },
  type: string(),
}));
