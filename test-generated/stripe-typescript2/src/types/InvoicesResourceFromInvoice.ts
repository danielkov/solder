...
export const InvoicesResourceFromInvoiceSchema: TypedSchema<InvoicesResourceFromInvoice> = typed<InvoicesResourceFromInvoice>(object({ action: string(), invoice: InvoiceOrRefSchema }));
