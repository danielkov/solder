...
export const PostTerminalLocationsLocationRequestSchema: TypedSchema<PostTerminalLocationsLocationRequest> = typed<PostTerminalLocationsLocationRequest>(object({
  get address() {
    return optional(PostTerminalLocationsLocationRequestAddressSchema);
  },
  get addressKana() {
    return optional(PostTerminalLocationsRequestAddressKanaSchema);
  },
  get addressKanji() {
    return optional(PostTerminalLocationsRequestAddressKanjiSchema);
  },
  get configurationOverrides() {
    return optional(PostTerminalLocationsLocationRequestConfigurationOverridesSchema);
  },
  get displayName() {
    return optional(PostTerminalLocationsLocationRequestDisplayNameSchema);
  },
  get displayNameKana() {
    return optional(PostTerminalLocationsLocationRequestDisplayNameKanaSchema);
  },
  get displayNameKanji() {
    return optional(PostTerminalLocationsLocationRequestDisplayNameKanjiSchema);
  },
  ...
  get phone() {
    return optional(PostTerminalLocationsLocationRequestPhoneSchema);
  },
}));
