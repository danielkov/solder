...
export const AccountSchema: TypedSchema<Account> = typed<Account>(object({
  get businessProfile() {
    return optional(AccountBusinessProfileSchema);
  },
  businessType: optional(string()),
  get capabilities() {
    return optional(AccountCapabilitiesSchema);
  },
  chargesEnabled: optional(boolean()),
  get company() {
    return optional(LegalEntityCompanySchema);
  },
  get controller() {
    return optional(AccountUnificationAccountControllerSchema);
  },
  ...
  get externalAccounts() {
    return optional(ExternalAccountsPropertySchema);
  },
  get futureRequirements() {
    return optional(AccountFutureRequirementsSchema);
  },
  get groups() {
    return optional(AccountGroupMembershipSchema);
  },
  id: string(),
  get individual() {
    return optional(PersonSchema);
  },
  get metadata() {
  ...
  get requirements() {
    return optional(AccountRequirementsSchema);
  },
  get settings() {
    return optional(AccountSettingsSchema);
  },
  get tosAcceptance() {
    return optional(AccountTosAcceptanceSchema);
  },
