...
export const PayoutSchema: TypedSchema<Payout> = typed<Payout>(object({
  ...
  get destination() {
    return optional(DestinationUnionSchema);
  },
  ...
  object: string(),
  get originalPayout() {
    return optional(OriginalPayoutOrRefSchema);
  },
  payoutMethod: optional(string()),
  reconciliationStatus: string(),
  get reversedBy() {
    return optional(ReversedByOrRefSchema);
  },
  sourceType: string(),
  statementDescriptor: optional(string()),
  status: string(),
  get traceId() {
    return optional(PayoutsTraceIdSchema);
  },
  type: string(),
}));
