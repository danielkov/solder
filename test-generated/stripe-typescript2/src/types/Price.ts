...
import { TransformQuantitySchema } from './TransformQuantity';
/**
 * Price
 * 
...
export const PriceSchema: TypedSchema<Price> = typed<Price>(object({
  active: boolean(),
  billingScheme: string(),
  created: number(),
  currency: string(),
  get currencyOptions() {
    return optional(CurrencyOptionsPropertySchema);
  },
  get customUnitAmount() {
    return optional(CustomUnitAmountSchema);
  },
  id: string(),
  livemode: boolean(),
  ...
  object: string(),
  product: ProductUnionSchema,
  get recurring() {
    return optional(RecurringSchema);
  },
  taxBehavior: optional(string()),
  get tiers() {
    return optional(array(PriceTierSchema));
  },
  tiersMode: optional(string()),
  get transformQuantity() {
    return optional(TransformQuantitySchema);
  },
  type: string(),
