...
export const PostTestHelpersIssuingAuthorizationsRequestSchema: TypedSchema<PostTestHelpersIssuingAuthorizationsRequest> = typed<PostTestHelpersIssuingAuthorizationsRequest>(object({
  ...
  get amountDetails() {
    return optional(PostTestHelpersIssuingAuthorizationsRequestAmountDetailsSchema);
  },
  ...
  get fleet() {
    return optional(PostTestHelpersIssuingAuthorizationsRequestFleetSchema);
  },
  fraudDisputabilityLikelihood: optional(string()),
  get fuel() {
    return optional(DefaultPostTestHelpersIssuingAuthorizationsRequestFuelSchema);
  },
  isAmountControllable: optional(boolean()),
  merchantAmount: optional(number()),
  merchantCurrency: optional(string()),
  get merchantData() {
    return optional(PostTestHelpersIssuingAuthorizationsRequestMerchantDataSchema);
  },
  get networkData() {
    return optional(PostTestHelpersIssuingAuthorizationsRequestNetworkDataSchema);
  },
  get riskAssessment() {
    return optional(PostTestHelpersIssuingAuthorizationsRequestRiskAssessmentSchema);
  },
  get verificationData() {
    return optional(PostTestHelpersIssuingAuthorizationsRequestVerificationDataSchema);
  },
