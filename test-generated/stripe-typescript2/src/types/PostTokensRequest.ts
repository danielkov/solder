...
export const PostTokensRequestSchema: TypedSchema<PostTokensRequest> = typed<PostTokensRequest>(object({
  get account() {
    return optional(PostTokensRequestAccountSchema);
  },
  get bankAccount() {
    return optional(PostTokensRequestBankAccountSchema);
  },
  get card() {
    return optional(PostTokensRequestCardSchema);
  },
  customer: optional(string()),
  get cvcUpdate() {
    return optional(PostTokensRequestCvcUpdateSchema);
  },
  expand: optional(array(string())),
  get person() {
    return optional(PostTokensRequestPersonSchema);
  },
  get pii() {
    return optional(PostTokensRequestPiiSchema);
  },
}));
