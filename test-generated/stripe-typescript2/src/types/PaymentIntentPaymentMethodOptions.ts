...
export const PaymentIntentPaymentMethodOptionsSchema: TypedSchema<PaymentIntentPaymentMethodOptions> = typed<PaymentIntentPaymentMethodOptions>(object({
  get acssDebit() {
    return optional(AcssDebitUnionSchema);
  },
  get affirm() {
    return optional(AffirmUnionSchema);
  },
  get afterpayClearpay() {
    return optional(AfterpayClearpayUnionSchema);
  },
  get alipay() {
    return optional(AlipayUnionSchema);
  },
  get alma() {
    return optional(AlmaUnionSchema);
  },
  get amazonPay() {
    return optional(AmazonPayUnionSchema);
  },
  get auBecsDebit() {
    return optional(AuBecsDebitUnionSchema);
  },
  get bacsDebit() {
    return optional(BacsDebitUnionSchema);
  },
  get bancontact() {
    return optional(BancontactUnionSchema);
  },
  get billie() {
    return optional(BillieUnionSchema);
  },
  get blik() {
    return optional(BlikUnionSchema);
  },
  get boleto() {
    return optional(BoletoUnionSchema);
  },
  get card() {
    return optional(CardUnionSchema);
  },
  get cardPresent() {
    return optional(CardPresentUnionSchema);
  },
  get cashapp() {
    return optional(CashappUnionSchema);
  },
  get crypto() {
    return optional(CryptoUnionSchema);
  },
  get customerBalance() {
    return optional(CustomerBalanceUnionSchema);
  },
  get eps() {
    return optional(EpsUnionSchema);
  },
  get fpx() {
    return optional(FpxUnionSchema);
  },
  get giropay() {
    return optional(GiropayUnionSchema);
  },
  get grabpay() {
    return optional(GrabpayUnionSchema);
  },
  get ideal() {
    return optional(IdealUnionSchema);
  },
  get interacPresent() {
    return optional(InteracPresentUnionSchema);
  },
  get kakaoPay() {
    return optional(KakaoPayUnionSchema);
  },
  get klarna() {
    return optional(KlarnaUnionSchema);
  },
  get konbini() {
    return optional(KonbiniUnionSchema);
  },
  get krCard() {
    return optional(KrCardUnionSchema);
  },
  get link() {
    return optional(LinkUnionSchema);
  },
  get mbWay() {
    return optional(MbWayUnionSchema);
  },
  get mobilepay() {
    return optional(MobilepayUnionSchema);
  },
  get multibanco() {
    return optional(MultibancoUnionSchema);
  },
  get naverPay() {
    return optional(NaverPayUnionSchema);
  },
  get nzBankAccount() {
    return optional(NzBankAccountUnionSchema);
  },
  get oxxo() {
    return optional(OxxoUnionSchema);
  },
  get p24() {
    return optional(P24UnionSchema);
  },
  get payByBank() {
    return optional(PayByBankUnionSchema);
  },
  get payco() {
    return optional(PaycoUnionSchema);
  },
  get paynow() {
    return optional(PaynowUnionSchema);
  },
  get paypal() {
    return optional(PaypalUnionSchema);
  },
  get pix() {
    return optional(PixUnionSchema);
  },
  get promptpay() {
    return optional(PromptpayUnionSchema);
  },
  get revolutPay() {
    return optional(RevolutPayUnionSchema);
  },
  get samsungPay() {
    return optional(SamsungPayUnionSchema);
  },
  get satispay() {
    return optional(SatispayUnionSchema);
  },
  get sepaDebit() {
    return optional(SepaDebitUnionSchema);
  },
  get sofort() {
    return optional(SofortUnionSchema);
  },
  get swish() {
    return optional(SwishUnionSchema);
  },
  get twint() {
    return optional(TwintUnionSchema);
  },
  get usBankAccount() {
    return optional(UsBankAccountUnionSchema);
  },
  get wechatPay() {
    return optional(WechatPayUnionSchema);
  },
  get zip() {
    return optional(ZipUnionSchema);
  },
}));
