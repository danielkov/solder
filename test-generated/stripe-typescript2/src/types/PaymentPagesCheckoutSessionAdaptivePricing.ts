...
export const PaymentPagesCheckoutSessionAdaptivePricingSchema: TypedSchema<PaymentPagesCheckoutSessionAdaptivePricing> = typed<PaymentPagesCheckoutSessionAdaptivePricing>(object({ enabled: boolean() }));
