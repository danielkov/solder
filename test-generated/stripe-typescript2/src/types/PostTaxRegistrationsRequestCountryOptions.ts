...
export const PostTaxRegistrationsRequestCountryOptionsSchema: TypedSchema<PostTaxRegistrationsRequestCountryOptions> = typed<PostTaxRegistrationsRequestCountryOptions>(object({
  get ae() {
    return optional(PostTaxRegistrationsRequestAeSchema);
  },
  get al() {
    return optional(PostTaxRegistrationsRequestAeSchema);
  },
  get am() {
    return optional(PostTaxRegistrationsRequestAmSchema);
  },
  get ao() {
    return optional(PostTaxRegistrationsRequestAeSchema);
  },
  get at() {
    return optional(PostTaxRegistrationsRequestAtSchema);
  },
  get au() {
    return optional(PostTaxRegistrationsRequestAeSchema);
  },
  ...
  get ca() {
    return optional(PostTaxRegistrationsRequestCaSchema);
  },
  get cd() {
    return optional(PostTaxRegistrationsRequestAeSchema);
  },
  ...
  get th() {
    return optional(PostTaxRegistrationsRequestThSchema);
  },
  get tj() {
    return optional(PostTaxRegistrationsRequestAmSchema);
  },
  ...
  get us() {
    return optional(PostTaxRegistrationsRequestUsSchema);
  },
  get uy() {
    return optional(PostTaxRegistrationsRequestAeSchema);
  },
