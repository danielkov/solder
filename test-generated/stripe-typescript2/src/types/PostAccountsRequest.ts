...
export const PostAccountsRequestSchema: TypedSchema<PostAccountsRequest> = typed<PostAccountsRequest>(object({
  ...
  get bankAccount() {
    return optional(PostAccountsRequestBankAccountSchema);
  },
  get businessProfile() {
    return optional(PostAccountsRequestBusinessProfileSchema);
  },
  businessType: optional(string()),
  get capabilities() {
    return optional(PostAccountsRequestCapabilitiesSchema);
  },
  get company() {
    return optional(PostAccountsRequestCompanySchema);
  },
  get controller() {
    return optional(PostAccountsRequestControllerSchema);
  },
  country: optional(string()),
  defaultCurrency: optional(string()),
  get documents() {
    return optional(PostAccountsRequestDocumentsSchema);
  },
  email: optional(string()),
  expand: optional(array(string())),
  externalAccount: optional(string()),
  get groups() {
    return optional(PostAccountsRequestGroupsSchema);
  },
  get individual() {
    return optional(PostAccountsRequestIndividualSchema);
  },
  get metadata() {
    return optional(DefaultPostAccountsRequestMetadataSchema);
  },
  get settings() {
    return optional(PostAccountsRequestSettingsSchema);
  },
  get tosAcceptance() {
    return optional(DefaultPostAccountsRequestTosAcceptanceSchema);
  },
