...
export const QuotesResourceFromQuoteSchema: TypedSchema<QuotesResourceFromQuote> = typed<QuotesResourceFromQuote>(object({ isRevision: boolean(), quote: QuoteOrRefSchema }));
