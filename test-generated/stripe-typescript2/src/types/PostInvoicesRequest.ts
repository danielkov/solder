...
export const PostInvoicesRequestSchema: TypedSchema<PostInvoicesRequest> = typed<PostInvoicesRequest>(object({
  ...
  get customFields() {
    return optional(PostInvoicesRequestCustomFieldsSchema);
  },
  ...
  get discounts() {
    return optional(PostInvoicesRequestDiscountsSchema);
  },
  ...
  get fromInvoice() {
    return optional(PostInvoicesRequestFromInvoiceSchema);
  },
  get issuer() {
  ...
  get shippingCost() {
    return optional(PostInvoicesRequestShippingCostSchema);
  },
  get shippingDetails() {
    return optional(PostInvoicesRequestShippingDetailsSchema);
  },
  statementDescriptor: optional(string()),
  subscription: optional(string()),
  get transferData() {
    return optional(PostInvoicesRequestTransferDataSchema);
  },
}));
