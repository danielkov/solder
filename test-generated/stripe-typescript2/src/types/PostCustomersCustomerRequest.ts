...
export const PostCustomersCustomerRequestSchema: TypedSchema<PostCustomersCustomerRequest> = typed<PostCustomersCustomerRequest>(object({
  get address() {
    return optional(PostCustomersRequestAddressSchema);
  },
  balance: optional(number()),
  get bankAccount() {
    return optional(PostCustomersCustomerRequestBankAccountSchema);
  },
  get businessName() {
    return optional(PostCustomersRequestBusinessNameSchema);
  },
  get card() {
    return optional(PostChargesRequestCardSchema);
  },
  get cashBalance() {
    return optional(PostCustomersRequestCashBalanceSchema);
  },
  ...
  get individualName() {
    return optional(PostCustomersRequestIndividualNameSchema);
  },
  invoicePrefix: optional(string()),
  get invoiceSettings() {
    return optional(PostCustomersRequestInvoiceSettingsSchema);
  },
  get metadata() {
  ...
  get shipping() {
    return optional(PostCustomersRequestShippingSchema);
  },
  source: optional(string()),
  get tax() {
    return optional(PostCustomersCustomerRequestTaxSchema);
  },
