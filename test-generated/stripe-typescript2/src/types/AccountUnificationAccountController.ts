...
export const AccountUnificationAccountControllerSchema: TypedSchema<AccountUnificationAccountController> = typed<AccountUnificationAccountController>(object({
  get fees() {
    return optional(AccountUnificationAccountControllerFeesSchema);
  },
  isController: optional(boolean()),
  get losses() {
    return optional(AccountUnificationAccountControllerLossesSchema);
  },
  requirementCollection: optional(string()),
  get stripeDashboard() {
    return optional(AccountUnificationAccountControllerStripeDashboardSchema);
  },
  type: string(),
}));
