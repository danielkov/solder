...
export const PaymentIntentNextActionSchema: TypedSchema<PaymentIntentNextAction> = typed<PaymentIntentNextAction>(object({
  get alipayHandleRedirect() {
    return optional(PaymentIntentNextActionAlipayHandleRedirectSchema);
  },
  get boletoDisplayDetails() {
    return optional(PaymentIntentNextActionBoletoSchema);
  },
  get cardAwaitNotification() {
    return optional(PaymentIntentNextActionCardAwaitNotificationSchema);
  },
  get cashappHandleRedirectOrDisplayQrCode() {
    return optional(PaymentIntentNextActionCashappHandleRedirectOrDisplayQrCodeSchema);
  },
  get displayBankTransferInstructions() {
    return optional(PaymentIntentNextActionDisplayBankTransferInstructionsSchema);
  },
  get konbiniDisplayDetails() {
    return optional(PaymentIntentNextActionKonbiniSchema);
  },
  get multibancoDisplayDetails() {
    return optional(PaymentIntentNextActionDisplayMultibancoDetailsSchema);
  },
  get oxxoDisplayDetails() {
    return optional(PaymentIntentNextActionDisplayOxxoDetailsSchema);
  },
  get paynowDisplayQrCode() {
    return optional(PaymentIntentNextActionPaynowDisplayQrCodeSchema);
  },
  get pixDisplayQrCode() {
    return optional(PaymentIntentNextActionPixDisplayQrCodeSchema);
  },
  get promptpayDisplayQrCode() {
    return optional(PaymentIntentNextActionPromptpayDisplayQrCodeSchema);
  },
  get redirectToUrl() {
    return optional(PaymentIntentNextActionRedirectToUrlSchema);
  },
  get swishHandleRedirectOrDisplayQrCode() {
    return optional(PaymentIntentNextActionSwishHandleRedirectOrDisplayQrCodeSchema);
  },
  type: string(),
  useStripeSdk: optional(unknown()),
  get verifyWithMicrodeposits() {
    return optional(PaymentIntentNextActionVerifyWithMicrodepositsSchema);
  },
  get wechatPayDisplayQrCode() {
    return optional(PaymentIntentNextActionWechatPayDisplayQrCodeSchema);
  },
  get wechatPayRedirectToAndroidApp() {
    return optional(PaymentIntentNextActionWechatPayRedirectToAndroidAppSchema);
  },
  get wechatPayRedirectToIosApp() {
    return optional(PaymentIntentNextActionWechatPayRedirectToIosAppSchema);
  },
}));
