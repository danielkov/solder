...
export const DisputePaymentMethodDetailsSchema: TypedSchema<DisputePaymentMethodDetails> = typed<DisputePaymentMethodDetails>(object({
  get amazonPay() {
    return optional(DisputePaymentMethodDetailsAmazonPaySchema);
  },
  get card() {
    return optional(DisputePaymentMethodDetailsCardSchema);
  },
  get klarna() {
    return optional(DisputePaymentMethodDetailsKlarnaSchema);
  },
  get paypal() {
    return optional(DisputePaymentMethodDetailsPaypalSchema);
  },
  type: string(),
}));
