...
export const PostIssuingPersonalizationDesignsPersonalizationDesignRequestSchema: TypedSchema<PostIssuingPersonalizationDesignsPersonalizationDesignRequest> = typed<PostIssuingPersonalizationDesignsPersonalizationDesignRequest>(object({
  get cardLogo() {
    return optional(PostIssuingPersonalizationDesignsPersonalizationDesignRequestCardLogoSchema);
  },
  get carrierText() {
    return optional(PostIssuingPersonalizationDesignsPersonalizationDesignRequestCarrierTextSchema);
  },
  expand: optional(array(string())),
  get lookupKey() {
    return optional(PostIssuingPersonalizationDesignsPersonalizationDesignRequestLookupKeySchema);
  },
  get metadata() {
    return optional(PostAccountsAccountBankAccountsRequestMetadataSchema);
  },
  get name() {
    return optional(PostIssuingPersonalizationDesignsPersonalizationDesignRequestNameSchema);
  },
  physicalBundle: optional(string()),
  get preferences() {
    return optional(PostIssuingPersonalizationDesignsRequestPreferencesSchema);
  },
