...
export const PostPaymentIntentsRequestCardObjectSchema: TypedSchema<PostPaymentIntentsRequestCardObject> = typed<PostPaymentIntentsRequestCardObject>(object({
  ...
  get installments() {
    return optional(PostInvoicesRequestCardObjectInstallmentsSchema);
  },
  get mandateOptions() {
    return optional(PostPaymentIntentsRequestCardObjectMandateOptionsSchema);
  },
  ...
  get statementDescriptorSuffixKana() {
    return optional(PostPaymentIntentsRequestCardObjectStatementDescriptorSuffixKanaSchema);
  },
  get statementDescriptorSuffixKanji() {
    return optional(PostPaymentIntentsRequestCardObjectStatementDescriptorSuffixKanjiSchema);
  },
  get threeDSecure() {
    return optional(PostPaymentIntentsRequestCardObjectThreeDSecureSchema);
  },
}));
