...
export const PostBillingPortalSessionsRequestFlowDataSchema: TypedSchema<PostBillingPortalSessionsRequestFlowData> = typed<PostBillingPortalSessionsRequestFlowData>(object({
  get afterCompletion() {
    return optional(PostBillingPortalSessionsRequestAfterCompletionSchema);
  },
  get subscriptionCancel() {
    return optional(PostBillingPortalSessionsRequestSubscriptionCancelSchema);
  },
  get subscriptionUpdate() {
    return optional(PostBillingPortalSessionsRequestSubscriptionUpdateSchema);
  },
  get subscriptionUpdateConfirm() {
    return optional(PostBillingPortalSessionsRequestSubscriptionUpdateConfirmSchema);
  },
  type: string(),
}));
