...
export const PostTokensRequestPersonSchema: TypedSchema<PostTokensRequestPerson> = typed<PostTokensRequestPerson>(object({
  get additionalTosAcceptances() {
    return optional(PostTokensRequestAdditionalTosAcceptancesSchema);
  },
  get address() {
  ...
  get dob() {
    return optional(PostAccountsRequestDobSchema);
  },
  get documents() {
    return optional(PostTokensRequestDocumentsSchema);
  },
  ...
  get registeredAddress() {
    return optional(PostAccountsRequestSupportAddressSchema);
  },
  get relationship() {
    return optional(PostTokensRequestRelationshipSchema);
  },
  ssnLast4: optional(string()),
  get usCfpbData() {
    return optional(PostTokensRequestUsCfpbDataSchema);
  },
  get verification() {
    return optional(DefaultPostAccountsRequestVerificationSchema);
  },
}));
