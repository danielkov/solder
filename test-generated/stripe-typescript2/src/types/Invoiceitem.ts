...
export const InvoiceitemSchema: TypedSchema<Invoiceitem> = typed<Invoiceitem>(object({
  ...
  discountable: boolean(),
  get discounts() {
    return optional(array(DiscountsItemOrRefSchema));
  },
  id: string(),
  get invoice() {
  ...
  object: string(),
  get parent() {
    return optional(BillingBillResourceInvoiceItemParentsInvoiceItemParentSchema);
  },
  ...
  proration: boolean(),
  get prorationDetails() {
    return optional(ProrationDetailsSchema);
  },
  quantity: number(),
  get taxRates() {
