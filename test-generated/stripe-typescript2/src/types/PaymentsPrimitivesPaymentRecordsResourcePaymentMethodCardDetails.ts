...
export const PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsSchema: TypedSchema<PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetails> = typed<PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetails>(object({
  ...
  get checks() {
    return optional(PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceChecksSchema);
  },
  ...
  get networkToken() {
    return optional(PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceNetworkTokenSchema);
  },
  networkTransactionId: optional(string()),
  get threeDSecure() {
    return optional(PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceThreeDSecureSchema);
  },
  get wallet() {
    return optional(PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceWalletSchema);
  },
}));
