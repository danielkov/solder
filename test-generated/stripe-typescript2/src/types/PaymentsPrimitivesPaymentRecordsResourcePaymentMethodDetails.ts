...
import type { PaymentsPrimitivesPaymentRecordsResourceBillingDetails } from './PaymentsPrimitivesPaymentRecordsResourceBillingDetails';
import { PaymentsPrimitivesPaymentRecordsResourceBillingDetailsSchema } from './PaymentsPrimitivesPaymentRecordsResourceBillingDetails';
import type { PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetails } from './PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetails';
import { PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsSchema } from './PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetails';
import type { PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCustomDetails } from './PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCustomDetails';
import { PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCustomDetailsSchema } from './PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCustomDetails';
import type { PaymentsPrimitivesPaymentRecordsResourcePaymentMethodUsBankAccountDetails } from './PaymentsPrimitivesPaymentRecordsResourcePaymentMethodUsBankAccountDetails';
import { PaymentsPrimitivesPaymentRecordsResourcePaymentMethodUsBankAccountDetailsSchema } from './PaymentsPrimitivesPaymentRecordsResourcePaymentMethodUsBankAccountDetails';
/**
...
export interface PaymentsPrimitivesPaymentRecordsResourcePaymentMethodDetails {
   ...
   */
  billingDetails?: PaymentsPrimitivesPaymentRecordsResourceBillingDetails;
  /**
...
It contains information specific to the payment method.
   ...
   * 
   */
  usBankAccount?: PaymentsPrimitivesPaymentRecordsResourcePaymentMethodUsBankAccountDetails;
  /**
...
export const PaymentsPrimitivesPaymentRecordsResourcePaymentMethodDetailsSchema: TypedSchema<PaymentsPrimitivesPaymentRecordsResourcePaymentMethodDetails> = typed<PaymentsPrimitivesPaymentRecordsResourcePaymentMethodDetails>(object({
  get achCreditTransfer() {
    return optional(PaymentMethodDetailsAchCreditTransferSchema);
  },
  get achDebit() {
    return optional(PaymentMethodDetailsAchDebitSchema);
  },
  get acssDebit() {
    return optional(PaymentMethodDetailsAcssDebitSchema);
  },
  get affirm() {
    return optional(PaymentMethodDetailsAffirmSchema);
  },
  get afterpayClearpay() {
    return optional(PaymentMethodDetailsAfterpayClearpaySchema);
  },
  get alipay() {
    return optional(PaymentFlowsPrivatePaymentMethodsAlipayDetailsSchema);
  },
  get alma() {
    return optional(PaymentMethodDetailsAlmaSchema);
  },
  get amazonPay() {
    return optional(PaymentMethodDetailsAmazonPaySchema);
  },
  get auBecsDebit() {
    return optional(PaymentMethodDetailsAuBecsDebitSchema);
  },
  get bacsDebit() {
    return optional(PaymentMethodDetailsBacsDebitSchema);
  },
  get bancontact() {
    return optional(PaymentMethodDetailsBancontactSchema);
  },
  get billie() {
    return optional(PaymentMethodDetailsBillieSchema);
  },
  get billingDetails() {
    return optional(PaymentsPrimitivesPaymentRecordsResourceBillingDetailsSchema);
  },
  get blik() {
    return optional(PaymentMethodDetailsBlikSchema);
  },
  get boleto() {
    return optional(PaymentMethodDetailsBoletoSchema);
  },
  get card() {
    return optional(PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsSchema);
  },
  get cardPresent() {
    return optional(PaymentMethodDetailsCardPresentSchema);
  },
  get cashapp() {
    return optional(PaymentMethodDetailsCashappSchema);
  },
  get crypto() {
    return optional(PaymentMethodDetailsCryptoSchema);
  },
  get custom() {
    return optional(PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCustomDetailsSchema);
  },
  get customerBalance() {
    return optional(PaymentMethodDetailsCustomerBalanceSchema);
  },
  get eps() {
    return optional(PaymentMethodDetailsEpsSchema);
  },
  get fpx() {
    return optional(PaymentMethodDetailsFpxSchema);
  },
  get giropay() {
    return optional(PaymentMethodDetailsGiropaySchema);
  },
  get grabpay() {
    return optional(PaymentMethodDetailsGrabpaySchema);
  },
  get ideal() {
    return optional(PaymentMethodDetailsIdealSchema);
  },
  get interacPresent() {
    return optional(PaymentMethodDetailsInteracPresentSchema);
  },
  get kakaoPay() {
    return optional(PaymentMethodDetailsKakaoPaySchema);
  },
  get klarna() {
    return optional(PaymentMethodDetailsKlarnaSchema);
  },
  get konbini() {
    return optional(PaymentMethodDetailsKonbiniSchema);
  },
  get krCard() {
    return optional(PaymentMethodDetailsKrCardSchema);
  },
  get link() {
    return optional(PaymentMethodDetailsLinkSchema);
  },
  get mbWay() {
    return optional(PaymentMethodDetailsMbWaySchema);
  },
  get mobilepay() {
    return optional(PaymentMethodDetailsMobilepaySchema);
  },
  get multibanco() {
    return optional(PaymentMethodDetailsMultibancoSchema);
  },
  get naverPay() {
    return optional(PaymentMethodDetailsNaverPaySchema);
  },
  get nzBankAccount() {
    return optional(PaymentMethodDetailsNzBankAccountSchema);
  },
  get oxxo() {
    return optional(PaymentMethodDetailsOxxoSchema);
  },
  get p24() {
    return optional(PaymentMethodDetailsP24Schema);
  },
  get payByBank() {
    return optional(PaymentMethodDetailsPayByBankSchema);
  },
  get payco() {
    return optional(PaymentMethodDetailsPaycoSchema);
  },
  paymentMethod: optional(string()),
  get paynow() {
    return optional(PaymentMethodDetailsPaynowSchema);
  },
  get paypal() {
    return optional(PaymentMethodDetailsPaypalSchema);
  },
  get pix() {
    return optional(PaymentMethodDetailsPixSchema);
  },
  get promptpay() {
    return optional(PaymentMethodDetailsPromptpaySchema);
  },
  get revolutPay() {
    return optional(PaymentMethodDetailsRevolutPaySchema);
  },
  get samsungPay() {
    return optional(PaymentMethodDetailsSamsungPaySchema);
  },
  get satispay() {
    return optional(PaymentMethodDetailsSatispaySchema);
  },
  get sepaDebit() {
    return optional(PaymentMethodDetailsSepaDebitSchema);
  },
  get sofort() {
    return optional(PaymentMethodDetailsSofortSchema);
  },
  get stripeAccount() {
    return optional(PaymentMethodDetailsStripeAccountSchema);
  },
  get swish() {
    return optional(PaymentMethodDetailsSwishSchema);
  },
  get twint() {
    return optional(PaymentMethodDetailsTwintSchema);
  },
  type: string(),
  get usBankAccount() {
    return optional(PaymentsPrimitivesPaymentRecordsResourcePaymentMethodUsBankAccountDetailsSchema);
  },
  get wechat() {
    return optional(PaymentMethodDetailsWechatSchema);
  },
  get wechatPay() {
    return optional(PaymentMethodDetailsWechatPaySchema);
  },
  get zip() {
    return optional(PaymentMethodDetailsZipSchema);
  },
}));
