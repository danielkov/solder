...
export const IssuingTransactionSchema: TypedSchema<IssuingTransaction> = typed<IssuingTransaction>(object({
  amount: number(),
  get amountDetails() {
    return optional(IssuingTransactionAmountDetailsSchema);
  },
  get authorization() {
    return optional(AuthorizationOrRefSchema);
  },
  ...
  currency: string(),
  get dispute() {
    return optional(DisputeOrRefSchema);
  },
  id: string(),
  livemode: boolean(),
  merchantAmount: number(),
  ...
  get networkData() {
    return optional(IssuingTransactionNetworkDataSchema);
  },
  object: string(),
  get purchaseDetails() {
    return optional(IssuingTransactionPurchaseDetailsSchema);
  },
  get token() {
    return optional(TokenOrRefSchema);
  },
  get treasury() {
    return optional(IssuingTransactionTreasurySchema);
  },
  type: string(),
