...
export const PostTestHelpersIssuingAuthorizationsAuthorizationCaptureRequestPurchaseDetailsSchema: TypedSchema<PostTestHelpersIssuingAuthorizationsAuthorizationCaptureRequestPurchaseDetails> = typed<PostTestHelpersIssuingAuthorizationsAuthorizationCaptureRequestPurchaseDetails>(object({
  get fleet() {
    return optional(PostTestHelpersIssuingAuthorizationsAuthorizationCaptureRequestFleetSchema);
  },
  get flight() {
    return optional(PostTestHelpersIssuingAuthorizationsAuthorizationCaptureRequestFlightSchema);
  },
  get fuel() {
    return optional(PostTestHelpersIssuingAuthorizationsAuthorizationCaptureRequestFuelSchema);
  },
  get lodging() {
    return optional(PostTestHelpersIssuingAuthorizationsAuthorizationCaptureRequestLodgingSchema);
  },
  get receipt() {
    return optional(array(PostTestHelpersIssuingAuthorizationsAuthorizationCaptureRequestReceiptItemSchema));
  },
