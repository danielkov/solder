...
export const PostPaymentRecordsReportPaymentRequestSchema: TypedSchema<PostPaymentRecordsReportPaymentRequest> = typed<PostPaymentRecordsReportPaymentRequest>(object({
  ...
  get customerDetails() {
    return optional(PostPaymentRecordsReportPaymentRequestCustomerDetailsSchema);
  },
  customerPresence: optional(string()),
  description: optional(string()),
  expand: optional(array(string())),
  get failed() {
    return optional(PostPaymentRecordsReportPaymentRequestFailedSchema);
  },
  get guaranteed() {
    return optional(PostPaymentRecordsReportPaymentRequestGuaranteedSchema);
  },
  initiatedAt: number(),
  get metadata() {
  ...
  get processorDetails() {
    return optional(PostPaymentRecordsReportPaymentRequestProcessorDetailsSchema);
  },
  get shippingDetails() {
    return optional(PostPaymentRecordsReportPaymentRequestShippingDetailsSchema);
  },
}));
