 ...
 */
export interface PostAccountsAccountRequestIndividual {
  /**
   * address_specs
   */
...
export const PostAccountsAccountRequestIndividualSchema: TypedSchema<PostAccountsAccountRequestIndividual> = typed<PostAccountsAccountRequestIndividual>(object({
  get address() {
  ...
  get fullNameAliases() {
    return optional(PostAccountsRequestFullNameAliasesSchema);
  },
  ...
  get relationship() {
    return optional(PostAccountsRequestRelationshipSchema);
  },
