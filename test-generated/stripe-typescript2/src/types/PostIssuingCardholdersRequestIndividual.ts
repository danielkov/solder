...
export const PostIssuingCardholdersRequestIndividualSchema: TypedSchema<PostIssuingCardholdersRequestIndividual> = typed<PostIssuingCardholdersRequestIndividual>(object({
  get cardIssuing() {
    return optional(PostIssuingCardholdersRequestCardIssuingSchema);
  },
  get dob() {
    return optional(PostAccountsRequestDobObjectSchema);
  },
  firstName: optional(string()),
  lastName: optional(string()),
  get verification() {
    return optional(PostIssuingCardholdersRequestVerificationSchema);
  },
}));
