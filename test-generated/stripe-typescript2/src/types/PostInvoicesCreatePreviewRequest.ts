...
export const PostInvoicesCreatePreviewRequestSchema: TypedSchema<PostInvoicesCreatePreviewRequest> = typed<PostInvoicesCreatePreviewRequest>(object({
  get automaticTax() {
    return optional(PostInvoicesCreatePreviewRequestAutomaticTaxSchema);
  },
  currency: optional(string()),
  customer: optional(string()),
  get customerDetails() {
    return optional(PostInvoicesCreatePreviewRequestCustomerDetailsSchema);
  },
  get discounts() {
    return optional(PostInvoicesCreatePreviewRequestDiscountsSchema);
  },
  expand: optional(array(string())),
  get invoiceItems() {
    return optional(array(PostInvoicesCreatePreviewRequestInvoiceItemsItemSchema));
  },
  get issuer() {
  ...
  get scheduleDetails() {
    return optional(PostInvoicesCreatePreviewRequestScheduleDetailsSchema);
  },
  subscription: optional(string()),
  get subscriptionDetails() {
    return optional(PostInvoicesCreatePreviewRequestSubscriptionDetailsSchema);
  },
}));
