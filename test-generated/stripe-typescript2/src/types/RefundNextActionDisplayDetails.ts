...
export const RefundNextActionDisplayDetailsSchema: TypedSchema<RefundNextActionDisplayDetails> = typed<RefundNextActionDisplayDetails>(object({ emailSent: EmailSentSchema, expiresAt: number() }));
