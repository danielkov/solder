...
export const PostChargesRequestSchema: TypedSchema<PostChargesRequest> = typed<PostChargesRequest>(object({
  ...
  get destination() {
    return optional(PostChargesRequestDestinationSchema);
  },
  ...
  get shipping() {
    return optional(PostChargesRequestShippingSchema);
  },
  source: optional(string()),
  statementDescriptor: optional(string()),
  statementDescriptorSuffix: optional(string()),
  get transferData() {
    return optional(PostChargesRequestTransferDataSchema);
  },
