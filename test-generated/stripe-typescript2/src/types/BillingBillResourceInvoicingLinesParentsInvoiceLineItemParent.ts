...
export const BillingBillResourceInvoicingLinesParentsInvoiceLineItemParentSchema: TypedSchema<BillingBillResourceInvoicingLinesParentsInvoiceLineItemParent> = typed<BillingBillResourceInvoicingLinesParentsInvoiceLineItemParent>(object({
  get invoiceItemDetails() {
    return optional(BillingBillResourceInvoicingLinesParentsInvoiceLineItemInvoiceItemParentSchema);
  },
  get subscriptionItemDetails() {
    return optional(BillingBillResourceInvoicingLinesParentsInvoiceLineItemSubscriptionItemParentSchema);
  },
  type: string(),
}));
