...
export const PostCheckoutSessionsRequestCustomFieldsItemSchema: TypedSchema<PostCheckoutSessionsRequestCustomFieldsItem> = typed<PostCheckoutSessionsRequestCustomFieldsItem>(object({
  get dropdown() {
    return optional(PostCheckoutSessionsRequestCustomFieldsItemDropdownSchema);
  },
  key: string(),
  label: PostCheckoutSessionsRequestCustomFieldsItemLabelSchema,
  get numeric() {
    return optional(PostCheckoutSessionsRequestCustomFieldsItemNumericSchema);
  },
  optional: optional(boolean()),
  get text() {
    return optional(PostCheckoutSessionsRequestCustomFieldsItemTextSchema);
  },
  type: string(),
}));
