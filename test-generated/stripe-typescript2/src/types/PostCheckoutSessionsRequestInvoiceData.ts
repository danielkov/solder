...
export const PostCheckoutSessionsRequestInvoiceDataSchema: TypedSchema<PostCheckoutSessionsRequestInvoiceData> = typed<PostCheckoutSessionsRequestInvoiceData>(object({
  ...
  get customFields() {
    return optional(PostCheckoutSessionsRequestCustomFieldsSchema);
  },
  description: optional(string()),
  footer: optional(string()),
  get issuer() {
    return optional(PostCheckoutSessionsRequestLiabilitySchema);
  },
  get metadata() {
    return optional(PostAccountsRequestMetadataObjectSchema);
  },
  get renderingOptions() {
    return optional(PostCheckoutSessionsRequestRenderingOptionsSchema);
  },
}));
