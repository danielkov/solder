...
export const PostIdentityVerificationSessionsRequestSchema: TypedSchema<PostIdentityVerificationSessionsRequest> = typed<PostIdentityVerificationSessionsRequest>(object({
  ...
  get options() {
    return optional(PostIdentityVerificationSessionsRequestOptionsSchema);
  },
  get providedDetails() {
    return optional(PostIdentityVerificationSessionsRequestProvidedDetailsSchema);
  },
  relatedCustomer: optional(string()),
  get relatedPerson() {
    return optional(PostIdentityVerificationSessionsRequestRelatedPersonSchema);
  },
