...
export const ChargeSchema: TypedSchema<Charge> = typed<Charge>(object({
  ...
  get applicationFee() {
    return optional(ApplicationFeeOrRefSchema);
  },
  applicationFeeAmount: optional(number()),
  get balanceTransaction() {
    return optional(BalanceTransactionOrRefSchema);
  },
  ...
  disputed: boolean(),
  get failureBalanceTransaction() {
    return optional(FailureBalanceTransactionOrRefSchema);
  },
  failureCode: optional(string()),
  failureMessage: optional(string()),
  get fraudDetails() {
    return optional(ChargeFraudDetailsSchema);
  },
  id: string(),
  livemode: boolean(),
  ...
  get outcome() {
    return optional(ChargeOutcomeSchema);
  },
  paid: boolean(),
  get paymentIntent() {
  ...
  get paymentMethodDetails() {
    return optional(PaymentMethodDetailsSchema);
  },
  ...
  refunded: boolean(),
  get refunds() {
    return optional(RefundsProperty2Schema);
  },
  get review() {
  ...
  get sourceTransfer() {
    return optional(SourceTransferOrRefSchema);
  },
  statementDescriptor: optional(string()),
  statementDescriptorSuffix: optional(string()),
  status: string(),
  get transfer() {
    return optional(TransferOrRefSchema);
  },
  get transferData() {
    return optional(ChargeTransferDataSchema);
  },
