...
export const PaymentMethodCardWalletSchema: TypedSchema<PaymentMethodCardWallet> = typed<PaymentMethodCardWallet>(object({
  get amexExpressCheckout() {
    return optional(PaymentMethodCardWalletAmexExpressCheckoutSchema);
  },
  get applePay() {
    return optional(PaymentMethodCardWalletApplePaySchema);
  },
  dynamicLast4: optional(string()),
  get googlePay() {
    return optional(PaymentMethodCardWalletGooglePaySchema);
  },
  get link() {
    return optional(PaymentMethodCardWalletLinkSchema);
  },
  get masterpass() {
    return optional(PaymentMethodCardWalletMasterpassSchema);
  },
  get samsungPay() {
    return optional(PaymentMethodCardWalletSamsungPaySchema);
  },
  type: string(),
  get visaCheckout() {
    return optional(PaymentMethodCardWalletVisaCheckoutSchema);
  },
}));
