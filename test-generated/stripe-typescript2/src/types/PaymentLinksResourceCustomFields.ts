...
export const PaymentLinksResourceCustomFieldsSchema: TypedSchema<PaymentLinksResourceCustomFields> = typed<PaymentLinksResourceCustomFields>(object({
  get dropdown() {
    return optional(PaymentLinksResourceCustomFieldsDropdownSchema);
  },
  key: string(),
  label: PaymentLinksResourceCustomFieldsLabelSchema,
  get numeric() {
    return optional(PaymentLinksResourceCustomFieldsNumericSchema);
  },
  optional: boolean(),
  get text() {
    return optional(PaymentLinksResourceCustomFieldsTextSchema);
  },
  type: string(),
}));
