...
export const PostAccountsAccountRequestSchema: TypedSchema<PostAccountsAccountRequest> = typed<PostAccountsAccountRequest>(object({
  ...
  get businessProfile() {
    return optional(PostAccountsAccountRequestBusinessProfileSchema);
  },
  ...
  get company() {
    return optional(PostAccountsAccountRequestCompanySchema);
  },
  ...
  get individual() {
    return optional(PostAccountsAccountRequestIndividualSchema);
  },
  get metadata() {
    return optional(DefaultPostAccountsRequestMetadataSchema);
  },
  get settings() {
    return optional(PostAccountsAccountRequestSettingsSchema);
  },
  get tosAcceptance() {
