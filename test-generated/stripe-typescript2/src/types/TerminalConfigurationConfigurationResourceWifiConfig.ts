...
export const TerminalConfigurationConfigurationResourceWifiConfigSchema: TypedSchema<TerminalConfigurationConfigurationResourceWifiConfig> = typed<TerminalConfigurationConfigurationResourceWifiConfig>(object({
  get enterpriseEapPeap() {
    return optional(TerminalConfigurationConfigurationResourceEnterprisePeapWifiSchema);
  },
  get enterpriseEapTls() {
    return optional(TerminalConfigurationConfigurationResourceEnterpriseTlsWifiSchema);
  },
  get personalPsk() {
    return optional(TerminalConfigurationConfigurationResourcePersonalPskWifiSchema);
  },
  type: string(),
}));
