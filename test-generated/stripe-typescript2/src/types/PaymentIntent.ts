...
export const PaymentIntentSchema: TypedSchema<PaymentIntent> = typed<PaymentIntent>(object({
  ...
  get amountDetails() {
    return optional(AmountDetailsUnionSchema);
  },
  amountReceived: optional(number()),
  get application() {
    return optional(ApplicationOrRefSchema);
  },
  applicationFeeAmount: optional(number()),
  get automaticPaymentMethods() {
    return optional(PaymentFlowsAutomaticPaymentMethodsPaymentIntentSchema);
  },
  ...
  get hooks() {
    return optional(PaymentFlowsPaymentIntentAsyncWorkflowsSchema);
  },
  id: string(),
  ...
  get latestCharge() {
    return optional(LatestChargeOrRefSchema);
  },
  livemode: boolean(),
  get metadata() {
  ...
  get nextAction() {
    return optional(PaymentIntentNextActionSchema);
  },
  object: string(),
  get onBehalfOf() {
  ...
  get paymentDetails() {
    return optional(PaymentFlowsPaymentDetailsSchema);
  },
  get paymentMethod() {
    return optional(PaymentMethodOrRefSchema);
  },
  get paymentMethodConfigurationDetails() {
    return optional(PaymentMethodConfigBizPaymentMethodConfigurationDetailsSchema);
  },
  get paymentMethodOptions() {
    return optional(PaymentIntentPaymentMethodOptionsSchema);
  },
  ...
  get processing() {
    return optional(PaymentIntentProcessingSchema);
  },
  receiptEmail: optional(string()),
  get review() {
    return optional(ReviewOrRefSchema);
  },
  ...
  status: string(),
  get transferData() {
    return optional(TransferDataSchema);
  },
