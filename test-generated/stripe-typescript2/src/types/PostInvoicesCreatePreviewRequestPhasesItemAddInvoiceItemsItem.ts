...
export const PostInvoicesCreatePreviewRequestPhasesItemAddInvoiceItemsItemSchema: TypedSchema<PostInvoicesCreatePreviewRequestPhasesItemAddInvoiceItemsItem> = typed<PostInvoicesCreatePreviewRequestPhasesItemAddInvoiceItemsItem>(object({
  get discounts() {
    return optional(array(PostCustomersCustomerSubscriptionsRequestAddInvoiceItemsItemDiscountsItemSchema));
  },
  get metadata() {
    return optional(PostAccountsRequestMetadataObjectSchema);
  },
  get period() {
    return optional(PostInvoicesCreatePreviewRequestPhasesItemAddInvoiceItemsItemPeriodSchema);
  },
  price: optional(string()),
  get priceData() {
    return optional(PostCustomersCustomerSubscriptionsRequestAddInvoiceItemsItemPriceDataSchema);
  },
