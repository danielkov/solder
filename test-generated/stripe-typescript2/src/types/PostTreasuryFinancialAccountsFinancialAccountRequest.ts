...
export const PostTreasuryFinancialAccountsFinancialAccountRequestSchema: TypedSchema<PostTreasuryFinancialAccountsFinancialAccountRequest> = typed<PostTreasuryFinancialAccountsFinancialAccountRequest>(object({
  ...
  get features() {
    return optional(PostTreasuryFinancialAccountsFinancialAccountRequestFeaturesSchema);
  },
  get forwardingSettings() {
    return optional(PostTreasuryFinancialAccountsFinancialAccountRequestForwardingSettingsSchema);
  },
  get metadata() {
    return optional(PostAccountsAccountBankAccountsRequestMetadataSchema);
  },
  get nickname() {
    return optional(PostTreasuryFinancialAccountsRequestNicknameSchema);
  },
  get platformRestrictions() {
    return optional(PostTreasuryFinancialAccountsRequestPlatformRestrictionsSchema);
  },
}));
