...
export const PostTestHelpersConfirmationTokensRequestInstallmentsSchema: TypedSchema<PostTestHelpersConfirmationTokensRequestInstallments> = typed<PostTestHelpersConfirmationTokensRequestInstallments>(object({ plan: PostInvoicesRequestCardObjectPlanObjectSchema }));
