...
export const QuoteSchema: TypedSchema<Quote> = typed<Quote>(object({
  ...
  get defaultTaxRates() {
    return optional(array(DefaultTaxRatesItemOrRefSchema));
  },
  ...
  get fromQuote() {
    return optional(QuotesResourceFromQuoteSchema);
  },
  header: optional(string()),
  id: string(),
  get invoice() {
    return optional(InvoiceUnionSchema);
  },
  ...
  get subscriptionSchedule() {
    return optional(SubscriptionScheduleOrRefSchema);
  },
  get testClock() {
  ...
  get transferData() {
    return optional(QuotesResourceTransferDataSchema);
  },
}));
