...
export const TreasuryOutboundPaymentsResourceAchTrackingDetailsSchema: TypedSchema<TreasuryOutboundPaymentsResourceAchTrackingDetails> = typed<TreasuryOutboundPaymentsResourceAchTrackingDetails>(object({ traceId: string() }));
