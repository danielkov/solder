...
export const PostTaxSettingsRequestHeadOfficeSchema: TypedSchema<PostTaxSettingsRequestHeadOffice> = typed<PostTaxSettingsRequestHeadOffice>(object({ address: PostTaxSettingsRequestAddressSchema }));
