...
export const SetupIntentPaymentMethodOptionsSchema: TypedSchema<SetupIntentPaymentMethodOptions> = typed<SetupIntentPaymentMethodOptions>(object({
  get acssDebit() {
    return optional(AcssDebitUnion2Schema);
  },
  get amazonPay() {
    return optional(AmazonPayUnion2Schema);
  },
  get bacsDebit() {
    return optional(BacsDebitUnion2Schema);
  },
  get card() {
    return optional(CardUnion2Schema);
  },
  get cardPresent() {
    return optional(CardPresentUnion2Schema);
  },
  get klarna() {
    return optional(KlarnaUnion2Schema);
  },
  get link() {
    return optional(LinkUnion2Schema);
  },
  get paypal() {
    return optional(PaypalUnion2Schema);
  },
  get sepaDebit() {
    return optional(SepaDebitUnion2Schema);
  },
  get usBankAccount() {
    return optional(UsBankAccountUnion2Schema);
  },
}));
