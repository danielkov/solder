...
export const PostIssuingCardsRequestSchema: TypedSchema<PostIssuingCardsRequest> = typed<PostIssuingCardsRequest>(object({
  ...
  get pin() {
    return optional(PostIssuingCardsRequestPinSchema);
  },
  replacementFor: optional(string()),
  replacementReason: optional(string()),
  get secondLine() {
    return optional(PostIssuingCardsRequestSecondLineSchema);
  },
  get shipping() {
    return optional(PostIssuingCardsRequestShippingSchema);
  },
  get spendingControls() {
    return optional(PostIssuingCardsRequestSpendingControlsSchema);
  },
