 ...
 * 
 */
export interface OutboundPaymentsPaymentMethodDetailsUsBankAccount {
  /**
...
export const OutboundPaymentsPaymentMethodDetailsUsBankAccountSchema: TypedSchema<OutboundPaymentsPaymentMethodDetailsUsBankAccount> = typed<OutboundPaymentsPaymentMethodDetailsUsBankAccount>(object({
