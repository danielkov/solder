...
export const TaxProductResourceTaxAssociationTransactionAttemptsResourceCommittedSchema: TypedSchema<TaxProductResourceTaxAssociationTransactionAttemptsResourceCommitted> = typed<TaxProductResourceTaxAssociationTransactionAttemptsResourceCommitted>(object({ transaction: string() }));
