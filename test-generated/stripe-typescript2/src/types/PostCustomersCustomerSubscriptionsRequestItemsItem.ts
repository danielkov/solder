 ...
 */
export interface PostCustomersCustomerSubscriptionsRequestItemsItem {
...
export const PostCustomersCustomerSubscriptionsRequestItemsItemSchema: TypedSchema<PostCustomersCustomerSubscriptionsRequestItemsItem> = typed<PostCustomersCustomerSubscriptionsRequestItemsItem>(object({
  get billingThresholds() {
    return optional(PostCustomersCustomerSubscriptionsRequestItemsItemBillingThresholdsSchema);
  },
  get discounts() {
  ...
  get priceData() {
    return optional(PostCustomersCustomerSubscriptionsRequestItemsItemPriceDataSchema);
  },
