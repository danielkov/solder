...
export const SetupAttemptPaymentMethodDetailsSchema: TypedSchema<SetupAttemptPaymentMethodDetails> = typed<SetupAttemptPaymentMethodDetails>(object({
  get acssDebit() {
    return optional(SetupAttemptPaymentMethodDetailsAcssDebitSchema);
  },
  get amazonPay() {
    return optional(SetupAttemptPaymentMethodDetailsAmazonPaySchema);
  },
  get auBecsDebit() {
    return optional(SetupAttemptPaymentMethodDetailsAuBecsDebitSchema);
  },
  get bacsDebit() {
    return optional(SetupAttemptPaymentMethodDetailsBacsDebitSchema);
  },
  get bancontact() {
    return optional(SetupAttemptPaymentMethodDetailsBancontactSchema);
  },
  get boleto() {
    return optional(SetupAttemptPaymentMethodDetailsBoletoSchema);
  },
  get card() {
    return optional(SetupAttemptPaymentMethodDetailsCardSchema);
  },
  get cardPresent() {
    return optional(SetupAttemptPaymentMethodDetailsCardPresentSchema);
  },
  get cashapp() {
    return optional(SetupAttemptPaymentMethodDetailsCashappSchema);
  },
  get ideal() {
    return optional(SetupAttemptPaymentMethodDetailsIdealSchema);
  },
  get kakaoPay() {
    return optional(SetupAttemptPaymentMethodDetailsKakaoPaySchema);
  },
  get klarna() {
    return optional(SetupAttemptPaymentMethodDetailsKlarnaSchema);
  },
  get krCard() {
    return optional(SetupAttemptPaymentMethodDetailsKrCardSchema);
  },
  get link() {
    return optional(SetupAttemptPaymentMethodDetailsLinkSchema);
  },
  get naverPay() {
    return optional(SetupAttemptPaymentMethodDetailsNaverPaySchema);
  },
  get nzBankAccount() {
    return optional(SetupAttemptPaymentMethodDetailsNzBankAccountSchema);
  },
  get paypal() {
    return optional(SetupAttemptPaymentMethodDetailsPaypalSchema);
  },
  get revolutPay() {
    return optional(SetupAttemptPaymentMethodDetailsRevolutPaySchema);
  },
  get sepaDebit() {
    return optional(SetupAttemptPaymentMethodDetailsSepaDebitSchema);
  },
  get sofort() {
    return optional(SetupAttemptPaymentMethodDetailsSofortSchema);
  },
  type: string(),
  get usBankAccount() {
    return optional(SetupAttemptPaymentMethodDetailsUsBankAccountSchema);
  },
}));
