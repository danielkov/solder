...
export const TerminalConfigurationSchema: TypedSchema<TerminalConfiguration> = typed<TerminalConfiguration>(object({
  get bbposWisepad3() {
    return optional(TerminalConfigurationConfigurationResourceDeviceTypeSpecificConfigSchema);
  },
  get bbposWiseposE() {
    return optional(TerminalConfigurationConfigurationResourceDeviceTypeSpecificConfigSchema);
  },
  ...
  object: string(),
  get offline() {
    return optional(TerminalConfigurationConfigurationResourceOfflineConfigSchema);
  },
  get rebootWindow() {
    return optional(TerminalConfigurationConfigurationResourceRebootWindowSchema);
  },
  get stripeS700() {
    return optional(TerminalConfigurationConfigurationResourceDeviceTypeSpecificConfigSchema);
  },
  get tipping() {
    return optional(TerminalConfigurationConfigurationResourceTippingSchema);
  },
  get verifoneP400() {
    return optional(TerminalConfigurationConfigurationResourceDeviceTypeSpecificConfigSchema);
  },
  get wifi() {
    return optional(TerminalConfigurationConfigurationResourceWifiConfigSchema);
  },
}));
