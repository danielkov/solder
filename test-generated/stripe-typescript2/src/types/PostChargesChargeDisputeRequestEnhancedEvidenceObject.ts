...
export const PostChargesChargeDisputeRequestEnhancedEvidenceObjectSchema: TypedSchema<PostChargesChargeDisputeRequestEnhancedEvidenceObject> = typed<PostChargesChargeDisputeRequestEnhancedEvidenceObject>(object({
  get visaCompellingEvidence3() {
    return optional(PostChargesChargeDisputeRequestEnhancedEvidenceObjectVisaCompellingEvidence3Schema);
  },
  get visaCompliance() {
    return optional(PostChargesChargeDisputeRequestEnhancedEvidenceObjectVisaComplianceSchema);
  },
}));
