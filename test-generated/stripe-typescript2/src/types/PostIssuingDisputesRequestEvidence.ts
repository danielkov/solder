...
export const PostIssuingDisputesRequestEvidenceSchema: TypedSchema<PostIssuingDisputesRequestEvidence> = typed<PostIssuingDisputesRequestEvidence>(object({
  get canceled() {
    return optional(PostIssuingDisputesRequestCanceledSchema);
  },
  get duplicate() {
    return optional(PostIssuingDisputesRequestDuplicateSchema);
  },
  get fraudulent() {
    return optional(PostIssuingDisputesRequestFraudulentSchema);
  },
  get merchandiseNotAsDescribed() {
    return optional(PostIssuingDisputesRequestMerchandiseNotAsDescribedSchema);
  },
  get noValidAuthorization() {
    return optional(PostIssuingDisputesRequestNoValidAuthorizationSchema);
  },
  get notReceived() {
    return optional(PostIssuingDisputesRequestNotReceivedSchema);
  },
  get other() {
    return optional(PostIssuingDisputesRequestOtherSchema);
  },
  reason: optional(string()),
  get serviceNotAsDescribed() {
    return optional(PostIssuingDisputesRequestServiceNotAsDescribedSchema);
  },
}));
