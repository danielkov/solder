...
export const RefundDestinationDetailsSchema: TypedSchema<RefundDestinationDetails> = typed<RefundDestinationDetails>(object({
  get affirm() {
    return optional(DestinationDetailsUnimplementedSchema);
  },
  ...
  get blik() {
    return optional(RefundDestinationDetailsBlikSchema);
  },
  get brBankTransfer() {
    return optional(RefundDestinationDetailsBrBankTransferSchema);
  },
  get card() {
    return optional(RefundDestinationDetailsCardSchema);
  },
  get cashapp() {
    return optional(DestinationDetailsUnimplementedSchema);
  },
  get crypto() {
    return optional(RefundDestinationDetailsCryptoSchema);
  },
  ...
  get euBankTransfer() {
    return optional(RefundDestinationDetailsEuBankTransferSchema);
  },
  get gbBankTransfer() {
    return optional(RefundDestinationDetailsGbBankTransferSchema);
  },
  get giropay() {
    return optional(DestinationDetailsUnimplementedSchema);
  },
  ...
  get jpBankTransfer() {
    return optional(RefundDestinationDetailsJpBankTransferSchema);
  },
  get klarna() {
    return optional(DestinationDetailsUnimplementedSchema);
  },
  get mbWay() {
    return optional(RefundDestinationDetailsMbWaySchema);
  },
  get multibanco() {
    return optional(RefundDestinationDetailsMultibancoSchema);
  },
  get mxBankTransfer() {
    return optional(RefundDestinationDetailsMxBankTransferSchema);
  },
  get nzBankTransfer() {
    return optional(DestinationDetailsUnimplementedSchema);
  },
  get p24() {
    return optional(RefundDestinationDetailsP24Schema);
  },
  get paynow() {
    return optional(DestinationDetailsUnimplementedSchema);
  },
  get paypal() {
    return optional(RefundDestinationDetailsPaypalSchema);
  },
  get pix() {
    return optional(DestinationDetailsUnimplementedSchema);
  },
  ...
  get swish() {
    return optional(RefundDestinationDetailsSwishSchema);
  },
  get thBankTransfer() {
    return optional(RefundDestinationDetailsThBankTransferSchema);
  },
  get twint() {
    return optional(DestinationDetailsUnimplementedSchema);
  },
  type: string(),
  get usBankTransfer() {
    return optional(RefundDestinationDetailsUsBankTransferSchema);
  },
  get wechatPay() {
    return optional(DestinationDetailsUnimplementedSchema);
  },
