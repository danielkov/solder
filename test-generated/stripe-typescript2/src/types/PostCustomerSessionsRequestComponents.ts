...
export const PostCustomerSessionsRequestComponentsSchema: TypedSchema<PostCustomerSessionsRequestComponents> = typed<PostCustomerSessionsRequestComponents>(object({
  get buyButton() {
    return optional(PostCustomerSessionsRequestBuyButtonSchema);
  },
  get customerSheet() {
    return optional(PostCustomerSessionsRequestCustomerSheetSchema);
  },
  get mobilePaymentElement() {
    return optional(PostCustomerSessionsRequestMobilePaymentElementSchema);
  },
  get paymentElement() {
    return optional(PostCustomerSessionsRequestPaymentElementSchema);
  },
  get pricingTable() {
    return optional(PostCustomerSessionsRequestPricingTableSchema);
  },
}));
