...
export const PostProductsIdRequestSchema: TypedSchema<PostProductsIdRequest> = typed<PostProductsIdRequest>(object({
  ...
  get description() {
    return optional(PostProductsIdRequestDescriptionSchema);
  },
  expand: optional(array(string())),
  get images() {
    return optional(PostProductsIdRequestImagesSchema);
  },
  get marketingFeatures() {
    return optional(PostProductsIdRequestMarketingFeaturesSchema);
  },
  get metadata() {
  ...
  get packageDimensions() {
    return optional(PostProductsIdRequestPackageDimensionsSchema);
  },
  shippable: optional(boolean()),
  statementDescriptor: optional(string()),
  get taxCode() {
    return optional(PostInvoiceitemsRequestTaxCodeSchema);
  },
  get unitLabel() {
    return optional(PostProductsIdRequestUnitLabelSchema);
  },
  get url() {
    return optional(PostProductsIdRequestUrlSchema);
  },
}));
