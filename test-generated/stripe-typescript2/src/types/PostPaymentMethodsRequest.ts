import { array, object, optional, string, typed, unknown } from '@speakeasy-api/tonic';
...
export const PostPaymentMethodsRequestSchema: TypedSchema<PostPaymentMethodsRequest> = typed<PostPaymentMethodsRequest>(object({
  get acssDebit() {
    return optional(PostPaymentMethodsRequestAcssDebitSchema);
  },
  ...
  get auBecsDebit() {
    return optional(PostPaymentMethodsRequestAuBecsDebitSchema);
  },
  get bacsDebit() {
    return optional(PostPaymentMethodsRequestBacsDebitSchema);
  },
  bancontact: optional(unknown()),
  billie: optional(unknown()),
  get billingDetails() {
    return optional(PostPaymentMethodsRequestBillingDetailsSchema);
  },
  blik: optional(unknown()),
  get boleto() {
    return optional(PostPaymentMethodsRequestBoletoSchema);
  },
  get card() {
    return optional(PostPaymentMethodsRequestCardSchema);
  },
  cashapp: optional(unknown()),
  crypto: optional(unknown()),
  get custom() {
    return optional(PostPaymentMethodsRequestCustomSchema);
  },
  customer: optional(string()),
  customerBalance: optional(unknown()),
  get eps() {
    return optional(PostPaymentMethodsRequestEpsSchema);
  },
  expand: optional(array(string())),
  get fpx() {
    return optional(PostPaymentMethodsRequestFpxSchema);
  },
  giropay: optional(unknown()),
  grabpay: optional(unknown()),
  get ideal() {
    return optional(PostPaymentMethodsRequestIdealSchema);
  },
  interacPresent: optional(unknown()),
  kakaoPay: optional(unknown()),
  get klarna() {
    return optional(PostPaymentMethodsRequestKlarnaSchema);
  },
  ...
  get naverPay() {
    return optional(PostPaymentMethodsRequestNaverPaySchema);
  },
  get nzBankAccount() {
    return optional(PostPaymentMethodsRequestNzBankAccountSchema);
  },
  oxxo: optional(unknown()),
  get p24() {
    return optional(PostPaymentMethodsRequestP24Schema);
  },
  ...
  get radarOptions() {
    return optional(PostChargesRequestRadarOptionsSchema);
  },
  revolutPay: optional(unknown()),
  samsungPay: optional(unknown()),
  satispay: optional(unknown()),
  get sepaDebit() {
    return optional(PostPaymentMethodsRequestSepaDebitSchema);
  },
  get sofort() {
    return optional(PostPaymentMethodsRequestSofortSchema);
  },
  swish: optional(unknown()),
  twint: optional(unknown()),
  type: optional(string()),
  get usBankAccount() {
    return optional(PostPaymentMethodsRequestUsBankAccountSchema);
  },
