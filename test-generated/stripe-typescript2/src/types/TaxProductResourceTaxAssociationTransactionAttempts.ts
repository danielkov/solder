...
export const TaxProductResourceTaxAssociationTransactionAttemptsSchema: TypedSchema<TaxProductResourceTaxAssociationTransactionAttempts> = typed<TaxProductResourceTaxAssociationTransactionAttempts>(object({
  get committed() {
    return optional(TaxProductResourceTaxAssociationTransactionAttemptsResourceCommittedSchema);
  },
  get errored() {
    return optional(TaxProductResourceTaxAssociationTransactionAttemptsResourceErroredSchema);
  },
  source: string(),
  status: string(),
}));
