 ...
 * 
 */
export interface CreditNotesPretaxCreditAmount {
  /**
...
export const CreditNotesPretaxCreditAmountSchema: TypedSchema<CreditNotesPretaxCreditAmount> = typed<CreditNotesPretaxCreditAmount>(object({
  amount: number(),
  get creditBalanceTransaction() {
    return optional(CreditBalanceTransactionOrRefSchema);
  },
  get discount() {
    return optional(DiscountUnionSchema);
  },
  type: string(),
}));
