...
export const PostSubscriptionSchedulesRequestSchema: TypedSchema<PostSubscriptionSchedulesRequest> = typed<PostSubscriptionSchedulesRequest>(object({
  ...
  get defaultSettings() {
    return optional(PostSubscriptionSchedulesRequestDefaultSettingsSchema);
  },
  ...
  get phases() {
    return optional(array(PostSubscriptionSchedulesRequestPhasesItemSchema));
  },
  get startDate() {
    return optional(PostSubscriptionSchedulesRequestStartDateSchema);
  },
}));
