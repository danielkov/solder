...
export const PostInvoicesCreatePreviewRequestCustomerDetailsSchema: TypedSchema<PostInvoicesCreatePreviewRequestCustomerDetails> = typed<PostInvoicesCreatePreviewRequestCustomerDetails>(object({
  get address() {
    return optional(PostInvoicesCreatePreviewRequestAddressSchema);
  },
  get shipping() {
    return optional(PostInvoicesCreatePreviewRequestShippingSchema);
  },
  get tax() {
    return optional(PostInvoicesCreatePreviewRequestTaxSchema);
  },
