...
export const TreasuryOutboundPaymentsResourceReturnedStatusSchema: TypedSchema<TreasuryOutboundPaymentsResourceReturnedStatus> = typed<TreasuryOutboundPaymentsResourceReturnedStatus>(object({ code: string(), transaction: TransactionOrRef2Schema }));
