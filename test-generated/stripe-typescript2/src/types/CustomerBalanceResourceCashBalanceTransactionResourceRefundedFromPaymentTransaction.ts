...
export const CustomerBalanceResourceCashBalanceTransactionResourceRefundedFromPaymentTransactionSchema: TypedSchema<CustomerBalanceResourceCashBalanceTransactionResourceRefundedFromPaymentTransaction> = typed<CustomerBalanceResourceCashBalanceTransactionResourceRefundedFromPaymentTransaction>(object({ refund: RefundOrRefSchema }));
