...
export const PostInvoiceitemsInvoiceitemRequestSchema: TypedSchema<PostInvoiceitemsInvoiceitemRequest> = typed<PostInvoiceitemsInvoiceitemRequest>(object({
  ...
  get discounts() {
    return optional(PostInvoiceitemsInvoiceitemRequestDiscountsSchema);
  },
  ...
  get priceData() {
    return optional(PostInvoiceitemsRequestPriceDataSchema);
  },
  get pricing() {
  ...
  get taxRates() {
    return optional(PostInvoiceitemsInvoiceitemRequestTaxRatesSchema);
  },
