...
export const GelatoDocumentReportSchema: TypedSchema<GelatoDocumentReport> = typed<GelatoDocumentReport>(object({
  ...
  get dob() {
    return optional(GelatoDataDocumentReportDateOfBirthSchema);
  },
  get error() {
    return optional(GelatoDocumentReportErrorSchema);
  },
  get expirationDate() {
    return optional(GelatoDataDocumentReportExpirationDateSchema);
  },
  files: optional(array(string())),
  firstName: optional(string()),
  get issuedDate() {
    return optional(GelatoDataDocumentReportIssuedDateSchema);
  },
