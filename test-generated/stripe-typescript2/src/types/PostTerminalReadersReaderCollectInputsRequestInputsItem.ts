...
export const PostTerminalReadersReaderCollectInputsRequestInputsItemSchema: TypedSchema<PostTerminalReadersReaderCollectInputsRequestInputsItem> = typed<PostTerminalReadersReaderCollectInputsRequestInputsItem>(object({
  ...
  get selection() {
    return optional(PostTerminalReadersReaderCollectInputsRequestInputsItemSelectionSchema);
  },
  get toggles() {
    return optional(array(PostTerminalReadersReaderCollectInputsRequestInputsItemTogglesItemSchema));
  },
  type: string(),
}));
