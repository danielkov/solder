 ...
 */
export interface PostPaymentIntentsRequestAmountDetails {
...
export const PostPaymentIntentsRequestAmountDetailsSchema: TypedSchema<PostPaymentIntentsRequestAmountDetails> = typed<PostPaymentIntentsRequestAmountDetails>(object({
  get discountAmount() {
    return optional(PostBalanceSettingsRequestDelayDaysOverrideSchema);
  },
  get lineItems() {
    return optional(PostPaymentIntentsRequestLineItemsSchema);
  },
  get shipping() {
    return optional(PostPaymentIntentsRequestShippingSchema);
  },
  get tax() {
    return optional(PostPaymentIntentsRequestTaxSchema);
  },
}));
