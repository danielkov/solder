...
export const PostInvoicesInvoiceLinesLineItemIdRequestSchema: TypedSchema<PostInvoicesInvoiceLinesLineItemIdRequest> = typed<PostInvoicesInvoiceLinesLineItemIdRequest>(object({
  ...
  get discounts() {
    return optional(PostInvoicesInvoiceLinesLineItemIdRequestDiscountsSchema);
  },
  expand: optional(array(string())),
  get metadata() {
    return optional(PostInvoicesInvoiceLinesLineItemIdRequestMetadataSchema);
  },
  get period() {
    return optional(PostInvoiceitemsRequestPeriodSchema);
  },
  get priceData() {
    return optional(PostInvoicesInvoiceLinesLineItemIdRequestPriceDataSchema);
  },
  get pricing() {
    return optional(PostInvoiceitemsRequestPricingSchema);
  },
  quantity: optional(number()),
  get taxAmounts() {
    return optional(PostInvoicesInvoiceLinesLineItemIdRequestTaxAmountsSchema);
  },
  get taxRates() {
    return optional(PostInvoicesInvoiceLinesLineItemIdRequestTaxRatesSchema);
  },
}));
