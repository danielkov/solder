...
export const PaymentIntentPaymentMethodOptionsUsBankAccountSchema: TypedSchema<PaymentIntentPaymentMethodOptionsUsBankAccount> = typed<PaymentIntentPaymentMethodOptionsUsBankAccount>(object({
  get financialConnections() {
    return optional(LinkedAccountOptionsCommonSchema);
  },
  get mandateOptions() {
    return optional(PaymentMethodOptionsUsBankAccountMandateOptionsSchema);
  },
