...
export const TaxProductResourceShipFromDetailsSchema: TypedSchema<TaxProductResourceShipFromDetails> = typed<TaxProductResourceShipFromDetails>(object({ address: TaxProductResourcePostalAddressSchema }));
