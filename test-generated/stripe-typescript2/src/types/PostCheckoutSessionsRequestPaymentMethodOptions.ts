import { object, optional, typed, unknown } from '@speakeasy-api/tonic';
...
export const PostCheckoutSessionsRequestPaymentMethodOptionsSchema: TypedSchema<PostCheckoutSessionsRequestPaymentMethodOptions> = typed<PostCheckoutSessionsRequestPaymentMethodOptions>(object({
  get acssDebit() {
    return optional(PostCheckoutSessionsRequestAcssDebitSchema);
  },
  get affirm() {
    return optional(PostCheckoutSessionsRequestAffirmSchema);
  },
  get afterpayClearpay() {
    return optional(PostCheckoutSessionsRequestAffirmSchema);
  },
  get alipay() {
    return optional(PostCheckoutSessionsRequestAlipaySchema);
  },
  get alma() {
    return optional(PostCheckoutSessionsRequestAlmaSchema);
  },
  get amazonPay() {
    return optional(PostCheckoutSessionsRequestAmazonPaySchema);
  },
  get auBecsDebit() {
    return optional(PostCheckoutSessionsRequestAuBecsDebitSchema);
  },
  get bacsDebit() {
    return optional(PostCheckoutSessionsRequestBacsDebitSchema);
  },
  get bancontact() {
    return optional(PostCheckoutSessionsRequestBancontactSchema);
  },
  get billie() {
    return optional(PostCheckoutSessionsRequestAlmaSchema);
  },
  get boleto() {
    return optional(PostCheckoutSessionsRequestBoletoSchema);
  },
  get card() {
    return optional(PostCheckoutSessionsRequestCardSchema);
  },
  get cashapp() {
    return optional(PostCheckoutSessionsRequestCashappSchema);
  },
  get customerBalance() {
    return optional(PostCheckoutSessionsRequestCustomerBalanceSchema);
  },
  get demoPay() {
    return optional(PostCheckoutSessionsRequestDemoPaySchema);
  },
  get eps() {
    return optional(PostCheckoutSessionsRequestBancontactSchema);
  },
  ...
  get klarna() {
    return optional(PostCheckoutSessionsRequestKlarnaSchema);
  },
  get konbini() {
    return optional(PostCheckoutSessionsRequestKonbiniSchema);
  },
  get krCard() {
    return optional(PostCheckoutSessionsRequestAmazonPaySchema);
  },
  ...
  get p24() {
    return optional(PostCheckoutSessionsRequestP24Schema);
  },
  ...
  get paypal() {
    return optional(PostCheckoutSessionsRequestPaypalSchema);
  },
  get pix() {
    return optional(PostCheckoutSessionsRequestPixSchema);
  },
  get revolutPay() {
    return optional(PostCheckoutSessionsRequestAmazonPaySchema);
  },
  ...
  get swish() {
    return optional(PostCheckoutSessionsRequestSwishSchema);
  },
  get twint() {
    return optional(PostCheckoutSessionsRequestAlipaySchema);
  },
  get usBankAccount() {
    return optional(PostCheckoutSessionsRequestUsBankAccountSchema);
  },
  get wechatPay() {
    return optional(PostCheckoutSessionsRequestWechatPaySchema);
  },
}));
