...
export const CheckoutSessionSchema: TypedSchema<CheckoutSession> = typed<CheckoutSession>(object({
  get adaptivePricing() {
    return optional(PaymentPagesCheckoutSessionAdaptivePricingSchema);
  },
  get afterExpiration() {
    return optional(PaymentPagesCheckoutSessionAfterExpirationSchema);
  },
  ...
  get brandingSettings() {
    return optional(PaymentPagesCheckoutSessionBrandingSettingsSchema);
  },
  cancelUrl: optional(string()),
  clientReferenceId: optional(string()),
  clientSecret: optional(string()),
  get collectedInformation() {
    return optional(PaymentPagesCheckoutSessionCollectedInformationSchema);
  },
  get consent() {
    return optional(PaymentPagesCheckoutSessionConsentSchema);
  },
  get consentCollection() {
    return optional(PaymentPagesCheckoutSessionConsentCollectionSchema);
  },
  created: number(),
  currency: optional(string()),
  get currencyConversion() {
    return optional(PaymentPagesCheckoutSessionCurrencyConversionSchema);
  },
  customFields: array(PaymentPagesCheckoutSessionCustomFieldsSchema),
  customText: PaymentPagesCheckoutSessionCustomTextSchema,
  get customer() {
    return optional(CustomerUnionSchema);
  },
  customerCreation: optional(string()),
  get customerDetails() {
    return optional(PaymentPagesCheckoutSessionCustomerDetailsSchema);
  },
  customerEmail: optional(string()),
  get discounts() {
    return optional(array(PaymentPagesCheckoutSessionDiscountSchema));
  },
  excludedPaymentMethodTypes: optional(array(string())),
  expiresAt: number(),
  id: string(),
  get invoice() {
    return optional(InvoiceOrRefSchema);
  },
  get invoiceCreation() {
    return optional(PaymentPagesCheckoutSessionInvoiceCreationSchema);
  },
  get lineItems() {
    return optional(LineItemsPropertySchema);
  },
  livemode: boolean(),
  ...
  mode: string(),
  get nameCollection() {
    return optional(PaymentPagesCheckoutSessionNameCollectionSchema);
  },
  object: string(),
  get optionalItems() {
    return optional(array(PaymentPagesCheckoutSessionOptionalItemSchema));
  },
  originContext: optional(string()),
  get paymentIntent() {
    return optional(PaymentIntentOrRefSchema);
  },
  get paymentLink() {
    return optional(PaymentLinkOrRefSchema);
  },
  paymentMethodCollection: optional(string()),
  get paymentMethodConfigurationDetails() {
    return optional(PaymentMethodConfigBizPaymentMethodConfigurationDetailsSchema);
  },
  get paymentMethodOptions() {
    return optional(CheckoutSessionPaymentMethodOptionsSchema);
  },
  paymentMethodTypes: array(string()),
  paymentStatus: string(),
  get permissions() {
    return optional(PaymentPagesCheckoutSessionPermissionsSchema);
  },
  get phoneNumberCollection() {
    return optional(PaymentPagesCheckoutSessionPhoneNumberCollectionSchema);
  },
  get presentmentDetails() {
    return optional(PaymentFlowsPaymentIntentPresentmentDetailsSchema);
  },
  recoveredFrom: optional(string()),
  redirectOnCompletion: optional(string()),
  returnUrl: optional(string()),
  get savedPaymentMethodOptions() {
    return optional(PaymentPagesCheckoutSessionSavedPaymentMethodOptionsSchema);
  },
  get setupIntent() {
    return optional(SetupIntentOrRefSchema);
  },
  get shippingAddressCollection() {
    return optional(PaymentPagesCheckoutSessionShippingAddressCollectionSchema);
  },
  get shippingCost() {
    return optional(PaymentPagesCheckoutSessionShippingCostSchema);
  },
  shippingOptions: array(PaymentPagesCheckoutSessionShippingOptionSchema),
  status: optional(string()),
  submitType: optional(string()),
  get subscription() {
    return optional(SubscriptionOrRefSchema);
  },
  successUrl: optional(string()),
  get taxIdCollection() {
    return optional(PaymentPagesCheckoutSessionTaxIdCollectionSchema);
  },
  get totalDetails() {
    return optional(PaymentPagesCheckoutSessionTotalDetailsSchema);
  },
  uiMode: optional(string()),
  url: optional(string()),
  get walletOptions() {
    return optional(CheckoutSessionWalletOptionsSchema);
  },
}));
