import { boolean, number, object, optional, string, typed } from '@speakeasy-api/tonic';
...
export const PaymentMethodSchema: TypedSchema<PaymentMethod> = typed<PaymentMethod>(object({
  get acssDebit() {
    return optional(PaymentMethodAcssDebitSchema);
  },
  get affirm() {
    return optional(PaymentMethodAffirmSchema);
  },
  get afterpayClearpay() {
    return optional(PaymentMethodAfterpayClearpaySchema);
  },
  get alipay() {
    return optional(PaymentFlowsPrivatePaymentMethodsAlipaySchema);
  },
  allowRedisplay: optional(string()),
  get alma() {
    return optional(PaymentMethodAlmaSchema);
  },
  get amazonPay() {
    return optional(PaymentMethodAmazonPaySchema);
  },
  get auBecsDebit() {
    return optional(PaymentMethodAuBecsDebitSchema);
  },
  get bacsDebit() {
    return optional(PaymentMethodBacsDebitSchema);
  },
  get bancontact() {
    return optional(PaymentMethodBancontactSchema);
  },
  get billie() {
    return optional(PaymentMethodBillieSchema);
  },
  billingDetails: BillingDetailsSchema,
  get blik() {
    return optional(PaymentMethodBlikSchema);
  },
  get boleto() {
    return optional(PaymentMethodBoletoSchema);
  },
  get card() {
    return optional(PaymentMethodCardSchema);
  },
  get cardPresent() {
    return optional(PaymentMethodCardPresentSchema);
  },
  get cashapp() {
    return optional(PaymentMethodCashappSchema);
  },
  created: number(),
  get crypto() {
    return optional(PaymentMethodCryptoSchema);
  },
  get custom() {
    return optional(PaymentMethodCustomSchema);
  },
  get customer() {
    return optional(CustomerOrRefSchema);
  },
  get customerBalance() {
    return optional(PaymentMethodCustomerBalanceSchema);
  },
  get eps() {
    return optional(PaymentMethodEpsSchema);
  },
  get fpx() {
    return optional(PaymentMethodFpxSchema);
  },
  get giropay() {
    return optional(PaymentMethodGiropaySchema);
  },
  get grabpay() {
    return optional(PaymentMethodGrabpaySchema);
  },
  id: string(),
  get ideal() {
    return optional(PaymentMethodIdealSchema);
  },
  get interacPresent() {
    return optional(PaymentMethodInteracPresentSchema);
  },
  get kakaoPay() {
    return optional(PaymentMethodKakaoPaySchema);
  },
  get klarna() {
    return optional(PaymentMethodKlarnaSchema);
  },
  get konbini() {
    return optional(PaymentMethodKonbiniSchema);
  },
  get krCard() {
    return optional(PaymentMethodKrCardSchema);
  },
  get link() {
    return optional(PaymentMethodLinkSchema);
  },
  livemode: boolean(),
  get mbWay() {
    return optional(PaymentMethodMbWaySchema);
  },
  get metadata() {
    return optional(MetadataPropertySchema);
  },
  get mobilepay() {
    return optional(PaymentMethodMobilepaySchema);
  },
  get multibanco() {
    return optional(PaymentMethodMultibancoSchema);
  },
  get naverPay() {
    return optional(PaymentMethodNaverPaySchema);
  },
  get nzBankAccount() {
    return optional(PaymentMethodNzBankAccountSchema);
  },
  object: string(),
  get oxxo() {
    return optional(PaymentMethodOxxoSchema);
  },
  get p24() {
    return optional(PaymentMethodP24Schema);
  },
  get payByBank() {
    return optional(PaymentMethodPayByBankSchema);
  },
  get payco() {
    return optional(PaymentMethodPaycoSchema);
  },
  get paynow() {
    return optional(PaymentMethodPaynowSchema);
  },
  get paypal() {
    return optional(PaymentMethodPaypalSchema);
  },
  get pix() {
    return optional(PaymentMethodPixSchema);
  },
  get promptpay() {
    return optional(PaymentMethodPromptpaySchema);
  },
  get radarOptions() {
    return optional(RadarRadarOptionsSchema);
  },
  get revolutPay() {
    return optional(PaymentMethodRevolutPaySchema);
  },
  get samsungPay() {
    return optional(PaymentMethodSamsungPaySchema);
  },
  get satispay() {
    return optional(PaymentMethodSatispaySchema);
  },
  get sepaDebit() {
    return optional(PaymentMethodSepaDebitSchema);
  },
  get sofort() {
    return optional(PaymentMethodSofortSchema);
  },
  get swish() {
    return optional(PaymentMethodSwishSchema);
  },
  get twint() {
    return optional(PaymentMethodTwintSchema);
  },
  type: string(),
  get usBankAccount() {
    return optional(PaymentMethodUsBankAccountSchema);
  },
  get wechatPay() {
    return optional(PaymentMethodWechatPaySchema);
  },
  get zip() {
    return optional(PaymentMethodZipSchema);
  },
}));
