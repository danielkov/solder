...
export const IssuingTransactionFleetReportedBreakdownSchema: TypedSchema<IssuingTransactionFleetReportedBreakdown> = typed<IssuingTransactionFleetReportedBreakdown>(object({
  get fuel() {
    return optional(IssuingTransactionFleetFuelPriceDataSchema);
  },
  get nonFuel() {
    return optional(IssuingTransactionFleetNonFuelPriceDataSchema);
  },
  get tax() {
    return optional(IssuingTransactionFleetTaxDataSchema);
  },
}));
