...
export const PostTreasuryFinancialAccountsFinancialAccountFeaturesRequestSchema: TypedSchema<PostTreasuryFinancialAccountsFinancialAccountFeaturesRequest> = typed<PostTreasuryFinancialAccountsFinancialAccountFeaturesRequest>(object({
  get cardIssuing() {
    return optional(PostTreasuryFinancialAccountsFinancialAccountFeaturesRequestCardIssuingSchema);
  },
  get depositInsurance() {
    return optional(PostTreasuryFinancialAccountsFinancialAccountFeaturesRequestDepositInsuranceSchema);
  },
  expand: optional(array(string())),
  get financialAddresses() {
    return optional(PostTreasuryFinancialAccountsFinancialAccountFeaturesRequestFinancialAddressesSchema);
  },
  get inboundTransfers() {
    return optional(PostTreasuryFinancialAccountsFinancialAccountFeaturesRequestInboundTransfersSchema);
  },
  get intraStripeFlows() {
    return optional(PostTreasuryFinancialAccountsFinancialAccountFeaturesRequestIntraStripeFlowsSchema);
  },
  get outboundPayments() {
    return optional(PostTreasuryFinancialAccountsFinancialAccountFeaturesRequestOutboundPaymentsSchema);
  },
  get outboundTransfers() {
    return optional(PostTreasuryFinancialAccountsFinancialAccountFeaturesRequestOutboundTransfersSchema);
  },
}));
