...
export const BankConnectionsResourceBalanceSchema: TypedSchema<BankConnectionsResourceBalance> = typed<BankConnectionsResourceBalance>(object({
  asOf: number(),
  get cash() {
    return optional(BankConnectionsResourceBalanceApiResourceCashBalanceSchema);
  },
  get credit() {
    return optional(BankConnectionsResourceBalanceApiResourceCreditBalanceSchema);
  },
