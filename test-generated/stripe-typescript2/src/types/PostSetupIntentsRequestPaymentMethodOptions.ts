...
export const PostSetupIntentsRequestPaymentMethodOptionsSchema: TypedSchema<PostSetupIntentsRequestPaymentMethodOptions> = typed<PostSetupIntentsRequestPaymentMethodOptions>(object({
  get acssDebit() {
    return optional(PostSetupIntentsRequestAcssDebitSchema);
  },
  amazonPay: optional(unknown()),
  get bacsDebit() {
    return optional(PostSetupIntentsRequestBacsDebitSchema);
  },
  get card() {
    return optional(PostSetupIntentsRequestCardSchema);
  },
  cardPresent: optional(unknown()),
  get klarna() {
    return optional(PostSetupIntentsRequestKlarnaSchema);
  },
  link: optional(unknown()),
  get paypal() {
    return optional(PostSetupIntentsRequestPaypalSchema);
  },
  get sepaDebit() {
    return optional(PostSetupIntentsRequestBacsDebitSchema);
  },
  get usBankAccount() {
    return optional(PostSetupIntentsRequestUsBankAccountSchema);
  },
}));
