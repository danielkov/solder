...
export const PaymentFlowsAmountDetailsSchema: TypedSchema<PaymentFlowsAmountDetails> = typed<PaymentFlowsAmountDetails>(object({
  ...
  get lineItems() {
    return optional(LineItemsProperty2Schema);
  },
  get shipping() {
    return optional(PaymentFlowsAmountDetailsResourceShippingSchema);
  },
  get tax() {
    return optional(PaymentFlowsAmountDetailsResourceTaxSchema);
  },
  get tip() {
    return optional(PaymentFlowsAmountDetailsClientResourceTipSchema);
  },
}));
