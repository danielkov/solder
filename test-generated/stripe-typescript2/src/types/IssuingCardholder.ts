...
export const IssuingCardholderSchema: TypedSchema<IssuingCardholder> = typed<IssuingCardholder>(object({
  ...
  get company() {
    return optional(IssuingCardholderCompanySchema);
  },
  created: number(),
  email: optional(string()),
  id: string(),
  get individual() {
    return optional(IssuingCardholderIndividualSchema);
  },
  livemode: boolean(),
  ...
  get spendingControls() {
    return optional(IssuingCardholderAuthorizationControlsSchema);
  },
  status: string(),
  type: string(),
}));
