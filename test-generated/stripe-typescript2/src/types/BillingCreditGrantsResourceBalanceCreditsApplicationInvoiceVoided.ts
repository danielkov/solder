...
export const BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedSchema: TypedSchema<BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoided> = typed<BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoided>(object({ invoice: InvoiceOrRefSchema, invoiceLineItem: string() }));
