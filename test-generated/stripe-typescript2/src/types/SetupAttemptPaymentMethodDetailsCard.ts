...
export const SetupAttemptPaymentMethodDetailsCardSchema: TypedSchema<SetupAttemptPaymentMethodDetailsCard> = typed<SetupAttemptPaymentMethodDetailsCard>(object({
  ...
  get checks() {
    return optional(SetupAttemptPaymentMethodDetailsCardChecksSchema);
  },
  ...
  get threeDSecure() {
    return optional(ThreeDSecureDetailsSchema);
  },
  get wallet() {
    return optional(SetupAttemptPaymentMethodDetailsCardWalletSchema);
  },
}));
