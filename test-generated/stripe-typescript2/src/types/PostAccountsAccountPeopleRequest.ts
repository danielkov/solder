...
export const PostAccountsAccountPeopleRequestSchema: TypedSchema<PostAccountsAccountPeopleRequest> = typed<PostAccountsAccountPeopleRequest>(object({
  get additionalTosAcceptances() {
    return optional(PostAccountsAccountPeopleRequestAdditionalTosAcceptancesSchema);
  },
  get address() {
    return optional(PostAccountsAccountPeopleRequestAddressSchema);
  },
  get addressKana() {
    return optional(PostAccountsAccountPeopleRequestAddressKanaSchema);
  },
  get addressKanji() {
    return optional(PostAccountsAccountPeopleRequestAddressKanjiSchema);
  },
  get dob() {
    return optional(PostAccountsAccountPeopleRequestDobSchema);
  },
  get documents() {
    return optional(PostAccountsAccountPeopleRequestDocumentsSchema);
  },
  ...
  get fullNameAliases() {
    return optional(PostAccountsAccountPeopleRequestFullNameAliasesSchema);
  },
  ...
  get registeredAddress() {
    return optional(PostAccountsAccountPeopleRequestRegisteredAddressSchema);
  },
  get relationship() {
    return optional(PostAccountsAccountPeopleRequestRelationshipSchema);
  },
  ssnLast4: optional(string()),
  get usCfpbData() {
    return optional(PostAccountsAccountPeopleRequestUsCfpbDataSchema);
  },
  get verification() {
    return optional(PostAccountsAccountPeopleRequestVerificationSchema);
  },
}));
