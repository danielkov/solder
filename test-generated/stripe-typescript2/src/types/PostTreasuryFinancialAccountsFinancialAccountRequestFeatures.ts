...
export const PostTreasuryFinancialAccountsFinancialAccountRequestFeaturesSchema: TypedSchema<PostTreasuryFinancialAccountsFinancialAccountRequestFeatures> = typed<PostTreasuryFinancialAccountsFinancialAccountRequestFeatures>(object({
  get cardIssuing() {
    return optional(PostTreasuryFinancialAccountsRequestCardIssuingSchema);
  },
  get depositInsurance() {
    return optional(PostTreasuryFinancialAccountsRequestCardIssuingSchema);
  },
  get financialAddresses() {
    return optional(PostTreasuryFinancialAccountsRequestFinancialAddressesSchema);
  },
  get inboundTransfers() {
    return optional(PostTreasuryFinancialAccountsRequestInboundTransfersSchema);
  },
  get intraStripeFlows() {
    return optional(PostTreasuryFinancialAccountsRequestCardIssuingSchema);
  },
  get outboundPayments() {
    return optional(PostTreasuryFinancialAccountsRequestOutboundPaymentsSchema);
  },
  get outboundTransfers() {
    return optional(PostTreasuryFinancialAccountsRequestOutboundTransfersSchema);
  },
}));
