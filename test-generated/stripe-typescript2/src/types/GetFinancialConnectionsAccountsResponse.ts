...
export const GetFinancialConnectionsAccountsResponseSchema: TypedSchema<GetFinancialConnectionsAccountsResponse> = typed<GetFinancialConnectionsAccountsResponse>(object({
