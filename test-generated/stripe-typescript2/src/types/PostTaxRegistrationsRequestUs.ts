...
export const PostTaxRegistrationsRequestUsSchema: TypedSchema<PostTaxRegistrationsRequestUs> = typed<PostTaxRegistrationsRequestUs>(object({
  get localAmusementTax() {
    return optional(PostTaxRegistrationsRequestLocalAmusementTaxSchema);
  },
  get localLeaseTax() {
    return optional(PostTaxRegistrationsRequestLocalLeaseTaxSchema);
  },
  state: string(),
  get stateSalesTax() {
    return optional(PostTaxRegistrationsRequestStateSalesTaxSchema);
  },
  type: string(),
}));
