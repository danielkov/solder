...
export const PostTaxCalculationsRequestShipFromDetailsSchema: TypedSchema<PostTaxCalculationsRequestShipFromDetails> = typed<PostTaxCalculationsRequestShipFromDetails>(object({ address: DefaultPostTaxCalculationsRequestAddressSchema }));
