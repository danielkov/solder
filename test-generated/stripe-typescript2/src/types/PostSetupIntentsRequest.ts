...
export const PostSetupIntentsRequestSchema: TypedSchema<PostSetupIntentsRequest> = typed<PostSetupIntentsRequest>(object({
  ...
  get automaticPaymentMethods() {
    return optional(PostSetupIntentsRequestAutomaticPaymentMethodsSchema);
  },
  ...
  get mandateData() {
    return optional(PostSetupIntentsRequestMandateDataSchema);
  },
  get metadata() {
  ...
  get paymentMethodData() {
    return optional(PostSetupIntentsRequestPaymentMethodDataSchema);
  },
  get paymentMethodOptions() {
    return optional(PostSetupIntentsRequestPaymentMethodOptionsSchema);
  },
  paymentMethodTypes: optional(array(string())),
  returnUrl: optional(string()),
  get singleUse() {
    return optional(PostSetupIntentsRequestSingleUseSchema);
  },
