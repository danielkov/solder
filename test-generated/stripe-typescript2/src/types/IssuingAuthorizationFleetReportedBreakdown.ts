...
export const IssuingAuthorizationFleetReportedBreakdownSchema: TypedSchema<IssuingAuthorizationFleetReportedBreakdown> = typed<IssuingAuthorizationFleetReportedBreakdown>(object({
  get fuel() {
    return optional(IssuingAuthorizationFleetFuelPriceDataSchema);
  },
  get nonFuel() {
    return optional(IssuingAuthorizationFleetNonFuelPriceDataSchema);
  },
  get tax() {
    return optional(IssuingAuthorizationFleetTaxDataSchema);
  },
}));
