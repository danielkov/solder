...
export const CustomerCashBalanceTransactionSchema: TypedSchema<CustomerCashBalanceTransaction> = typed<CustomerCashBalanceTransaction>(object({
  get adjustedForOverdraft() {
    return optional(CustomerBalanceResourceCashBalanceTransactionResourceAdjustedForOverdraftSchema);
  },
  get appliedToPayment() {
    return optional(CustomerBalanceResourceCashBalanceTransactionResourceAppliedToPaymentTransactionSchema);
  },
  created: number(),
  currency: string(),
  ...
  endingBalance: number(),
  get funded() {
    return optional(CustomerBalanceResourceCashBalanceTransactionResourceFundedTransactionSchema);
  },
  id: string(),
  livemode: boolean(),
  netAmount: number(),
  ...
  get refundedFromPayment() {
    return optional(CustomerBalanceResourceCashBalanceTransactionResourceRefundedFromPaymentTransactionSchema);
  },
  get transferredToBalance() {
    return optional(CustomerBalanceResourceCashBalanceTransactionResourceTransferredToBalanceSchema);
  },
  type: string(),
  get unappliedFromPayment() {
    return optional(CustomerBalanceResourceCashBalanceTransactionResourceUnappliedFromPaymentTransactionSchema);
  },
}));
