...
export const TreasuryTransactionsResourceAbstractTransactionResourceStatusTransitionsSchema: TypedSchema<TreasuryTransactionsResourceAbstractTransactionResourceStatusTransitions> = typed<TreasuryTransactionsResourceAbstractTransactionResourceStatusTransitions>(object({ postedAt: optional(number()), voidAt: optional(number()) }));
