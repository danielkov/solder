...
export const SubscriptionSchema: TypedSchema<Subscription> = typed<Subscription>(object({
  ...
  get billingCycleAnchorConfig() {
    return optional(SubscriptionsResourceBillingCycleAnchorConfigSchema);
  },
  billingMode: SubscriptionsResourceBillingModeSchema,
  get billingThresholds() {
    return optional(SubscriptionBillingThresholdsSchema);
  },
  cancelAt: optional(number()),
  cancelAtPeriodEnd: boolean(),
  canceledAt: optional(number()),
  get cancellationDetails() {
    return optional(CancellationDetailsSchema);
  },
  collectionMethod: string(),
  created: number(),
  currency: string(),
  ...
  get defaultTaxRates() {
    return optional(array(TaxRateSchema));
  },
  ...
  get latestInvoice() {
    return optional(LatestInvoiceOrRefSchema);
  },
  livemode: boolean(),
  ...
  get pauseCollection() {
    return optional(SubscriptionsResourcePauseCollectionSchema);
  },
  get paymentSettings() {
    return optional(SubscriptionsResourcePaymentSettingsSchema);
  },
  get pendingInvoiceItemInterval() {
    return optional(SubscriptionPendingInvoiceItemIntervalSchema);
  },
  get pendingSetupIntent() {
    return optional(PendingSetupIntentOrRefSchema);
  },
  get pendingUpdate() {
    return optional(SubscriptionsResourcePendingUpdateSchema);
  },
  get schedule() {
    return optional(ScheduleOrRefSchema);
  },
  startDate: number(),
  status: string(),
  get testClock() {
  ...
  get transferData() {
    return optional(SubscriptionTransferDataSchema);
  },
  trialEnd: optional(number()),
  get trialSettings() {
    return optional(SubscriptionsTrialsResourceTrialSettingsSchema);
  },
