...
export const PostPaymentLinksPaymentLinkRequestSchema: TypedSchema<PostPaymentLinksPaymentLinkRequest> = typed<PostPaymentLinksPaymentLinkRequest>(object({
  ...
  get afterCompletion() {
    return optional(PostPaymentLinksRequestAfterCompletionSchema);
  },
  allowPromotionCodes: optional(boolean()),
  get automaticTax() {
    return optional(PostPaymentLinksRequestAutomaticTaxSchema);
  },
  billingAddressCollection: optional(string()),
  get customFields() {
    return optional(PostPaymentLinksPaymentLinkRequestCustomFieldsSchema);
  },
  get customText() {
  ...
  get inactiveMessage() {
    return optional(PostPaymentLinksPaymentLinkRequestInactiveMessageSchema);
  },
  get invoiceCreation() {
    return optional(PostPaymentLinksPaymentLinkRequestInvoiceCreationSchema);
  },
  get lineItems() {
    return optional(array(PostPaymentLinksPaymentLinkRequestLineItemsItemSchema));
  },
  get metadata() {
    return optional(PostPaymentLinksRequestMetadataSchema);
  },
  get nameCollection() {
    return optional(PostPaymentLinksPaymentLinkRequestNameCollectionSchema);
  },
  get paymentIntentData() {
    return optional(PostPaymentLinksPaymentLinkRequestPaymentIntentDataSchema);
  },
  paymentMethodCollection: optional(string()),
  get paymentMethodTypes() {
    return optional(PostPaymentLinksPaymentLinkRequestPaymentMethodTypesSchema);
  },
  get phoneNumberCollection() {
    return optional(PostPaymentLinksRequestPhoneNumberCollectionSchema);
  },
  get restrictions() {
    return optional(PostPaymentLinksPaymentLinkRequestRestrictionsSchema);
  },
  get shippingAddressCollection() {
    return optional(PostPaymentLinksPaymentLinkRequestShippingAddressCollectionSchema);
  },
  submitType: optional(string()),
  get subscriptionData() {
    return optional(PostPaymentLinksPaymentLinkRequestSubscriptionDataSchema);
  },
  get taxIdCollection() {
