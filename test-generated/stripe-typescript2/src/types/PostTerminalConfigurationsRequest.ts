...
export const PostTerminalConfigurationsRequestSchema: TypedSchema<PostTerminalConfigurationsRequest> = typed<PostTerminalConfigurationsRequest>(object({
  get bbposWisepad3() {
    return optional(PostTerminalConfigurationsRequestBbposWisepad3Schema);
  },
  get bbposWiseposE() {
    return optional(PostTerminalConfigurationsRequestBbposWiseposESchema);
  },
  ...
  get rebootWindow() {
    return optional(PostTerminalConfigurationsRequestRebootWindowSchema);
  },
  get stripeS700() {
    return optional(PostTerminalConfigurationsRequestStripeS700Schema);
  },
  get tipping() {
    return optional(PostTerminalConfigurationsRequestTippingSchema);
  },
  get verifoneP400() {
    return optional(PostTerminalConfigurationsRequestVerifoneP400Schema);
  },
  get wifi() {
