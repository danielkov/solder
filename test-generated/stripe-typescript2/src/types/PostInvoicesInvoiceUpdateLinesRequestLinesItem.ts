 ...
 * lines_data_param
 */
export interface PostInvoicesInvoiceUpdateLinesRequestLinesItem {
  amount?: number;
  description?: string;
...
export const PostInvoicesInvoiceUpdateLinesRequestLinesItemSchema: TypedSchema<PostInvoicesInvoiceUpdateLinesRequestLinesItem> = typed<PostInvoicesInvoiceUpdateLinesRequestLinesItem>(object({
  ...
  id: string(),
  get metadata() {
    return optional(PostAccountsRequestMetadataSchema);
  },
  get period() {
    return optional(PostInvoicesCreatePreviewRequestInvoiceItemsItemPeriodSchema);
  },
  get priceData() {
    return optional(PostInvoicesInvoiceAddLinesRequestLinesItemPriceDataSchema);
  },
  get pricing() {
    return optional(PostInvoicesInvoiceAddLinesRequestLinesItemPricingSchema);
  },
  quantity: optional(number()),
  get taxAmounts() {
    return optional(PostInvoicesInvoiceAddLinesRequestLinesItemTaxAmountsSchema);
  },
  get taxRates() {
