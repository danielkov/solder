...
export const PostTerminalConfigurationsConfigurationRequestSchema: TypedSchema<PostTerminalConfigurationsConfigurationRequest> = typed<PostTerminalConfigurationsConfigurationRequest>(object({
  get bbposWisepad3() {
    return optional(PostTerminalConfigurationsConfigurationRequestBbposWisepad3Schema);
  },
  get bbposWiseposE() {
    return optional(PostTerminalConfigurationsConfigurationRequestBbposWiseposESchema);
  },
  expand: optional(array(string())),
  name: optional(string()),
  get offline() {
    return optional(PostTerminalConfigurationsRequestOfflineSchema);
  },
  get rebootWindow() {
    return optional(PostTerminalConfigurationsConfigurationRequestRebootWindowSchema);
  },
  get stripeS700() {
    return optional(PostTerminalConfigurationsConfigurationRequestStripeS700Schema);
  },
  get tipping() {
    return optional(PostTerminalConfigurationsRequestTippingSchema);
  },
  get verifoneP400() {
    return optional(PostTerminalConfigurationsConfigurationRequestVerifoneP400Schema);
  },
  get wifi() {
    return optional(PostTerminalConfigurationsRequestWifiSchema);
  },
}));
