...
export const PostCustomersCustomerSubscriptionsRequestPaymentMethodOptionsSchema: TypedSchema<PostCustomersCustomerSubscriptionsRequestPaymentMethodOptions> = typed<PostCustomersCustomerSubscriptionsRequestPaymentMethodOptions>(object({
  get acssDebit() {
    return optional(PostCustomersCustomerSubscriptionsRequestAcssDebitSchema);
  },
  get bancontact() {
    return optional(PostCustomersCustomerSubscriptionsRequestBancontactSchema);
  },
  get card() {
    return optional(PostCustomersCustomerSubscriptionsRequestCardSchema);
  },
  get customerBalance() {
    return optional(PostCustomersCustomerSubscriptionsRequestCustomerBalanceSchema);
  },
  get konbini() {
    return optional(PostCustomersCustomerSubscriptionsRequestKonbiniSchema);
  },
  get sepaDebit() {
    return optional(PostCustomersCustomerSubscriptionsRequestKonbiniSchema);
  },
  get usBankAccount() {
    return optional(PostCustomersCustomerSubscriptionsRequestUsBankAccountSchema);
  },
}));
