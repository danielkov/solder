...
import type { PostSubscriptionItemsRequestPriceData } from './PostSubscriptionItemsRequestPriceData';
import { PostSubscriptionItemsRequestPriceDataSchema } from './PostSubscriptionItemsRequestPriceData';
...
export interface PostSubscriptionItemsRequest {
  /**
...
Use `error_if_incomplete` if you want Stripe to return an HTTP 402 status code if a subscription's invoice cannot be paid. For example, if a payment method requires 3DS authentication due to SCA regulation and further user action is needed, this parameter does not update the subscription and returns an error instead. This was the default behavior for API versions prior to 2019-03-14. See the [changelog](https://docs.stripe.com/changelog/2019-03-14) to learn more.
   ...
   */
  priceData?: PostSubscriptionItemsRequestPriceData;
  /**
...
export const PostSubscriptionItemsRequestSchema: TypedSchema<PostSubscriptionItemsRequest> = typed<PostSubscriptionItemsRequest>(object({
  get billingThresholds() {
    return optional(PostSubscriptionItemsRequestBillingThresholdsSchema);
  },
  get discounts() {
    return optional(PostSubscriptionItemsRequestDiscountsSchema);
  },
  ...
  get priceData() {
    return optional(PostSubscriptionItemsRequestPriceDataSchema);
  },
  ...
  subscription: string(),
  get taxRates() {
    return optional(PostSubscriptionItemsRequestTaxRatesSchema);
  },
}));
