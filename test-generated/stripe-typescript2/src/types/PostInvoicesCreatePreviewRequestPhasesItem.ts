...
import type { PostInvoicesCreatePreviewRequestPhasesItemEndDate } from './PostInvoicesCreatePreviewRequestPhasesItemEndDate';
import { PostInvoicesCreatePreviewRequestPhasesItemEndDateSchema } from './PostInvoicesCreatePreviewRequestPhasesItemEndDate';
 ...
 */
export interface PostInvoicesCreatePreviewRequestPhasesItem {
  ...
  endDate?: PostInvoicesCreatePreviewRequestPhasesItemEndDate;
  /**
   * invoice_settings
   */
  ...
  startDate?: PostInvoicesCreatePreviewRequestPhasesItemEndDate;
  /**
   * transfer_data_specs
   */
  transferData?: DefaultPostCheckoutSessionsRequestTransferData;
  trial?: boolean;
  trialEnd?: PostInvoicesCreatePreviewRequestPhasesItemEndDate;
}

export const PostInvoicesCreatePreviewRequestPhasesItemSchema: TypedSchema<PostInvoicesCreatePreviewRequestPhasesItem> = typed<PostInvoicesCreatePreviewRequestPhasesItem>(object({
  get addInvoiceItems() {
    return optional(array(PostInvoicesCreatePreviewRequestPhasesItemAddInvoiceItemsItemSchema));
  },
  applicationFeePercent: optional(number()),
  get automaticTax() {
    return optional(PostInvoicesCreatePreviewRequestPhasesItemAutomaticTaxSchema);
  },
  billingCycleAnchor: optional(string()),
  get billingThresholds() {
    return optional(PostInvoicesCreatePreviewRequestPhasesItemBillingThresholdsSchema);
  },
  collectionMethod: optional(string()),
  defaultPaymentMethod: optional(string()),
  get defaultTaxRates() {
    return optional(PostAccountsAccountRequestDefaultAccountTaxIdsSchema);
  },
  get description() {
    return optional(PostAccountsAccountPeopleRequestFilesItemSchema);
  },
  get discounts() {
    return optional(PostCustomersCustomerSubscriptionsRequestItemsItemDiscountsSchema);
  },
  get duration() {
    return optional(PostInvoicesCreatePreviewRequestPhasesItemDurationSchema);
  },
  get endDate() {
    return optional(PostInvoicesCreatePreviewRequestPhasesItemEndDateSchema);
  },
  get invoiceSettings() {
    return optional(PostInvoicesCreatePreviewRequestPhasesItemInvoiceSettingsSchema);
  },
  items: array(PostInvoicesCreatePreviewRequestPhasesItemItemsItemSchema),
  get metadata() {
    return optional(PostAccountsRequestMetadataObjectSchema);
  },
  ...
  get transferData() {
    return optional(DefaultPostCheckoutSessionsRequestTransferDataSchema);
  },
