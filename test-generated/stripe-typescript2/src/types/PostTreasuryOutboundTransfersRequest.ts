...
export const PostTreasuryOutboundTransfersRequestSchema: TypedSchema<PostTreasuryOutboundTransfersRequest> = typed<PostTreasuryOutboundTransfersRequest>(object({
  ...
  get destinationPaymentMethodData() {
    return optional(PostTreasuryOutboundTransfersRequestDestinationPaymentMethodDataSchema);
  },
  get destinationPaymentMethodOptions() {
    return optional(PostTreasuryOutboundTransfersRequestDestinationPaymentMethodOptionsSchema);
  },
