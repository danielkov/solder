...
export interface PostIssuingCardholdersRequest {
  /**
   * billing_specs
   * 
...
export const PostIssuingCardholdersRequestSchema: TypedSchema<PostIssuingCardholdersRequest> = typed<PostIssuingCardholdersRequest>(object({
  billing: PostIssuingCardholdersRequestBillingSchema,
  get company() {
    return optional(PostIssuingCardholdersRequestCompanySchema);
  },
  email: optional(string()),
  expand: optional(array(string())),
  get individual() {
    return optional(PostIssuingCardholdersRequestIndividualSchema);
  },
  get metadata() {
  ...
  get spendingControls() {
    return optional(PostIssuingCardholdersRequestSpendingControlsSchema);
  },
