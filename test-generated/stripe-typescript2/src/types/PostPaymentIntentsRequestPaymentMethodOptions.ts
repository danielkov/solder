 ...
 */
export interface PostPaymentIntentsRequestPaymentMethodOptions {
...
export const PostPaymentIntentsRequestPaymentMethodOptionsSchema: TypedSchema<PostPaymentIntentsRequestPaymentMethodOptions> = typed<PostPaymentIntentsRequestPaymentMethodOptions>(object({
  get acssDebit() {
    return optional(DefaultPostPaymentIntentsRequestAcssDebitSchema);
  },
  get affirm() {
    return optional(PostPaymentIntentsRequestAffirmSchema);
  },
  get afterpayClearpay() {
    return optional(PostPaymentIntentsRequestAfterpayClearpaySchema);
  },
  get alipay() {
    return optional(PostPaymentIntentsRequestAlipaySchema);
  },
  get alma() {
    return optional(PostPaymentIntentsRequestAlmaSchema);
  },
  get amazonPay() {
    return optional(PostPaymentIntentsRequestAmazonPaySchema);
  },
  get auBecsDebit() {
    return optional(DefaultPostPaymentIntentsRequestAuBecsDebitSchema);
  },
  get bacsDebit() {
    return optional(DefaultPostPaymentIntentsRequestBacsDebitSchema);
  },
  get bancontact() {
    return optional(PostPaymentIntentsRequestBancontactSchema);
  },
  get billie() {
    return optional(PostPaymentIntentsRequestAlmaSchema);
  },
  get blik() {
    return optional(PostPaymentIntentsRequestBlikSchema);
  },
  get boleto() {
    return optional(DefaultPostPaymentIntentsRequestBoletoSchema);
  },
  get card() {
    return optional(PostPaymentIntentsRequestCardSchema);
  },
  get cardPresent() {
    return optional(PostPaymentIntentsRequestCardPresentSchema);
  },
  get cashapp() {
    return optional(PostPaymentIntentsRequestCashappSchema);
  },
  get crypto() {
    return optional(PostPaymentIntentsRequestCryptoSchema);
  },
  get customerBalance() {
    return optional(PostPaymentIntentsRequestCustomerBalanceSchema);
  },
  get eps() {
    return optional(DefaultPostPaymentIntentsRequestEpsSchema);
  },
  get fpx() {
    return optional(DefaultPostPaymentIntentsRequestFpxSchema);
  },
  get giropay() {
    return optional(DefaultPostPaymentIntentsRequestFpxSchema);
  },
  ...
  get interacPresent() {
    return optional(PostPaymentIntentsRequestInteracPresentSchema);
  },
  get kakaoPay() {
    return optional(PostPaymentIntentsRequestAmazonPaySchema);
  },
  get klarna() {
    return optional(DefaultPostPaymentIntentsRequestKlarnaSchema);
  },
  get konbini() {
    return optional(PostPaymentIntentsRequestKonbiniSchema);
  },
  get krCard() {
    return optional(PostPaymentIntentsRequestAmazonPaySchema);
  },
  get link() {
    return optional(PostPaymentIntentsRequestLinkSchema);
  },
  get mbWay() {
    return optional(DefaultPostPaymentIntentsRequestFpxSchema);
  },
  get mobilepay() {
    return optional(PostPaymentIntentsRequestMobilepaySchema);
  },
  get multibanco() {
    return optional(DefaultPostPaymentIntentsRequestFpxSchema);
  },
  ...
  get oxxo() {
    return optional(PostPaymentIntentsRequestOxxoSchema);
  },
  get p24() {
    return optional(DefaultPostPaymentIntentsRequestP24Schema);
  },
  get payByBank() {
    return optional(PostPaymentIntentsRequestPayByBankSchema);
  },
  get payco() {
    return optional(PostPaymentIntentsRequestAlmaSchema);
  },
  ...
  get paypal() {
    return optional(PostPaymentIntentsRequestPaypalSchema);
  },
  get pix() {
    return optional(PostPaymentIntentsRequestPixSchema);
  },
  get promptpay() {
    return optional(DefaultPostPaymentIntentsRequestFpxSchema);
  },
  ...
  get sofort() {
    return optional(DefaultPostPaymentIntentsRequestSofortSchema);
  },
  get swish() {
    return optional(PostPaymentIntentsRequestSwishSchema);
  },
  get twint() {
    return optional(PostPaymentIntentsRequestCryptoSchema);
  },
  get usBankAccount() {
    return optional(DefaultPostPaymentIntentsRequestUsBankAccountSchema);
  },
  get wechatPay() {
    return optional(PostPaymentIntentsRequestWechatPaySchema);
  },
  get zip() {
    return optional(DefaultPostPaymentIntentsRequestFpxSchema);
  },
