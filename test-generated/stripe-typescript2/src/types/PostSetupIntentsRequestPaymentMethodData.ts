 ...
 */
export interface PostSetupIntentsRequestPaymentMethodData {
  /**
...
export const PostSetupIntentsRequestPaymentMethodDataSchema: TypedSchema<PostSetupIntentsRequestPaymentMethodData> = typed<PostSetupIntentsRequestPaymentMethodData>(object({
  get acssDebit() {
