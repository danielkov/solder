...
export const PostQuotesQuoteRequestSchema: TypedSchema<PostQuotesQuoteRequest> = typed<PostQuotesQuoteRequest>(object({
  ...
  get description() {
    return optional(PostQuotesQuoteRequestDescriptionSchema);
  },
  get discounts() {
  ...
  get footer() {
    return optional(PostQuotesQuoteRequestFooterSchema);
  },
  get header() {
    return optional(PostQuotesQuoteRequestHeaderSchema);
  },
  get invoiceSettings() {
    return optional(PostQuotesRequestInvoiceSettingsSchema);
  },
  get lineItems() {
    return optional(array(PostQuotesQuoteRequestLineItemsItemSchema));
  },
  get metadata() {
  ...
  get subscriptionData() {
    return optional(PostQuotesQuoteRequestSubscriptionDataSchema);
  },
  get transferData() {
