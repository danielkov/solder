...
export interface PostTreasuryCreditReversalsRequest {
  /**
...
export const PostTreasuryCreditReversalsRequestSchema: TypedSchema<PostTreasuryCreditReversalsRequest> = typed<PostTreasuryCreditReversalsRequest>(object({
