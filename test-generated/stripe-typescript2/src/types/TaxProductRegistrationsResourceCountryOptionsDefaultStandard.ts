...
export const TaxProductRegistrationsResourceCountryOptionsDefaultStandardSchema: TypedSchema<TaxProductRegistrationsResourceCountryOptionsDefaultStandard> = typed<TaxProductRegistrationsResourceCountryOptionsDefaultStandard>(object({ placeOfSupplyScheme: string() }));
