...
export const FundingInstructionsBankTransferFinancialAddressSchema: TypedSchema<FundingInstructionsBankTransferFinancialAddress> = typed<FundingInstructionsBankTransferFinancialAddress>(object({
  get aba() {
    return optional(FundingInstructionsBankTransferAbaRecordSchema);
  },
  get iban() {
    return optional(FundingInstructionsBankTransferIbanRecordSchema);
  },
  get sortCode() {
    return optional(FundingInstructionsBankTransferSortCodeRecordSchema);
  },
  get spei() {
    return optional(FundingInstructionsBankTransferSpeiRecordSchema);
  },
  supportedNetworks: optional(array(string())),
  get swift() {
    return optional(FundingInstructionsBankTransferSwiftRecordSchema);
  },
  type: string(),
  get zengin() {
    return optional(FundingInstructionsBankTransferZenginRecordSchema);
  },
}));
