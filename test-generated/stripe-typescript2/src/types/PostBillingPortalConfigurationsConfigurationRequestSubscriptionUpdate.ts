...
export const PostBillingPortalConfigurationsConfigurationRequestSubscriptionUpdateSchema: TypedSchema<PostBillingPortalConfigurationsConfigurationRequestSubscriptionUpdate> = typed<PostBillingPortalConfigurationsConfigurationRequestSubscriptionUpdate>(object({
  get defaultAllowedUpdates() {
    return optional(PostBillingPortalConfigurationsRequestDefaultAllowedUpdatesSchema);
  },
  enabled: optional(boolean()),
  get products() {
    return optional(PostBillingPortalConfigurationsRequestProductsSchema);
  },
  prorationBehavior: optional(string()),
  get scheduleAtPeriodEnd() {
    return optional(PostBillingPortalConfigurationsConfigurationRequestScheduleAtPeriodEndSchema);
  },
