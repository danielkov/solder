...
export const PaymentLinksResourceIndividualNameSchema: TypedSchema<PaymentLinksResourceIndividualName> = typed<PaymentLinksResourceIndividualName>(object({ enabled: boolean(), optional: boolean() }));
