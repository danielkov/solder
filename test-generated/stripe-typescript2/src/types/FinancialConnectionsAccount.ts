...
export const FinancialConnectionsAccountSchema: TypedSchema<FinancialConnectionsAccount> = typed<FinancialConnectionsAccount>(object({
  get accountHolder() {
    return optional(BankConnectionsResourceAccountholderSchema);
  },
  get accountNumbers() {
    return optional(array(BankConnectionsResourceAccountNumberDetailsSchema));
  },
  get balance() {
    return optional(BankConnectionsResourceBalanceSchema);
  },
  get balanceRefresh() {
    return optional(BankConnectionsResourceBalanceRefreshSchema);
  },
  category: string(),
  created: number(),
  ...
  object: string(),
  get ownership() {
    return optional(OwnershipOrRefSchema);
  },
  get ownershipRefresh() {
    return optional(BankConnectionsResourceOwnershipRefreshSchema);
  },
  ...
  supportedPaymentMethodTypes: array(string()),
  get transactionRefresh() {
    return optional(BankConnectionsResourceTransactionRefreshSchema);
  },
}));
