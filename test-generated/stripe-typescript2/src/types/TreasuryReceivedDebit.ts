...
export const TreasuryReceivedDebitSchema: TypedSchema<TreasuryReceivedDebit> = typed<TreasuryReceivedDebit>(object({
  ...
  get initiatingPaymentMethodDetails() {
    return optional(TreasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetailsSchema);
  },
  ...
  object: string(),
  get reversalDetails() {
    return optional(TreasuryReceivedDebitsResourceReversalDetailsSchema);
  },
  status: string(),
  get transaction() {
    return optional(TransactionOrRef2Schema);
  },
}));
