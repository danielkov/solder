...
export const PostPricesRequestSchema: TypedSchema<PostPricesRequest> = typed<PostPricesRequest>(object({
  ...
  currency: string(),
  get currencyOptions() {
    return optional(PostPricesRequestCurrencyOptionsSchema);
  },
  get customUnitAmount() {
    return optional(PostPricesRequestCustomUnitAmountSchema);
  },
  ...
  get productData() {
    return optional(PostPricesRequestProductDataSchema);
  },
  get recurring() {
    return optional(PostPricesRequestRecurringSchema);
  },
  taxBehavior: optional(string()),
  get tiers() {
    return optional(array(PostPlansRequestTiersItemSchema));
  },
  tiersMode: optional(string()),
  transferLookupKey: optional(boolean()),
  get transformQuantity() {
    return optional(PostPlansRequestTransformUsageSchema);
  },
