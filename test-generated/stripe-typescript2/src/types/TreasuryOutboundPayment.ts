...
export const TreasuryOutboundPaymentSchema: TypedSchema<TreasuryOutboundPayment> = typed<TreasuryOutboundPayment>(object({
  ...
  get destinationPaymentMethodDetails() {
    return optional(OutboundPaymentsPaymentMethodDetailsSchema);
  },
  get endUserDetails() {
    return optional(TreasuryOutboundPaymentsResourceOutboundPaymentResourceEndUserDetailsSchema);
  },
  expectedArrivalDate: number(),
  financialAccount: string(),
  ...
  object: string(),
  get returnedDetails() {
    return optional(TreasuryOutboundPaymentsResourceReturnedStatusSchema);
  },
  statementDescriptor: string(),
  status: string(),
  statusTransitions: TreasuryOutboundPaymentsResourceOutboundPaymentResourceStatusTransitionsSchema,
  get trackingDetails() {
    return optional(TreasuryOutboundPaymentsResourceOutboundPaymentResourceTrackingDetailsSchema);
  },
