...
export const SourceSchema: TypedSchema<Source> = typed<Source>(object({
  get achCreditTransfer() {
    return optional(SourceTypeAchCreditTransferSchema);
  },
  get achDebit() {
    return optional(SourceTypeAchDebitSchema);
  },
  get acssDebit() {
    return optional(SourceTypeAcssDebitSchema);
  },
  get alipay() {
    return optional(SourceTypeAlipaySchema);
  },
  allowRedisplay: optional(string()),
  amount: optional(number()),
  get auBecsDebit() {
    return optional(SourceTypeAuBecsDebitSchema);
  },
  get bancontact() {
    return optional(SourceTypeBancontactSchema);
  },
  get card() {
    return optional(SourceTypeCardSchema);
  },
  get cardPresent() {
    return optional(SourceTypeCardPresentSchema);
  },
  clientSecret: string(),
  get codeVerification() {
    return optional(SourceCodeVerificationFlowSchema);
  },
  created: number(),
  currency: optional(string()),
  customer: optional(string()),
  get eps() {
    return optional(SourceTypeEpsSchema);
  },
  flow: string(),
  get giropay() {
    return optional(SourceTypeGiropaySchema);
  },
  id: string(),
  get ideal() {
    return optional(SourceTypeIdealSchema);
  },
  get klarna() {
    return optional(SourceTypeKlarnaSchema);
  },
  livemode: boolean(),
  get metadata() {
  ...
  get multibanco() {
    return optional(SourceTypeMultibancoSchema);
  },
  object: string(),
  get owner() {
    return optional(SourceOwnerSchema);
  },
  get p24() {
    return optional(SourceTypeP24Schema);
  },
  get receiver() {
    return optional(SourceReceiverFlowSchema);
  },
  get redirect() {
    return optional(SourceRedirectFlowSchema);
  },
  get sepaDebit() {
    return optional(SourceTypeSepaDebitSchema);
  },
  get sofort() {
    return optional(SourceTypeSofortSchema);
  },
  get sourceOrder() {
    return optional(SourceOrderSchema);
  },
  statementDescriptor: optional(string()),
  status: string(),
  get threeDSecure() {
    return optional(SourceTypeThreeDSecureSchema);
  },
  type: string(),
  usage: optional(string()),
  get wechat() {
    return optional(SourceTypeWechatSchema);
  },
}));
