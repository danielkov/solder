 ...
 */
export interface PostAccountsAccountRequestBusinessProfile {
  /**
...
export const PostAccountsAccountRequestBusinessProfileSchema: TypedSchema<PostAccountsAccountRequestBusinessProfile> = typed<PostAccountsAccountRequestBusinessProfile>(object({
  get annualRevenue() {
    return optional(PostAccountsRequestAnnualRevenueSchema);
  },
  estimatedWorkerCount: optional(number()),
  mcc: optional(string()),
  minorityOwnedBusinessDesignation: optional(array(string())),
  get monthlyEstimatedRevenue() {
    return optional(PostAccountsRequestMonthlyEstimatedRevenueSchema);
  },
  ...
  get supportUrl() {
    return optional(PostAccountsRequestSupportUrlSchema);
  },
  url: optional(string()),
}));
