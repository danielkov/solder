...
export const PostPaymentIntentsRequestSchema: TypedSchema<PostPaymentIntentsRequest> = typed<PostPaymentIntentsRequest>(object({
  amount: number(),
  get amountDetails() {
    return optional(PostPaymentIntentsRequestAmountDetailsSchema);
  },
  applicationFeeAmount: optional(number()),
  get automaticPaymentMethods() {
    return optional(PostPaymentIntentsRequestAutomaticPaymentMethodsSchema);
  },
  ...
  get mandateData() {
    return optional(PostPaymentIntentsRequestMandateDataSchema);
  },
  get metadata() {
    return optional(PostAccountsAccountBankAccountsRequestMetadataSchema);
  },
  get offSession() {
    return optional(PostPaymentIntentsRequestOffSessionSchema);
  },
  onBehalfOf: optional(string()),
  get paymentDetails() {
    return optional(PostPaymentIntentsRequestPaymentDetailsSchema);
  },
  ...
  get shipping() {
    return optional(DefaultPostPaymentIntentsRequestShippingSchema);
  },
  statementDescriptor: optional(string()),
  statementDescriptorSuffix: optional(string()),
  get transferData() {
    return optional(PostPaymentIntentsRequestTransferDataSchema);
  },
