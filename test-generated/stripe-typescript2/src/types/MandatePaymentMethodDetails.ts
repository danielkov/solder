...
export const MandatePaymentMethodDetailsSchema: TypedSchema<MandatePaymentMethodDetails> = typed<MandatePaymentMethodDetails>(object({
  get acssDebit() {
    return optional(MandateAcssDebitSchema);
  },
  get amazonPay() {
    return optional(MandateAmazonPaySchema);
  },
  get auBecsDebit() {
    return optional(MandateAuBecsDebitSchema);
  },
  get bacsDebit() {
    return optional(MandateBacsDebitSchema);
  },
  get card() {
    return optional(CardMandatePaymentMethodDetailsSchema);
  },
  get cashapp() {
    return optional(MandateCashappSchema);
  },
  get kakaoPay() {
    return optional(MandateKakaoPaySchema);
  },
  get klarna() {
    return optional(MandateKlarnaSchema);
  },
  get krCard() {
    return optional(MandateKrCardSchema);
  },
  get link() {
    return optional(MandateLinkSchema);
  },
  get naverPay() {
    return optional(MandateNaverPaySchema);
  },
  get nzBankAccount() {
    return optional(MandateNzBankAccountSchema);
  },
  get paypal() {
    return optional(MandatePaypalSchema);
  },
  get revolutPay() {
    return optional(MandateRevolutPaySchema);
  },
  get sepaDebit() {
    return optional(MandateSepaDebitSchema);
  },
  type: string(),
  get usBankAccount() {
    return optional(MandateUsBankAccountSchema);
  },
}));
