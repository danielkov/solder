...
export const PostIssuingCardholdersRequestBillingSchema: TypedSchema<PostIssuingCardholdersRequestBilling> = typed<PostIssuingCardholdersRequestBilling>(object({ address: PostIssuingCardholdersRequestAddressSchema }));
