...
export const PostAccountsRequestDocumentsSchema: TypedSchema<PostAccountsRequestDocuments> = typed<PostAccountsRequestDocuments>(object({
  get bankAccountOwnershipVerification() {
    return optional(PostAccountsRequestBankAccountObjectBankAccountOwnershipVerificationSchema);
  },
  get companyLicense() {
    return optional(PostAccountsRequestBankAccountObjectBankAccountOwnershipVerificationSchema);
  },
  ...
  get proofOfRegistration() {
    return optional(PostAccountsRequestProofOfRegistrationSchema);
  },
