...
export const CustomerBalanceResourceCashBalanceTransactionResourceFundedTransactionResourceBankTransferSchema: TypedSchema<CustomerBalanceResourceCashBalanceTransactionResourceFundedTransactionResourceBankTransfer> = typed<CustomerBalanceResourceCashBalanceTransactionResourceFundedTransactionResourceBankTransfer>(object({
  get euBankTransfer() {
    return optional(CustomerBalanceResourceCashBalanceTransactionResourceFundedTransactionResourceBankTransferResourceEuBankTransferSchema);
  },
  get gbBankTransfer() {
    return optional(CustomerBalanceResourceCashBalanceTransactionResourceFundedTransactionResourceBankTransferResourceGbBankTransferSchema);
  },
  get jpBankTransfer() {
    return optional(CustomerBalanceResourceCashBalanceTransactionResourceFundedTransactionResourceBankTransferResourceJpBankTransferSchema);
  },
  reference: optional(string()),
  type: string(),
  get usBankTransfer() {
    return optional(CustomerBalanceResourceCashBalanceTransactionResourceFundedTransactionResourceBankTransferResourceUsBankTransferSchema);
  },
}));
