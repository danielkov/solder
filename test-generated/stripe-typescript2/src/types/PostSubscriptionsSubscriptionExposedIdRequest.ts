import { array, boolean, number, object, optional, string, typed } from '@speakeasy-api/tonic';
...
import type { PostSubscriptionsRequestOnBehalfOf } from './PostSubscriptionsRequestOnBehalfOf';
import { PostSubscriptionsRequestOnBehalfOfSchema } from './PostSubscriptionsRequestOnBehalfOf';
import type { PostSubscriptionsSubscriptionExposedIdRequestDescription } from './PostSubscriptionsSubscriptionExposedIdRequestDescription';
import { PostSubscriptionsSubscriptionExposedIdRequestDescriptionSchema } from './PostSubscriptionsSubscriptionExposedIdRequestDescription';
import type { PostSubscriptionsSubscriptionExposedIdRequestTrialEnd } from './PostSubscriptionsSubscriptionExposedIdRequestTrialEnd';
import { PostSubscriptionsSubscriptionExposedIdRequestTrialEndSchema } from './PostSubscriptionsSubscriptionExposedIdRequestTrialEnd';
export interface PostSubscriptionsSubscriptionExposedIdRequest {
  /**
   ...
   */
  description?: PostSubscriptionsSubscriptionExposedIdRequestDescription;
  /**
   ...
   */
  onBehalfOf?: PostSubscriptionsRequestOnBehalfOf;
  /**
...
Use `error_if_incomplete` if you want Stripe to return an HTTP 402 status code if a subscription's invoice cannot be paid. For example, if a payment method requires 3DS authentication due to SCA regulation and further user action is needed, this parameter does not update the subscription and returns an error instead. This was the default behavior for API versions prior to 2019-03-14. See the [changelog](https://docs.stripe.com/changelog/2019-03-14) to learn more.
   ...
   */
  trialEnd?: PostSubscriptionsSubscriptionExposedIdRequestTrialEnd;
  /**
...
export const PostSubscriptionsSubscriptionExposedIdRequestSchema: TypedSchema<PostSubscriptionsSubscriptionExposedIdRequest> = typed<PostSubscriptionsSubscriptionExposedIdRequest>(object({
  get addInvoiceItems() {
    return optional(array(PostCustomersCustomerSubscriptionsRequestAddInvoiceItemsItemSchema));
  },
  get applicationFeePercent() {
    return optional(PostCustomersCustomerSubscriptionsRequestApplicationFeePercentSchema);
  },
  get automaticTax() {
    return optional(PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestAutomaticTaxSchema);
  },
  billingCycleAnchor: optional(string()),
  get billingThresholds() {
    return optional(PostCustomersCustomerSubscriptionsRequestBillingThresholdsSchema);
  },
  get cancelAt() {
    return optional(PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestCancelAtSchema);
  },
  cancelAtPeriodEnd: optional(boolean()),
  get cancellationDetails() {
    return optional(PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestCancellationDetailsSchema);
  },
  collectionMethod: optional(string()),
  daysUntilDue: optional(number()),
  defaultPaymentMethod: optional(string()),
  get defaultSource() {
    return optional(PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestDefaultSourceSchema);
  },
  get defaultTaxRates() {
    return optional(PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestDefaultTaxRatesSchema);
  },
  get description() {
    return optional(PostSubscriptionsSubscriptionExposedIdRequestDescriptionSchema);
  },
  get discounts() {
    return optional(PostCustomersCustomerSubscriptionsRequestDiscountsSchema);
  },
  expand: optional(array(string())),
  get invoiceSettings() {
    return optional(PostCustomersCustomerSubscriptionsRequestInvoiceSettingsSchema);
  },
  get items() {
    return optional(array(PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestItemsItemSchema));
  },
  get metadata() {
    return optional(DefaultPostAccountsRequestMetadataSchema);
  },
  offSession: optional(boolean()),
  get onBehalfOf() {
    return optional(PostSubscriptionsRequestOnBehalfOfSchema);
  },
  get pauseCollection() {
    return optional(PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestPauseCollectionSchema);
  },
  paymentBehavior: optional(string()),
  get paymentSettings() {
    return optional(PostCustomersCustomerSubscriptionsRequestPaymentSettingsSchema);
  },
  get pendingInvoiceItemInterval() {
    return optional(PostCustomersCustomerSubscriptionsRequestPendingInvoiceItemIntervalSchema);
  },
  prorationBehavior: optional(string()),
  prorationDate: optional(number()),
  get transferData() {
    return optional(PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestTransferDataSchema);
  },
  get trialEnd() {
    return optional(PostSubscriptionsSubscriptionExposedIdRequestTrialEndSchema);
  },
  trialFromPlan: optional(boolean()),
  get trialSettings() {
    return optional(PostCustomersCustomerSubscriptionsRequestTrialSettingsSchema);
  },
}));
