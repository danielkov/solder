...
export const PostTestHelpersIssuingAuthorizationsRequestRiskAssessmentSchema: TypedSchema<PostTestHelpersIssuingAuthorizationsRequestRiskAssessment> = typed<PostTestHelpersIssuingAuthorizationsRequestRiskAssessment>(object({
  get cardTestingRisk() {
    return optional(PostTestHelpersIssuingAuthorizationsRequestCardTestingRiskSchema);
  },
  get fraudRisk() {
    return optional(PostTestHelpersIssuingAuthorizationsRequestFraudRiskSchema);
  },
  get merchantDisputeRisk() {
    return optional(PostTestHelpersIssuingAuthorizationsRequestMerchantDisputeRiskSchema);
  },
}));
