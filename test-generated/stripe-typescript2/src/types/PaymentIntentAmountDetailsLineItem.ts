...
export const PaymentIntentAmountDetailsLineItemSchema: TypedSchema<PaymentIntentAmountDetailsLineItem> = typed<PaymentIntentAmountDetailsLineItem>(object({
  ...
  get paymentMethodOptions() {
    return optional(PaymentFlowsAmountDetailsResourceLineItemsListResourceLineItemResourcePaymentMethodOptionsSchema);
  },
  productCode: optional(string()),
  productName: string(),
  quantity: number(),
  get tax() {
    return optional(PaymentFlowsAmountDetailsResourceLineItemsListResourceLineItemResourceTaxSchema);
  },
  unitCost: number(),
