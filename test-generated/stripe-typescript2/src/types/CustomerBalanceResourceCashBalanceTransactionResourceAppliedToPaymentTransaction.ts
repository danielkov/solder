...
export const CustomerBalanceResourceCashBalanceTransactionResourceAppliedToPaymentTransactionSchema: TypedSchema<CustomerBalanceResourceCashBalanceTransactionResourceAppliedToPaymentTransaction> = typed<CustomerBalanceResourceCashBalanceTransactionResourceAppliedToPaymentTransaction>(object({ paymentIntent: PaymentIntentOrRefSchema }));
