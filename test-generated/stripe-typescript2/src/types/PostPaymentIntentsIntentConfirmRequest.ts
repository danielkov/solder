...
export const PostPaymentIntentsIntentConfirmRequestSchema: TypedSchema<PostPaymentIntentsIntentConfirmRequest> = typed<PostPaymentIntentsIntentConfirmRequest>(object({
  get amountDetails() {
    return optional(PostPaymentIntentsIntentRequestAmountDetailsSchema);
  },
  captureMethod: optional(string()),
  clientSecret: optional(string()),
  confirmationToken: optional(string()),
  errorOnRequiresAction: optional(boolean()),
  get excludedPaymentMethodTypes() {
    return optional(PostPaymentIntentsIntentRequestExcludedPaymentMethodTypesSchema);
  },
  expand: optional(array(string())),
  get hooks() {
    return optional(PostPaymentIntentsRequestHooksSchema);
  },
  mandate: optional(string()),
  get mandateData() {
    return optional(PostPaymentIntentsIntentConfirmRequestMandateDataSchema);
  },
  get offSession() {
    return optional(PostPaymentIntentsIntentConfirmRequestOffSessionSchema);
  },
  get paymentDetails() {
    return optional(PostPaymentIntentsIntentRequestPaymentDetailsSchema);
  },
  paymentMethod: optional(string()),
  get paymentMethodData() {
    return optional(PostPaymentIntentsRequestPaymentMethodDataSchema);
  },
  get paymentMethodOptions() {
    return optional(PostPaymentIntentsRequestPaymentMethodOptionsSchema);
  },
  paymentMethodTypes: optional(array(string())),
  get radarOptions() {
    return optional(DefaultPostPaymentIntentsRequestRadarOptionsSchema);
  },
  get receiptEmail() {
    return optional(PostPaymentIntentsIntentRequestReceiptEmailSchema);
  },
  returnUrl: optional(string()),
  setupFutureUsage: optional(string()),
  get shipping() {
    return optional(PostPaymentIntentsIntentRequestShippingSchema);
  },
