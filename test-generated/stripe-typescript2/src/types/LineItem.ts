...
export const LineItemSchema: TypedSchema<LineItem> = typed<LineItem>(object({
  ...
  object: string(),
  get parent() {
    return optional(BillingBillResourceInvoicingLinesParentsInvoiceLineItemParentSchema);
  },
  period: InvoiceLineItemPeriodSchema,
  get pretaxCreditAmounts() {
    return optional(array(InvoicesResourcePretaxCreditAmountSchema));
  },
  get pricing() {
    return optional(BillingBillResourceInvoicingPricingPricingSchema);
  },
