...
export const LegalEntityCompanyVerificationSchema: TypedSchema<LegalEntityCompanyVerification> = typed<LegalEntityCompanyVerification>(object({ document: LegalEntityCompanyVerificationDocumentSchema }));
