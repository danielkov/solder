...
import type { PostSubscriptionsRequestBillingCycleAnchorConfig } from './PostSubscriptionsRequestBillingCycleAnchorConfig';
import { PostSubscriptionsRequestBillingCycleAnchorConfigSchema } from './PostSubscriptionsRequestBillingCycleAnchorConfig';
...
export interface PostSubscriptionsRequest {
   ...
   */
  billingCycleAnchorConfig?: PostSubscriptionsRequestBillingCycleAnchorConfig;
  /**
   * billing_mode
   * 
...
export const PostSubscriptionsRequestSchema: TypedSchema<PostSubscriptionsRequest> = typed<PostSubscriptionsRequest>(object({
  get addInvoiceItems() {
  ...
  get automaticTax() {
    return optional(PostCustomersCustomerSubscriptionsRequestAutomaticTaxSchema);
  },
  backdateStartDate: optional(number()),
  billingCycleAnchor: optional(number()),
  get billingCycleAnchorConfig() {
    return optional(PostSubscriptionsRequestBillingCycleAnchorConfigSchema);
  },
  get billingMode() {
    return optional(PostSubscriptionSchedulesRequestBillingModeSchema);
  },
  get billingThresholds() {
    return optional(PostCustomersCustomerSubscriptionsRequestBillingThresholdsSchema);
  },
  get cancelAt() {
    return optional(PostCustomersCustomerSubscriptionsRequestCancelAtSchema);
  },
  ...
  get defaultTaxRates() {
    return optional(PostCustomersCustomerSubscriptionsRequestDefaultTaxRatesSchema);
  },
  ...
  get items() {
    return optional(array(PostCustomersCustomerSubscriptionsRequestItemsItemSchema));
  },
  get metadata() {
  ...
  get transferData() {
    return optional(PostCustomersCustomerSubscriptionsRequestTransferDataSchema);
  },
  get trialEnd() {
    return optional(PostCustomersCustomerSubscriptionsRequestTrialEndSchema);
  },
