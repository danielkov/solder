...
export const TerminalReaderReaderResourceReaderActionSchema: TypedSchema<TerminalReaderReaderResourceReaderAction> = typed<TerminalReaderReaderResourceReaderAction>(object({
  get collectInputs() {
    return optional(TerminalReaderReaderResourceCollectInputsActionSchema);
  },
  get collectPaymentMethod() {
    return optional(TerminalReaderReaderResourceCollectPaymentMethodActionSchema);
  },
  get confirmPaymentIntent() {
    return optional(TerminalReaderReaderResourceConfirmPaymentIntentActionSchema);
  },
  failureCode: optional(string()),
  failureMessage: optional(string()),
  get processPaymentIntent() {
    return optional(TerminalReaderReaderResourceProcessPaymentIntentActionSchema);
  },
  get processSetupIntent() {
    return optional(TerminalReaderReaderResourceProcessSetupIntentActionSchema);
  },
  get refundPayment() {
    return optional(TerminalReaderReaderResourceRefundPaymentActionSchema);
  },
  get setReaderDisplay() {
    return optional(TerminalReaderReaderResourceSetReaderDisplayActionSchema);
  },
  status: string(),
  type: string(),
}));
