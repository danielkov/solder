...
export const IssuingNetworkTokenNetworkDataSchema: TypedSchema<IssuingNetworkTokenNetworkData> = typed<IssuingNetworkTokenNetworkData>(object({
  get device() {
    return optional(IssuingNetworkTokenDeviceSchema);
  },
  get mastercard() {
    return optional(IssuingNetworkTokenMastercardSchema);
  },
  type: string(),
  get visa() {
    return optional(IssuingNetworkTokenVisaSchema);
  },
  get walletProvider() {
    return optional(IssuingNetworkTokenWalletProviderSchema);
  },
}));
