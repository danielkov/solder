...
export const IdentityVerificationSessionSchema: TypedSchema<IdentityVerificationSession> = typed<IdentityVerificationSession>(object({
  ...
  id: string(),
  get lastError() {
    return optional(GelatoSessionLastErrorSchema);
  },
  get lastVerificationReport() {
    return optional(LastVerificationReportOrRefSchema);
  },
  livemode: boolean(),
  metadata: MetadataPropertySchema,
  object: string(),
  get options() {
    return optional(GelatoVerificationSessionOptionsSchema);
  },
  get providedDetails() {
    return optional(GelatoProvidedDetailsSchema);
  },
  get redaction() {
    return optional(VerificationSessionRedactionSchema);
  },
  relatedCustomer: optional(string()),
  get relatedPerson() {
    return optional(GelatoRelatedPersonSchema);
  },
  status: string(),
  type: string(),
  url: optional(string()),
  ...
  get verifiedOutputs() {
    return optional(GelatoVerifiedOutputsSchema);
  },
}));
