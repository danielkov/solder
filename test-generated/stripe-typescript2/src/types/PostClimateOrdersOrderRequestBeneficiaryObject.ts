...
export const PostClimateOrdersOrderRequestBeneficiaryObjectSchema: TypedSchema<PostClimateOrdersOrderRequestBeneficiaryObject> = typed<PostClimateOrdersOrderRequestBeneficiaryObject>(object({ publicName: PostAccountsRequestPaymentsPricingSchema }));
