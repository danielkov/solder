 ...
 */
export interface PostAccountsAccountRequestCompany {
  /**
...
export const PostAccountsAccountRequestCompanySchema: TypedSchema<PostAccountsAccountRequestCompany> = typed<PostAccountsAccountRequestCompany>(object({
  get address() {
    return optional(PostAccountsRequestAddressSchema);
  },
  get addressKana() {
    return optional(PostAccountsRequestAddressKanaSchema);
  },
  get addressKanji() {
    return optional(PostAccountsRequestAddressKanjiSchema);
  },
  directorsProvided: optional(boolean()),
  get directorshipDeclaration() {
    return optional(PostAccountsRequestDirectorshipDeclarationSchema);
  },
  ...
  get ownershipDeclaration() {
    return optional(PostAccountsRequestOwnershipDeclarationSchema);
  },
  ownershipExemptionReason: optional(string()),
  phone: optional(string()),
  get registrationDate() {
    return optional(PostAccountsRequestRegistrationDateSchema);
  },
  registrationNumber: optional(string()),
  get representativeDeclaration() {
    return optional(PostAccountsRequestRepresentativeDeclarationSchema);
  },
  ...
  get verification() {
    return optional(PostAccountsRequestVerificationSchema);
  },
}));
