...
export const RefundDestinationDetailsCryptoSchema: TypedSchema<RefundDestinationDetailsCrypto> = typed<RefundDestinationDetailsCrypto>(object({ reference: optional(string()) }));
