...
export const PostCreditNotesRequestSchema: TypedSchema<PostCreditNotesRequest> = typed<PostCreditNotesRequest>(object({
  ...
  invoice: string(),
  get lines() {
    return optional(array(PostCreditNotesRequestLinesItemSchema));
  },
  ...
  get refunds() {
    return optional(array(PostCreditNotesRequestRefundsItemSchema));
  },
  get shippingCost() {
    return optional(PostCreditNotesRequestShippingCostSchema);
  },
}));
