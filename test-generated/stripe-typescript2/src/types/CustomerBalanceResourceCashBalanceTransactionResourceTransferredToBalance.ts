...
export const CustomerBalanceResourceCashBalanceTransactionResourceTransferredToBalanceSchema: TypedSchema<CustomerBalanceResourceCashBalanceTransactionResourceTransferredToBalance> = typed<CustomerBalanceResourceCashBalanceTransactionResourceTransferredToBalance>(object({ balanceTransaction: BalanceTransactionOrRefSchema }));
