...
export const BillingCreditGrantsResourceBalanceCreditsAppliedSchema: TypedSchema<BillingCreditGrantsResourceBalanceCreditsApplied> = typed<BillingCreditGrantsResourceBalanceCreditsApplied>(object({ invoice: InvoiceOrRefSchema, invoiceLineItem: string() }));
